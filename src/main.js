...
const WORKSPACE_ICON_OPTIONS = [
  ...
  { key: 'building', icon: 'ti-building-filled', label: 'Building' },
  { key: 'store', icon: 'ti-building-store-filled', label: 'Store' },
  { key: 'warehouse', icon: 'ti-building-warehouse-filled', label: 'Warehouse' },
  { key: 'briefcase', icon: 'ti-briefcase-filled', label: 'Briefcase' },
  { key: 'tools', icon: 'ti-tools-filled', label: 'Tools' },
  { key: 'tool', icon: 'ti-tool-filled', label: 'Tool' },
  { key: 'hammer', icon: 'ti-hammer-filled', label: 'Hammer' },
  { key: 'helmet', icon: 'ti-helmet-filled', label: 'Helmet' },
  { key: 'ruler', icon: 'ti-ruler-measure-filled', label: 'Ruler' },
  { key: 'truck', icon: 'ti-truck-filled', label: 'Truck' },
  { key: 'delivery', icon: 'ti-truck-delivery-filled', label: 'Delivery' },
  ...
  { key: 'contacts', icon: 'ti-address-book-filled', label: 'Contacts' },
  { key: 'checklist', icon: 'ti-clipboard-list-filled', label: 'Checklist' },
  { key: 'approved', icon: 'ti-clipboard-check-filled', label: 'Approved' },
  { key: 'map-pin', icon: 'ti-map-pin-filled', label: 'Pin' },
  { key: 'map', icon: 'ti-map-filled', label: 'Map' },
  ...
  { key: 'receipt', icon: 'ti-receipt-filled', label: 'Receipt' },
  ...
  { key: 'database', icon: 'ti-database-filled', label: 'Data' },
  { key: 'lock', icon: 'ti-lock-filled', label: 'Lock' },
  { key: 'key', icon: 'ti-key-filled', label: 'Key' },
  { key: 'flag', icon: 'ti-flag-filled', label: 'Flag' },
  { key: 'partner', icon: 'ti-heart-handshake-filled', label: 'Partner' },
  { key: 'support', icon: 'ti-lifebuoy-filled', label: 'Support' },
  { key: 'target', icon: 'ti-target-filled', label: 'Target' },
  { key: 'rocket', icon: 'ti-rocket-filled', label: 'Rocket' },
  { key: 'bolt', icon: 'ti-bolt-filled', label: 'Bolt' },
  { key: 'package', icon: 'ti-package-filled', label: 'Package' },
  { key: 'desktop', icon: 'ti-device-desktop-filled', label: 'Desktop' },
  ...
  { key: 'headset', icon: 'ti-headset-filled', label: 'Headset' },
];
