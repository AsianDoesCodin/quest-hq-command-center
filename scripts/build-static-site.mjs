...
const buildId = 'Forms Builder v21';
...
const formsLayoutRedoCss = `.forms-center{max-width:1360px}.forms-command.panel{min-height:0;padding:12px 14px;margin-bottom:14px;display:flex;justify-content:flex-end;align-items:center;gap:10px}.forms-command .sync-pill{margin-right:auto}.forms-command .primary-button,.forms-command .secondary-button,.forms-command .danger-button{min-height:38px;padding:0 13px}.forms-dashboard{display:none}.forms-center .tabs{margin-bottom:14px}.forms-library-grid{grid-template-columns:320px minmax(0,1fr);gap:14px}.forms-library-panel{align-self:start;min-height:calc(100vh - 230px);padding:14px}.forms-toolbar{grid-template-columns:1fr;gap:10px}.forms-summary{min-height:calc(100vh - 230px);padding:22px}.forms-summary>h2{font-size:28px;margin-bottom:6px}.form-status-row,.summary-pill-grid{grid-template-columns:repeat(3,minmax(150px,1fr));gap:10px;margin-top:14px}.forms-summary-share{grid-template-columns:minmax(0,1fr) auto;align-items:end;margin-top:18px;padding:14px;border-left:4px solid var(--orange)}.forms-summary-share strong{grid-column:1/-1}.forms-summary-share input{min-width:0;height:42px;overflow:hidden;text-overflow:ellipsis}.forms-summary-share .form-actions{grid-column:2;display:flex;gap:8px;white-space:nowrap}.forms-summary-actions{margin-top:14px}.form-card{padding:13px 14px}.form-card strong{font-size:17px}.form-card small{font-size:13px}.forms-preview-grid,.forms-response-grid{grid-template-columns:minmax(0,1fr) 320px;gap:14px}@media(max-width:1100px){.forms-library-grid,.forms-preview-grid,.forms-response-grid{grid-template-columns:1fr}.forms-library-panel,.forms-summary{min-height:0}.forms-summary-share{grid-template-columns:1fr}.forms-summary-share .form-actions{grid-column:1;white-space:normal}.form-status-row,.summary-pill-grid{grid-template-columns:repeat(2,minmax(0,1fr))}}@media(max-width:760px){.forms-command.panel{display:grid;grid-template-columns:1fr 1fr}.forms-command .sync-pill{grid-column:1/-1;margin-right:0;justify-content:center}.forms-command .primary-button,.forms-command .secondary-button,.forms-command .danger-button{width:100%}.form-status-row,.summary-pill-grid{grid-template-columns:1fr}.forms-summary{padding:16px}.forms-summary>h2{font-size:24px}}`;
