(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const o of s)if(o.type==="childList")for(const l of o.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&n(l)}).observe(document,{childList:!0,subtree:!0});function a(s){const o={};return s.integrity&&(o.integrity=s.integrity),s.referrerPolicy&&(o.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?o.credentials="include":s.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function n(s){if(s.ep)return;s.ep=!0;const o=a(s);fetch(s.href,o)}})();const ur="/quest-hq-command-center/assets/quest-secure-workspace-cockpit-tight-CMTSEVW0.png",We={buildId:"Quest HQ Company Workspace v1",localUsername:"lumen123",localPassword:"lumen123",supabaseUrl:"https://lpzotcznihwyyudxycmd.supabase.co",supabaseKey:"sb_publishable_Gd1aHMtItu-7daoq2YofeA_9wl1pQ07"},Be=new URL("/quest-hq-command-center/",window.location.origin).pathname.replace(/\/$/,""),Je="quest-hq-local-session",Mi="quest-hq-local-profile",en="quest-hq-job-cache-v2",tn="quest-hq-task-cache-v1",an="quest-hq-file-cache-v1",nn="quest-hq-drive-folder-cache-v1",sn="quest-hq-team-cache-v1",rn="quest-hq-company-membership-cache-v1",it="quest-hq-company-form-cache-v1",pa="quest-hq-company-form-response-cache-v1",on="quest-hq-finance-invoice-cache-v1",ln="quest-hq-finance-payment-cache-v1",cn="quest-hq-finance-expense-cache-v1",dn="quest-hq-finance-vendor-cache-v1",fa="quest-hq-time-entry-cache-v1",ga="quest-hq-active-timer-v1",De="quest-hq-active-company",un="quest-hq-pending-workspace-review-v1",Fi="quest-hq-task-view",Ii="quest-hq-drive-view",ba="quest-hq-notification-cache-v1",_a="quest-hq-message-conversation-cache-v1",va="quest-hq-message-access-cache-v1",ya="quest-hq-message-cache-v1",ha="quest-hq-message-read-cache-v1",wa="quest-hq-message-attachment-cache-v1",$a="quest-hq-calendar-event-cache-v1",Ke={developer:["*"],admin:["*"],owner:["*"],manager:["jobs.view","jobs.manage","tasks.view","tasks.manage","files.view","files.manage","forms.view","forms.manage","finance.view","team.view","clock.manage","approvals.manage","approvals.view","calendar.view","calendar.manage","calendar.view_team","users.view","settings.view","billing.view","roles.view","messages.view","messages.send","messages.create_group","messages.manage_groups","messages.attach_files"],member:["jobs.view","tasks.view","tasks.manage","files.view","forms.view","time.track","approvals.view","calendar.view","users.view","messages.view","messages.send","messages.attach_files"]},Ti=[["jobs.view","View jobs"],["jobs.manage","Create/edit jobs"],["tasks.view","View tasks"],["tasks.manage","Create/edit tasks"],["files.view","View files"],["files.manage","Upload/delete files"],["forms.view","View forms"],["forms.manage","Create/edit forms"],["crm.view","View CRM"],["finance.view","View finance"],["finance.manage","Create/edit finance"],["users.view","View users"],["users.manage","Invite/manage users"],["roles.view","View roles"],["roles.manage","Create/edit roles"],["billing.view","View billing"],["billing.manage","Manage subscription"],["settings.view","View settings"],["settings.manage","Manage settings"],["time.track","Track own time"],["clock.manage","Manage clock dashboard"],["approvals.view","View approvals"],["approvals.manage","Manage approvals"],["calendar.view","View calendar"],["calendar.manage","Create/edit calendar events"],["calendar.view_team","View team calendar"],["messages.view","View messages"],["messages.send","Send messages"],["messages.create_group","Create group chats"],["messages.manage_groups","Manage group chats"],["messages.attach_files","Attach files/images"],["messages.delete_own","Delete own messages"],["messages.delete_any","Delete any messages"],["messages.manage","Manage messages (compatibility)"]],mr={"messages.manage":["messages.manage_groups"],"messages.manage_groups":["messages.manage"]},st=[{id:"home",group:"Workspace",label:"Home",icon:"ti-home",symbol:"q-logo",status:"live",permission:""},{id:"jobs",group:"Workspace",label:"Jobs",icon:"ti-briefcase",symbol:"q-symbol-jobs",status:"live",permission:"jobs.view"},{id:"tasks",group:"Workspace",label:"Tasks",icon:"ti-list-check",symbol:"q-symbol-tasks",status:"live",permission:"tasks.view"},{id:"files",group:"Workspace",label:"Files",icon:"ti-folder",symbol:"q-symbol-files",status:"live",permission:"files.view"},{id:"forms",group:"Workspace",label:"Forms",icon:"ti-clipboard-list",symbol:"q-symbol-forms",status:"live",permission:"forms.view"},{id:"analytics",group:"Workspace",label:"Analytics",icon:"ti-chart-bar",symbol:"q-symbol-analytics",status:"live",permission:"jobs.view"},{id:"crm",group:"Workspace",label:"CRM",icon:"ti-users-group",symbol:"q-symbol-crm",status:"live",permission:"crm.view"},{id:"tickets",group:"Workspace",label:"Tickets",icon:"ti-ticket",symbol:"q-symbol-tickets",status:"planned"},{id:"finance",group:"Workspace",label:"Finance",icon:"ti-receipt-dollar",symbol:"q-symbol-finance",status:"live",permission:"finance.view"},{id:"knowledge",group:"Workspace",label:"Knowledge Base",icon:"ti-books",symbol:"q-symbol-knowledge",status:"planned"},{id:"automations",group:"Workspace",label:"Automations",icon:"ti-automation",symbol:"q-symbol-automations",status:"planned"},{id:"templates",group:"Workspace",label:"Templates",icon:"ti-template",symbol:"q-symbol-templates",status:"planned"},{id:"users",group:"Company",label:"Users",icon:"ti-users",symbol:"q-symbol-users",status:"live",permission:"users.view"},{id:"messages",group:"Company",label:"Messages",icon:"ti-messages",symbol:"q-symbol-messages",status:"live",permission:"messages.view"},{id:"settings",group:"Company",label:"Settings",icon:"ti-settings",symbol:"q-symbol-settings",status:"live",permission:"settings.view"},{id:"team-chart",group:"Company",label:"Team chart",icon:"ti-hierarchy-3",symbol:"q-symbol-team-chart",status:"live",permission:"team.view"},{id:"time",group:"Operations",label:"My time",icon:"ti-clock",symbol:"q-symbol-time",status:"live",permission:"time.track"},{id:"calendar",group:"Operations",label:"Calendar",icon:"ti-calendar",symbol:"q-symbol-calendar",status:"live",permission:"calendar.view"},{id:"approvals",group:"Operations",label:"Approvals",icon:"ti-user-check",symbol:"q-symbol-approvals",status:"live",permission:"approvals.view"},{id:"team-workload",group:"Operations",label:"Team workload",icon:"ti-users",symbol:"q-symbol-team-workload",status:"planned"},{id:"clock",group:"Operations",label:"Clock dashboard",icon:"ti-clock-hour-4",symbol:"q-symbol-clock",status:"live",permission:"clock.manage"}],pr={"/admin.html":"settings","/automations.html":"automations","/calendar.html":"calendar","/crm.html":"crm","/dashboards.html":"analytics","/files.html":"files","/finance.html":"finance","/forms.html":"forms","/jobs.html":"jobs","/knowledge.html":"knowledge","/messages.html":"messages","/templates.html":"templates","/tickets.html":"tickets"},Dt=["Lead","Site Review","Estimate","Approved","Active","Closed"],Ei=["pipeline","list","profile"],Ct=["todo","pending","hold","review","done"],ea=["critical","urgent","high","medium","low"],xi=["lead","bid","admin","invoicing","ar","meeting","web_dev"],Sa=["Company event","Job visit / inspection","Estimate appointment","Install / field work","Internal meeting","Personal reminder"],fr=["Task due","Invoice due","Approval","Time"].concat(Sa),gr="https://cdn.jsdelivr.net/gh/vscode-icons/vscode-icons@master/icons/",br=["All categories","Shared","Jobs","Forms","Photos","Permits","Contracts","Archive"],mn=[["jobs","Jobs","Job-linked folders and deliverables","ti-folders"],["shared","Shared","Company-wide files","ti-folder-share"],["forms","Forms","Completed forms and templates","ti-clipboard-list"],["photos","Photos","Site photos and field media","ti-photo"],["permits","Permits","Permit packets and approvals","ti-file-certificate"],["contracts","Contracts","Signed agreements and estimates","ti-file-dollar"],["archive","Archive","Closed or historical files","ti-archive"]],jt=["Inspection","Client approval","Intake","Survey","Safety","Internal"],pn=["Draft","Published","Archived"],Oi=["Draft","Sent","Partially paid","Paid","Overdue","Void"],Ri=["Pending","Approved","Paid","Rejected"],Pi=["Active","On hold","Inactive"],Ui=["ACH","Check","Card","Cash","Wire","Other"],ka=["Materials","Labor","Subcontractor","Permit","Equipment","Marketing","Software","Travel","Other"],fn=["company","role","custom","direct"],qt=[["short","Short answer"],["paragraph","Paragraph"],["multiple","Multiple choice"],["checkbox","Checkboxes"],["dropdown","Dropdown"],["date","Date"],["rating","Rating"],["yesno","Yes / No"],["file","File upload"]],At=[{id:"roofing",name:"Quest Roofing",short_name:"Roofing",color:"#f0b23b"},{id:"drafting",name:"Quest Drafting",short_name:"Drafting",color:"#60a5fa"},{id:"lumen",name:"Lumen Marketing",short_name:"Lumen",color:"#a78bfa"}],Ni=[{id:"11111111-1111-4111-8111-111111111111",company_id:"roofing",name:"Queen Creek Leak Follow-up",client_name:"Rosales Residence",contact_name:"Maya Rosales",site_address:"Queen Creek, AZ",job_type:"Roofing repair",stage:"Active",priority:"Urgent",owner_name:"Andre Lee",scope:"Emergency leak inspection, dry-in, and repair proposal.",notes:"Client reported active leak after monsoon storm.",estimate_total:6800,invoice_total:0,task_count:4,file_count:5,updated_at:new Date().toISOString()},{id:"22222222-2222-4222-8222-222222222222",company_id:"roofing",name:"Mesa Storage Roof Repair",client_name:"Mesa Storage Partners",contact_name:"D. Harris",site_address:"Mesa, AZ",job_type:"Commercial repair",stage:"Estimate",priority:"High",owner_name:"Maya Rosales",scope:"Inspect roof membrane, prepare repair estimate, and attach permit packet.",notes:"Board wants estimate and permit notes before approval.",estimate_total:18400,invoice_total:0,task_count:3,file_count:4,updated_at:new Date(Date.now()-864e5).toISOString()},{id:"33333333-3333-4333-8333-333333333333",company_id:"drafting",name:"Drafting Permit Package",client_name:"Horizon HVAC",contact_name:"Noah Park",site_address:"Chandler, AZ",job_type:"Drafting",stage:"Site Review",priority:"Medium",owner_name:"Noah Park",scope:"Prepare drawing package and client approval form.",notes:"Waiting on latest measurements.",estimate_total:4200,invoice_total:0,task_count:2,file_count:3,updated_at:new Date(Date.now()-1728e5).toISOString()}],Li=[{id:"abraham",name:"Abraham",full_name:"Abraham Flores",email:"abraham@quest-hq.local",color:"#f0b23b",active:!0,company_ids:["roofing","drafting"],supervisor_id:""},{id:"maya",name:"Maya",full_name:"Maya Rosales",email:"maya@quest-hq.local",color:"#60a5fa",active:!0,company_ids:["roofing"],supervisor_id:"abraham"},{id:"andre",name:"Andre",full_name:"Andre Lee",email:"andre@quest-hq.local",color:"#f97316",active:!0,company_ids:["roofing"],supervisor_id:"maya"},{id:"noah",name:"Noah",full_name:"Noah Park",email:"noah@quest-hq.local",color:"#a78bfa",active:!0,company_ids:["drafting"],supervisor_id:"abraham"},{id:"lumen-ops",name:"Lumen Ops",full_name:"Lumen Operations",email:"ops@lumen.local",color:"#7c3aed",active:!0,company_ids:["lumen"],supervisor_id:""}],Qi=[{company_id:"roofing",profile_id:"basic-quest-user",role:"developer",status:"active"},{company_id:"drafting",profile_id:"basic-quest-user",role:"developer",status:"active"},{company_id:"lumen",profile_id:"basic-quest-user",role:"developer",status:"active"}],Vi=[{id:"task-roofing-leak-1",title:"Call client and confirm active leak area",description:"Confirm access window, roof area, and whether temporary dry-in is still holding.",type:"lead",company_id:"roofing",project_id:"11111111-1111-4111-8111-111111111111",creator_id:"abraham",assignee_id:"maya",due:k(0),priority:"urgent",urgency:"urgent",status:"todo"},{id:"task-roofing-leak-2",title:"Upload inspection photos",description:"Attach site photos to the company drive and tag the Queen Creek job folder.",type:"admin",company_id:"roofing",project_id:"11111111-1111-4111-8111-111111111111",creator_id:"maya",assignee_id:"andre",due:k(1),priority:"high",urgency:"high",status:"pending"},{id:"task-roofing-mesa-1",title:"Prepare repair estimate packet",description:"Draft scope, estimate total, and permit notes for board review.",type:"bid",company_id:"roofing",project_id:"22222222-2222-4222-8222-222222222222",creator_id:"abraham",assignee_id:"maya",due:k(3),priority:"high",urgency:"high",status:"review"},{id:"task-drafting-package-1",title:"Request final measurements",description:"Get latest field measurements before starting permit drawings.",type:"admin",company_id:"drafting",project_id:"33333333-3333-4333-8333-333333333333",creator_id:"abraham",assignee_id:"noah",due:k(2),priority:"medium",urgency:"medium",status:"hold"},{id:"task-lumen-ops-1",title:"Create client onboarding checklist",description:"Internal Lumen setup task to prove company workspace isolation.",type:"meeting",company_id:"lumen",project_id:"",creator_id:"abraham",assignee_id:"lumen-ops",due:k(5),priority:"medium",urgency:"medium",status:"todo"}],Yi=[{id:"file-roofing-1",company_id:"roofing",job_id:"11111111-1111-4111-8111-111111111111",folder:"photos",file_name:"queen-creek-leak-photos.zip",mime_type:"application/zip",size_bytes:184e5,category:"Photos",uploaded_by_label:"Maya Rosales",created_at:new Date(Date.now()-36e5).toISOString()},{id:"file-roofing-2",company_id:"roofing",job_id:"22222222-2222-4222-8222-222222222222",folder:"permits",file_name:"mesa-storage-permit-notes.pdf",mime_type:"application/pdf",size_bytes:86e4,category:"Permits",uploaded_by_label:"Andre Lee",created_at:new Date(Date.now()-864e5).toISOString()},{id:"file-drafting-1",company_id:"drafting",job_id:"33333333-3333-4333-8333-333333333333",folder:"contracts",file_name:"horizon-hvac-drawing-agreement.pdf",mime_type:"application/pdf",size_bytes:42e4,category:"Contracts",uploaded_by_label:"Noah Park",created_at:new Date(Date.now()-1728e5).toISOString()},{id:"file-lumen-1",company_id:"lumen",job_id:"",folder:"shared",file_name:"lumen-shared-brand-assets.zip",mime_type:"application/zip",size_bytes:32e5,category:"Shared",uploaded_by_label:"Lumen Operations",created_at:new Date(Date.now()-2592e5).toISOString()}],Bi=[{id:"form-roofing-inspection",company_id:"roofing",title:"Roof Inspection Checklist",description:"Field checklist for leak calls, roof condition notes, photos, and repair recommendations.",type:"Inspection",status:"Published",audience:"Field team",creator_id:"abraham",linked_job_id:"11111111-1111-4111-8111-111111111111",theme_color:"#f0b23b",background:"paper",submit_label:"Submit inspection",collect_email:!0,require_approval:!1,created_at:new Date(Date.now()-6048e5).toISOString(),updated_at:new Date(Date.now()-864e5).toISOString(),questions:[{id:"q-roof-1",type:"short",label:"Inspection address",help:"Confirm the address before submitting.",required:!0},{id:"q-roof-2",type:"multiple",label:"Primary roof condition",help:"",required:!0,options:["Active leak","Storm damage","Aged underlayment","Maintenance issue"]},{id:"q-roof-3",type:"paragraph",label:"Recommended scope",help:"Write the repair or estimate recommendation.",required:!0},{id:"q-roof-4",type:"file",label:"Attach inspection photos",help:"Upload photos into the company drive after submit.",required:!1}]},{id:"form-roofing-estimate-approval",company_id:"roofing",title:"Estimate Approval",description:"Client-facing approval form for estimate review and signature follow-up.",type:"Client approval",status:"Draft",audience:"Client",creator_id:"maya",linked_job_id:"22222222-2222-4222-8222-222222222222",theme_color:"#f45d22",background:"clean",submit_label:"Approve estimate",collect_email:!0,require_approval:!0,created_at:new Date(Date.now()-432e6).toISOString(),updated_at:new Date(Date.now()-72e5).toISOString(),questions:[{id:"q-est-1",type:"short",label:"Client name",required:!0},{id:"q-est-2",type:"yesno",label:"Do you approve the attached estimate?",required:!0},{id:"q-est-3",type:"paragraph",label:"Questions or requested changes",required:!1}]},{id:"form-drafting-intake",company_id:"drafting",title:"Drafting Permit Intake",description:"Collect measurements, equipment details, and permit packet requirements.",type:"Intake",status:"Published",audience:"Client",creator_id:"noah",linked_job_id:"33333333-3333-4333-8333-333333333333",theme_color:"#60a5fa",background:"grid",submit_label:"Send intake",collect_email:!0,require_approval:!1,created_at:new Date(Date.now()-5184e5).toISOString(),updated_at:new Date(Date.now()-1728e5).toISOString(),questions:[{id:"q-draft-1",type:"short",label:"Project address",required:!0},{id:"q-draft-2",type:"paragraph",label:"Permit notes",required:!1},{id:"q-draft-3",type:"date",label:"Needed by",required:!0}]},{id:"form-lumen-onboarding",company_id:"lumen",title:"Client Onboarding Intake",description:"Initial Lumen setup form for client goals, assets, users, and launch timing.",type:"Intake",status:"Draft",audience:"Client",creator_id:"lumen-ops",linked_job_id:"",theme_color:"#a78bfa",background:"clean",submit_label:"Submit onboarding",collect_email:!0,require_approval:!1,created_at:new Date(Date.now()-3456e5).toISOString(),updated_at:new Date(Date.now()-2592e5).toISOString(),questions:[{id:"q-lumen-1",type:"short",label:"Company name",required:!0},{id:"q-lumen-2",type:"checkbox",label:"Needed services",required:!0,options:["Website","SEO","Paid ads","CRM setup"]},{id:"q-lumen-3",type:"paragraph",label:"Launch goals",required:!1}]}],Hi=[{id:"response-roofing-1",company_id:"roofing",form_id:"form-roofing-inspection",submitted_by:"Maya Rosales",created_at:new Date(Date.now()-36e5).toISOString(),answers:{"q-roof-1":"Queen Creek, AZ","q-roof-2":"Active leak","q-roof-3":"Dry-in held. Prepare repair estimate and photo packet."}}],zi=[{id:"vendor-roofing-materials",company_id:"roofing",name:"Valley Roofing Supply",contact_name:"Elena Ortiz",email:"orders@valleyroofingsupply.local",phone:"(480) 555-0190",category:"Materials",status:"Active",notes:"Primary tile, flashing, and underlayment vendor.",created_at:new Date(Date.now()-12096e5).toISOString(),updated_at:new Date(Date.now()-864e5).toISOString()},{id:"vendor-roofing-dryin",company_id:"roofing",name:"Monsoon Dry-In Crew",contact_name:"R. Alvarez",email:"dispatch@monsoondryin.local",phone:"(602) 555-0144",category:"Subcontractor",status:"Active",notes:"Emergency dry-in support during storm calls.",created_at:new Date(Date.now()-10368e5).toISOString(),updated_at:new Date(Date.now()-1728e5).toISOString()},{id:"vendor-drafting-permits",company_id:"drafting",name:"Permit Runner AZ",contact_name:"Sofia Chen",email:"permits@runneraz.local",phone:"(602) 555-0171",category:"Permit",status:"Active",notes:"Permit filing support for drafting packets.",created_at:new Date(Date.now()-864e6).toISOString(),updated_at:new Date(Date.now()-2592e5).toISOString()},{id:"vendor-lumen-software",company_id:"lumen",name:"Lumen SaaS Stack",contact_name:"Ops Billing",email:"billing@lumenstack.local",phone:"",category:"Software",status:"Active",notes:"Internal software subscriptions for client onboarding.",created_at:new Date(Date.now()-7776e5).toISOString(),updated_at:new Date(Date.now()-3456e5).toISOString()}],Wi=[{id:"invoice-roofing-queen-creek",company_id:"roofing",job_id:"11111111-1111-4111-8111-111111111111",client_name:"Rosales Residence",invoice_number:"QR-1007",status:"Partially paid",issue_date:k(-10),due_date:k(5),subtotal:6800,tax:0,total:6800,notes:"Emergency leak repair billing with deposit received.",created_at:new Date(Date.now()-864e6).toISOString(),updated_at:new Date(Date.now()-864e5).toISOString()},{id:"invoice-roofing-mesa-storage",company_id:"roofing",job_id:"22222222-2222-4222-8222-222222222222",client_name:"Mesa Storage Partners",invoice_number:"QR-1008",status:"Sent",issue_date:k(-18),due_date:k(-2),subtotal:18400,tax:0,total:18400,notes:"Estimate packet sent to board for approval.",created_at:new Date(Date.now()-15552e5).toISOString(),updated_at:new Date(Date.now()-1728e5).toISOString()},{id:"invoice-drafting-horizon",company_id:"drafting",job_id:"33333333-3333-4333-8333-333333333333",client_name:"Horizon HVAC",invoice_number:"QD-2031",status:"Sent",issue_date:k(-7),due_date:k(14),subtotal:4200,tax:0,total:4200,notes:"Drafting permit package milestone invoice.",created_at:new Date(Date.now()-6048e5).toISOString(),updated_at:new Date(Date.now()-1728e5).toISOString()},{id:"invoice-lumen-onboarding",company_id:"lumen",job_id:"",client_name:"Lumen Internal Launch",invoice_number:"LM-3004",status:"Draft",issue_date:k(-3),due_date:k(27),subtotal:3200,tax:0,total:3200,notes:"Demo onboarding package used for finance workspace.",created_at:new Date(Date.now()-2592e5).toISOString(),updated_at:new Date(Date.now()-864e5).toISOString()}],Ji=[{id:"payment-roofing-queen-creek-deposit",company_id:"roofing",invoice_id:"invoice-roofing-queen-creek",amount:2500,method:"ACH",received_at:k(-4),reference:"ACH-4421",notes:"Deposit received after dry-in visit.",created_at:new Date(Date.now()-3456e5).toISOString()},{id:"payment-drafting-horizon-retainer",company_id:"drafting",invoice_id:"invoice-drafting-horizon",amount:1e3,method:"Check",received_at:k(-1),reference:"CHK-117",notes:"Retainer collected before permit packet completion.",created_at:new Date(Date.now()-864e5).toISOString()}],Ki=[{id:"expense-roofing-queen-creek-materials",company_id:"roofing",job_id:"11111111-1111-4111-8111-111111111111",vendor_id:"vendor-roofing-materials",category:"Materials",amount:1850,status:"Approved",spent_at:k(-6),notes:"Underlayment, flashing, and tile replacement materials.",created_at:new Date(Date.now()-5184e5).toISOString(),updated_at:new Date(Date.now()-864e5).toISOString()},{id:"expense-roofing-mesa-permit",company_id:"roofing",job_id:"22222222-2222-4222-8222-222222222222",vendor_id:"vendor-roofing-materials",category:"Permit",amount:620,status:"Pending",spent_at:k(-2),notes:"Permit and document prep allowance.",created_at:new Date(Date.now()-1728e5).toISOString(),updated_at:new Date(Date.now()-72e5).toISOString()},{id:"expense-drafting-horizon-runner",company_id:"drafting",job_id:"33333333-3333-4333-8333-333333333333",vendor_id:"vendor-drafting-permits",category:"Permit",amount:480,status:"Approved",spent_at:k(-3),notes:"Permit runner package review.",created_at:new Date(Date.now()-2592e5).toISOString(),updated_at:new Date(Date.now()-864e5).toISOString()},{id:"expense-lumen-software-stack",company_id:"lumen",job_id:"",vendor_id:"vendor-lumen-software",category:"Software",amount:540,status:"Paid",spent_at:k(-5),notes:"Client onboarding software stack.",created_at:new Date(Date.now()-432e6).toISOString(),updated_at:new Date(Date.now()-1728e5).toISOString()}],Gi=[{id:"notification-roofing-task-assigned",company_id:"roofing",recipient_profile_id:"basic-quest-user",type:"task.assigned",title:"Task assigned",body:"Abraham assigned Leak inspection photos to you.",href:"/company/roofing/tasks?job_id=roofing-leak&task_id=task-roofing-leak-1",source_type:"task",source_id:"task-roofing-leak-1",read_at:"",created_at:new Date(Date.now()-7*6e4).toISOString()},{id:"notification-roofing-task-priority",company_id:"roofing",recipient_profile_id:"basic-quest-user",type:"task.priority",title:"Task priority changed",body:"Shan set priority to Urgent on HOA board approval package.",href:"/company/roofing/tasks?job_id=roofing-mesa&task_id=task-roofing-mesa-1",source_type:"task",source_id:"task-roofing-mesa-1",read_at:"",created_at:new Date(Date.now()-19*6e4).toISOString()},{id:"notification-roofing-approval",company_id:"roofing",recipient_profile_id:"basic-quest-user",type:"approval.ready",title:"Approval needs review",body:"Estimate approval is waiting in the company review queue.",href:"/company/roofing/approvals",source_type:"form",source_id:"form-roofing-estimate-approval",read_at:new Date(Date.now()-5*6e4).toISOString(),created_at:new Date(Date.now()-44*6e4).toISOString()},{id:"notification-drafting-task-review",company_id:"drafting",recipient_profile_id:"basic-quest-user",type:"task.status",title:"Task moved to review",body:"Drawing package QA is ready for review.",href:"/company/drafting/tasks?job_id=drafting-package&task_id=task-drafting-package-1",source_type:"task",source_id:"task-drafting-package-1",read_at:"",created_at:new Date(Date.now()-63*6e4).toISOString()},{id:"notification-lumen-finance",company_id:"lumen",recipient_profile_id:"basic-quest-user",type:"finance.invoice",title:"Invoice drafted",body:"Lumen onboarding invoice is ready for payment tracking.",href:"/company/lumen/finance?invoice=invoice-lumen-onboarding",source_type:"invoice",source_id:"invoice-lumen-onboarding",read_at:"",created_at:new Date(Date.now()-92*6e4).toISOString()}],gn=[{id:"msg-conv-roofing-all",company_id:"roofing",title:"Roofing dispatch",type:"company",created_by:"basic-quest-user",last_message_at:new Date(Date.now()-16*6e4).toISOString(),created_at:new Date(Date.now()-864e5).toISOString(),updated_at:new Date(Date.now()-16*6e4).toISOString()},{id:"msg-conv-roofing-crew",company_id:"roofing",title:"Roofing crew",type:"role",created_by:"basic-quest-user",last_message_at:new Date(Date.now()-52*6e4).toISOString(),created_at:new Date(Date.now()-1728e5).toISOString(),updated_at:new Date(Date.now()-52*6e4).toISOString()},{id:"msg-conv-roofing-direct-shan",company_id:"roofing",title:"Shan Kumar",type:"direct",created_by:"basic-quest-user",last_message_at:new Date(Date.now()-8*6e4).toISOString(),created_at:new Date(Date.now()-36e5).toISOString(),updated_at:new Date(Date.now()-8*6e4).toISOString()},{id:"msg-conv-drafting-all",company_id:"drafting",title:"Drafting review",type:"company",created_by:"basic-quest-user",last_message_at:new Date(Date.now()-74*6e4).toISOString(),created_at:new Date(Date.now()-2592e5).toISOString(),updated_at:new Date(Date.now()-74*6e4).toISOString()},{id:"msg-conv-lumen-product",company_id:"lumen",title:"Lumen launch room",type:"custom",created_by:"basic-quest-user",last_message_at:new Date(Date.now()-38*6e4).toISOString(),created_at:new Date(Date.now()-216e5).toISOString(),updated_at:new Date(Date.now()-38*6e4).toISOString()}],bn=[{id:"msg-access-roofing-all",conversation_id:"msg-conv-roofing-all",company_id:"roofing",target_type:"all_company",target_id:"all"},{id:"msg-access-roofing-crew-role",conversation_id:"msg-conv-roofing-crew",company_id:"roofing",target_type:"role",target_id:"staff-roofing"},{id:"msg-access-roofing-direct-basic",conversation_id:"msg-conv-roofing-direct-shan",company_id:"roofing",target_type:"profile",target_id:"basic-quest-user"},{id:"msg-access-roofing-direct-shan",conversation_id:"msg-conv-roofing-direct-shan",company_id:"roofing",target_type:"profile",target_id:"shan"},{id:"msg-access-drafting-all",conversation_id:"msg-conv-drafting-all",company_id:"drafting",target_type:"all_company",target_id:"all"},{id:"msg-access-lumen-basic",conversation_id:"msg-conv-lumen-product",company_id:"lumen",target_type:"profile",target_id:"basic-quest-user"},{id:"msg-access-lumen-role",conversation_id:"msg-conv-lumen-product",company_id:"lumen",target_type:"role",target_id:"admin-lumen"}],_n=[{id:"msg-roofing-all-1",conversation_id:"msg-conv-roofing-all",company_id:"roofing",sender_profile_id:"abraham",body:"Morning check: Mesa HOA estimate needs photos before noon.",message_type:"text",deleted_at:"",created_at:new Date(Date.now()-48*6e4).toISOString(),updated_at:new Date(Date.now()-48*6e4).toISOString()},{id:"msg-roofing-all-2",conversation_id:"msg-conv-roofing-all",company_id:"roofing",sender_profile_id:"basic-quest-user",body:"Got it. I am linking the job files now.",message_type:"text",deleted_at:"",created_at:new Date(Date.now()-16*6e4).toISOString(),updated_at:new Date(Date.now()-16*6e4).toISOString()},{id:"msg-roofing-crew-1",conversation_id:"msg-conv-roofing-crew",company_id:"roofing",sender_profile_id:"shan",body:"@Joshua bring the permit packet when you head to Arroyo.",message_type:"text",deleted_at:"",created_at:new Date(Date.now()-52*6e4).toISOString(),updated_at:new Date(Date.now()-52*6e4).toISOString()},{id:"msg-roofing-direct-1",conversation_id:"msg-conv-roofing-direct-shan",company_id:"roofing",sender_profile_id:"shan",body:"Can you confirm the roof access photo uploaded correctly?",message_type:"text",deleted_at:"",created_at:new Date(Date.now()-8*6e4).toISOString(),updated_at:new Date(Date.now()-8*6e4).toISOString()},{id:"msg-drafting-all-1",conversation_id:"msg-conv-drafting-all",company_id:"drafting",sender_profile_id:"abraham",body:"Horizon package QA is ready. Please keep notes in this thread.",message_type:"text",deleted_at:"",created_at:new Date(Date.now()-74*6e4).toISOString(),updated_at:new Date(Date.now()-74*6e4).toISOString()},{id:"msg-lumen-product-1",conversation_id:"msg-conv-lumen-product",company_id:"lumen",sender_profile_id:"basic-quest-user",body:"Finance and CRM are live enough for internal walkthrough. Next focus is polish and permissions.",message_type:"text",deleted_at:"",created_at:new Date(Date.now()-38*6e4).toISOString(),updated_at:new Date(Date.now()-38*6e4).toISOString()}],vn=[{id:"msg-attachment-roofing-photo",conversation_id:"msg-conv-roofing-crew",message_id:"msg-roofing-crew-1",company_id:"roofing",bucket_id:"quest-message-attachments",object_path:"",file_name:"roof-access-photo.jpg",mime_type:"image/jpeg",size_bytes:184e3,preview_url:"",created_at:new Date(Date.now()-52*6e4).toISOString()}],yn=[{conversation_id:"msg-conv-roofing-all",company_id:"roofing",profile_id:"basic-quest-user",last_read_at:new Date(Date.now()-10*6e4).toISOString()},{conversation_id:"msg-conv-roofing-crew",company_id:"roofing",profile_id:"basic-quest-user",last_read_at:""},{conversation_id:"msg-conv-roofing-direct-shan",company_id:"roofing",profile_id:"basic-quest-user",last_read_at:""},{conversation_id:"msg-conv-drafting-all",company_id:"drafting",profile_id:"basic-quest-user",last_read_at:""},{conversation_id:"msg-conv-lumen-product",company_id:"lumen",profile_id:"basic-quest-user",last_read_at:""}],Zi=[{id:"calendar-roofing-install",company_id:"roofing",title:"East ridge install window",description:"Crew visit for install prep and materials check.",event_type:"Install / field work",starts_at:`${k(1)}T14:00:00.000Z`,ends_at:`${k(1)}T17:00:00.000Z`,all_day:!1,visibility:"company",linked_type:"job",linked_id:"job-east-ridge",assigned_profile_id:"abraham",created_by:"basic-quest-user"},{id:"calendar-roofing-estimate",company_id:"roofing",title:"Garage roof estimate",description:"Client walkthrough and estimate appointment.",event_type:"Estimate appointment",starts_at:`${k(3)}T16:00:00.000Z`,ends_at:`${k(3)}T17:00:00.000Z`,all_day:!1,visibility:"company",linked_type:"",linked_id:"",assigned_profile_id:"shan",created_by:"basic-quest-user"},{id:"calendar-drafting-review",company_id:"drafting",title:"Plan review block",description:"Drafting team review for active plan updates.",event_type:"Internal meeting",starts_at:`${k(2)}T15:00:00.000Z`,ends_at:`${k(2)}T15:45:00.000Z`,all_day:!1,visibility:"company",linked_type:"",linked_id:"",assigned_profile_id:"",created_by:"basic-quest-user"},{id:"calendar-lumen-product",company_id:"lumen",title:"Quest HQ product review",description:"Review workspace permissions, messages, and calendar flow.",event_type:"Company event",starts_at:`${k(4)}T18:00:00.000Z`,ends_at:`${k(4)}T19:00:00.000Z`,all_day:!1,visibility:"company",linked_type:"",linked_id:"",assigned_profile_id:"basic-quest-user",created_by:"basic-quest-user"}],i={route:null,session:$e(Je,null),profileDraft:$e(Mi,null),authReady:!1,authMode:"signin",jobs:A(en,Ni).map(Xe),tasks:A(tn,Vi).map(et),files:A(an,Yi).map(vt),driveFolders:A(nn,[]).map(Un),forms:A(it,Bi).map(Pt),formResponses:A(pa,Hi).map(Nn),financeInvoices:A(on,Wi).map(Ut),financePayments:A(ln,Ji).map(Nt),financeExpenses:A(cn,Ki).map(Lt),financeVendors:A(dn,zi).map(Qt),notifications:A(ba,Gi).map(ht),messageConversations:A(_a,gn).map(ve),messageAccess:A(va,bn).map(ee),messages:A(ya,_n).map(Se),messageReads:A(ha,yn).map(Vt),messageAttachments:A(wa,vn).map(Ee),calendarEvents:A($a,Zi).map(tt),timeEntries:$e(fa,[]),activeTimer:$e(ga,null),teamMembers:A(sn,Li).map(Ln),memberships:A(rn,Qi),profiles:[],subscriptions:[],workspaceReviews:[],roles:[],rolePermissions:[],roleAssignments:[],resourceAcl:[],fieldPermissions:[],companyInvites:[],joinRequests:[],auditEvents:[],companies:Pn(At.map(Ze)),activeCompanyId:localStorage.getItem(De)||"",selectedJobId:"",selectedTaskId:"",selectedFileId:"",selectedFormId:"",selectedQuestionId:"",selectedFinanceInvoiceId:"",selectedFinanceExpenseId:"",selectedFinanceVendorId:"",selectedCalendarEventId:"",inviteLookup:null,expandedFormIds:new Set,formStartTemplateId:"",formStartTab:"blank",query:"",fileQuery:"",formQuery:"",crmQuery:"",stageFilter:"all",crmStageFilter:"all",crmOwnerFilter:"all",messageQuery:"",messageFilter:"all",selectedConversationId:"",messageRealtimeChannel:null,messageRealtimeKey:"",calendarScope:"company",calendarView:"week",calendarQuery:"",calendarTypeFilter:"all",calendarCursorDate:k(0),taskStatusFilter:"all",taskPriorityFilter:"all",fileCategoryFilter:"All categories",formTypeFilter:"all",formsTab:"library",formEditorTab:"questions",taskView:localStorage.getItem(Fi)||"table",driveFolder:"home",driveView:localStorage.getItem(Ii)||"list",sync:{label:"Loading workspace...",mode:"loading"},dataLoaded:!1,dataLoading:!1,loginError:"",authMessage:"",toast:null,toastTimer:null,modal:"",accountMenuOpen:!1,notificationMenuOpen:!1,rolePreview:null},Da=document.getElementById("app");let Ya=null;_r();function _r(){xc(),window.addEventListener("popstate",p),document.addEventListener("click",Pl),document.addEventListener("submit",Ll),document.addEventListener("input",gc),document.addEventListener("change",bc),vr(),p()}async function vr(){if(i.session?.auth==="local-basic"){Xi(),i.authReady=!0;return}const e=q();if(!e?.auth){i.authReady=!0,i.loginError="Supabase auth is unavailable in this browser session.";return}try{const{data:t}=await e.auth.getSession();await pt(t?.session||null),e.auth.onAuthStateChange((a,n)=>{pt(n||null).finally(()=>{i.dataLoaded=!1,p()})})}catch(t){i.loginError=t.message||"Unable to initialize Supabase auth."}finally{i.authReady=!0,p()}}async function pt(e){if(!e?.user){i.session=null,localStorage.removeItem(Je);return}const t=await yr(e.user);i.session=Bd(e,t),Dr(),D(Je,i.session)}async function yr(e){const t={id:e.id,email:e.email||"",full_name:e.user_metadata?.full_name||e.email||"Quest user",role:"member",role_label:"Member",member_id:"",company_ids:[],avatar_url:"",approved:!1,email_verified:!!e.email_confirmed_at},a=q();if(!a)return t;const n=await a.from("profiles").select("*").eq("id",e.id).maybeSingle();return n.error||!n.data?t:yt(n.data,t)}function p(){if(i.route=Mt(),!i.authReady){$r();return}if(i.route.name==="home"){pi(!1);return}if(i.route.name==="login"){pi(!0);return}if(wr(i.route)){j("/login?return_url="+encodeURIComponent(Rc()),{replace:!0});return}if(Sr(),i.session?.auth==="supabase"&&i.dataLoaded&&!Ue().length){hr();return}const e=Oc(i.route);if(e){j(e,{replace:!0});return}Qc(i.route),gs(i.route),i.route.params.get("account")==="profile"&&(i.modal="profile"),document.title=`${Pc(i.route)} | ${E(u())} | Quest HQ`,Da.innerHTML=qr(i.route,as(i.route))}function hr(){document.title="Company access pending | Quest HQ",Da.innerHTML=`
  ...
  `}function wr(e){return e.name==="login"||e.name==="home"?!1:!i.session}function $r(){document.title="Loading | Quest HQ",Da.innerHTML=`
    <main class="login-shell">
      <section class="login-panel">
        <div class="login-brand">
          <span class="side-mark">Q</span>
  ...
  `}function Sr(){i.dataLoaded||i.dataLoading||(i.dataLoading=!0,kr().catch(()=>{i.sync={label:"Local fallback",mode:"local"}}).finally(()=>{i.dataLoaded=!0,i.dataLoading=!1,Z(),p()}))}async function kr(){if(i.session?.auth==="local-basic"){i.sync={label:"Demo mode",mode:"local"};return}const e=q();if(!e){i.sync={label:"Supabase unavailable",mode:"local"};return}const[t,a,n,s,o,l,c,d,f,g,S,V,T,ne,Me,N,Kn,Gn,Zn,Xn,ei,ti,ai,ni,ii,si,ri]=await Promise.all([e.from("companies").select("*").order("name",{ascending:!0}),e.from("jobs").select("*").order("updated_at",{ascending:!1}),e.from("tasks").select("*").order("updated_at",{ascending:!1}),e.from("job_files").select("*").is("deleted_at",null).order("created_at",{ascending:!1}),e.from("team_members").select("*").order("name",{ascending:!0}),e.from("company_memberships").select("*"),e.from("profiles").select("*"),e.from("company_subscriptions").select("*"),e.from("roles").select("*").order("priority",{ascending:!1}),e.from("role_permissions").select("*"),e.from("user_role_assignments").select("*"),e.from("resource_acl").select("*"),e.from("field_permissions").select("*"),e.from("company_invites").select("*").order("created_at",{ascending:!1}),e.from("company_join_requests").select("*").order("created_at",{ascending:!1}),e.from("audit_events").select("*").order("created_at",{ascending:!1}).limit(100),e.from("message_conversations").select("*").order("last_message_at",{ascending:!1}),e.from("message_conversation_access").select("*"),e.from("messages").select("*").order("created_at",{ascending:!0}).limit(500),e.from("message_attachments").select("*").order("created_at",{ascending:!0}).limit(500),e.from("message_reads").select("*"),e.from("calendar_events").select("*").order("starts_at",{ascending:!0}),e.from("notifications").select("*").order("created_at",{ascending:!1}).limit(200),e.from("finance_invoices").select("*").order("updated_at",{ascending:!1}),e.from("finance_payments").select("*").order("received_at",{ascending:!1}),e.from("finance_expenses").select("*").order("spent_at",{ascending:!1}),e.from("finance_vendors").select("*").order("name",{ascending:!0})]);let le=0;if(t.error||(i.companies=(t.data||[]).map(Ze),le+=1),a.error||(i.jobs=(a.data||[]).map(Xe),le+=1),n.error||(i.tasks=(n.data||[]).map(et),le+=1),s.error||(i.files=(s.data||[]).map(vt),le+=1),o.error||(i.teamMembers=(o.data||[]).map(Ln),le+=1),l.error||(i.memberships=(l.data||[]).map(ra),le+=1),c.error||(i.profiles=(c.data||[]).map(Ht=>yt(Ht)),le+=1),d.error||(i.subscriptions=(d.data||[]).map(oa),le+=1),f.error||(i.roles=(f.data||[]).map(He),le+=1),g.error||(i.rolePermissions=(g.data||[]).map(Ga)),S.error||(i.roleAssignments=(S.data||[]).map(Rs)),V.error||(i.resourceAcl=(V.data||[]).map(Ad)),T.error||(i.fieldPermissions=(T.data||[]).map(Md)),ne.error||(i.companyInvites=(ne.data||[]).map(la)),Me.error||(i.joinRequests=(Me.data||[]).map(Ps)),N.error||(i.auditEvents=N.data||[]),Kn.error||(i.messageConversations=(Kn.data||[]).map(ve)),Gn.error||(i.messageAccess=(Gn.data||[]).map(ee)),Zn.error||(i.messages=(Zn.data||[]).map(Se)),Xn.error||(i.messageAttachments=(Xn.data||[]).map(Ee)),ei.error||(i.messageReads=(ei.data||[]).map(Vt)),ti.error||(i.calendarEvents=(ti.data||[]).map(tt)),ai.error||(i.notifications=(ai.data||[]).map(ht)),ni.error||(i.financeInvoices=(ni.data||[]).map(Ut),le+=1),ii.error||(i.financePayments=(ii.data||[]).map(Nt)),si.error||(i.financeExpenses=(si.data||[]).map(Lt)),ri.error||(i.financeVendors=(ri.data||[]).map(Qt)),Rn()){const Ht=await e.rpc("list_workspace_reviews").catch(Va=>({error:Va}));if(!Ht.error){i.workspaceReviews=(Ht.data||[]).map(ut);const Va=i.workspaceReviews.map(re=>Ze({id:re.company_id,name:re.company_name,short_name:re.company_name})),dr=i.workspaceReviews.map(re=>oa({company_id:re.company_id,status:re.status,plan_code:re.plan_code,amount_cents:re.amount_cents,currency:re.currency,trial_ends_at:re.trial_ends_at,current_period_end:re.current_period_end,grace_ends_at:re.grace_ends_at}));i.companies=Pn(i.companies.concat(Va)),i.subscriptions=Os(i.subscriptions.concat(dr))}}i.sync=le?{label:"Quest Supabase live",mode:"live"}:{label:"Local fallback",mode:"local"}}function q(){return!window.supabase||typeof window.supabase.createClient!="function"?null:(Ya||(Ya=window.supabase.createClient(We.supabaseUrl,We.supabaseKey)),Ya)}function Dr(){i.jobs=[],i.tasks=[],i.files=[],i.driveFolders=[],i.forms=[],i.formResponses=[],i.financeInvoices=[],i.financePayments=[],i.financeExpenses=[],i.financeVendors=[],i.notifications=[],i.messageConversations=[],i.messageAccess=[],i.messages=[],i.messageReads=[],i.messageAttachments=[],i.calendarEvents=[],i.timeEntries=[],i.activeTimer=null,i.teamMembers=[],i.memberships=[],i.profiles=[],i.subscriptions=[],i.workspaceReviews=[],i.roles=[],i.rolePermissions=[],i.roleAssignments=[],i.resourceAcl=[],i.fieldPermissions=[],i.companyInvites=[],i.joinRequests=[],i.auditEvents=[],i.companies=[],i.sync={label:"Loading secure workspace...",mode:"loading"}}function Xi(){i.jobs=A(en,Ni).map(Xe),i.tasks=A(tn,Vi).map(et),i.files=A(an,Yi).map(vt),i.driveFolders=A(nn,[]).map(Un),i.forms=A(it,Bi).map(Pt),i.formResponses=A(pa,Hi).map(Nn),i.financeInvoices=A(on,Wi).map(Ut),i.financePayments=A(ln,Ji).map(Nt),i.financeExpenses=A(cn,Ki).map(Lt),i.financeVendors=A(dn,zi).map(Qt),i.notifications=A(ba,Gi).map(ht),i.messageConversations=A(_a,gn).map(ve),i.messageAccess=A(va,bn).map(ee),i.messages=A(ya,_n).map(Se),i.messageReads=A(ha,yn).map(Vt),i.messageAttachments=A(wa,vn).map(Ee),i.calendarEvents=A($a,Zi).map(tt),i.timeEntries=$e(fa,[]),i.activeTimer=$e(ga,null),i.teamMembers=A(sn,Li).map(Ln),i.memberships=A(rn,Qi),i.profiles=[],i.subscriptions=[],i.workspaceReviews=[],i.roles=[],i.rolePermissions=[],i.roleAssignments=[],i.resourceAcl=[],i.fieldPermissions=[],i.companyInvites=[],i.joinRequests=[],i.auditEvents=[],i.companies=Pn(At.map(Ze)),i.sync={label:"Demo mode",mode:"local"}}function Cr(){return`
  ...
  `}function z(e,t="symbol-icon"){return`<svg class="${r(t)}" aria-hidden="true" focusable="false"><use href="#${r(e)}"></use></svg>`}function es(e=i.route?.section||"jobs"){return st.find(t=>t.id===e)?.symbol||"q-empty"}function jr(e){const t=String(e||"").toLowerCase();return t.includes("job")||t.includes("pipeline")?"q-symbol-jobs":t.includes("task")||t.includes("review")?"q-symbol-tasks":t.includes("file")?"q-symbol-files":t.includes("form")?"q-symbol-forms":t.includes("account")||t.includes("customer")||t.includes("member")||t.includes("user")||t.includes("lead")?"q-symbol-crm":t.includes("invoice")||t.includes("collected")||t.includes("expense")||t.includes("net")||t.includes("outstanding")?"q-symbol-finance":t.includes("time")||t.includes("today")||t.includes("days")||t.includes("timer")||t.includes("entries")?"q-symbol-clock":t.includes("approval")||t.includes("access")?"q-symbol-approvals":es()}function qr(e,t){const a=b(),n=u(),s=zd(a);return`
        ...
        <div class="topbar-right">
          <label class="company-switch">
            ...
            <select data-company-switch aria-label="Active company">
              ${En().map(o=>`<option value="${r(o.id)}" ${o.id===n?"selected":""}>${r(xt(o))}</option>`).join("")}
            </select>
          </label>
    ...
    ${ql(e,a)}
    ${us()}
  `}function Ar(e){const t=bs(e),a=t.filter(n=>!n.read_at).length;return`
  ...
  `}function Mr(e){return`
    <button class="notification-item ${e.read_at?"read":"unread"}" type="button" data-action="open-notification" data-notification-id="${r(e.id)}">
      <span></span>
      <div>
        <small>${r(Hs(e.type))} - ${r(e.title)} - ${r(lt(e.created_at))}</small>
        <strong>${r(e.body)}</strong>
      </div>
    </button>
  `}function Fr(e){const t=Ia(e);return t?`
  ...
  `:""}function Ir(e){const t=u(),a=b();return`
    ...
    ${["Workspace","Company","Operations"].map(n=>Tr(n,st.filter(s=>s.group===n&&ts(s,t)).map(s=>s.status==="planned"?xr(s.symbol,s.label):Er(e,m(s.id,{},t),s.symbol,s.label,Or(s.id,t))))).join("")}
  ...
  `}function Er(e,t,a,n,s=""){return`
    <a class="side-item ${Uc(e,t)?"active":""}" href="${_(t)}" data-router>
      ${z(a)}
      <span>${r(n)}</span>
      ${s!==""?`<b>${r(String(s))}</b>`:""}
    </a>
  ...
  `}function ts(e,t=u()){return e.id==="home"||e.status==="planned"?!0:!X(t)&&!["settings","users"].includes(e.id)?!1:h(e.permission||`${e.id}.view`,t)}function Or(e,t=u()){return e==="jobs"?Q(t).length:e==="tasks"?ae(t).length:e==="files"?Ce(t).length:e==="forms"?ye(t).length:e==="crm"?Tt(t).length:e==="finance"?_e(t).length:e==="users"?ie(t).filter(a=>a.status==="active").length:e==="messages"?_s(t)||xe(t).length:e==="calendar"?ys(t).length:e==="time"?js(t).focus.length:e==="approvals"?qn(t).length:e==="clock"&&Et(t)?"On":""}function hn(e,t){return`
    <nav class="tabbar compact-tabbar" aria-label="${r(e)}">
      ${t.map(([a,n,s])=>`<a class="${s?"active":""}" href="${_(a)}" data-router>${r(n)}</a>`).join("")}
    </nav>
  `}function as(e){if(e.name==="command")return Nr(u());if(e.name!=="company")return mi(e.name);const t=e.companyId;if(i.session?.auth==="supabase"&&!Ue().includes(t))return Ur(t);const a=st.find(n=>n.id===e.section);if(e.section==="home")return ns(t);if(a?.status!=="planned"){if(!X(t)&&e.section!=="settings")return Rr(t);if(a?.permission&&!h(a.permission,t))return Pr(t,a.permission)}return e.section==="jobs"?Zr(e,t):e.section==="tasks"?no(e,t):e.section==="files"?lo(e,t):e.section==="users"?$o(e,t):e.section==="settings"?jo(e,t):e.section==="forms"?xo(t):e.section==="analytics"?Gr(e,t):e.section==="crm"?zo(e,t):e.section==="finance"?ll(e,t):e.section==="messages"?Jo(e,t):e.section==="team-chart"?Co(t):e.section==="time"||e.section==="calendar"||e.section==="approvals"||e.section==="clock"?gl(e,t):mi(e.section)}function Rr(e){const t=Ea(e);return`
    ...
    `)}
    <section class="panel">
      ${H([["Company",E(e)],["Subscription",On(e)],["Allowed area","Settings, profile, and sign out remain available"],["Next step",t?"Quest approval / billing activation":"Restore billing access"]])}
    </section>
  `}function Pr(e,t){return`
    ...
    `)}
    <section class="panel">
      ${H([["Company",E(e)],["Required permission",t],["Your role",Ge(e)]])}
    </section>
  `}function Ur(e){return`
    ...
    `)}
    <section class="panel">
      ${H([["Requested company",E(e)],["Access rule","Active company membership required"],["Your status",oe(e,b().profile.id)?.status?I(oe(e,b().profile.id).status):"No active membership"]])}
    </section>
  `}function Nr(e){return ns(e)}function ns(e){const t=Q(e),a=ae(e),n=a.filter(N=>N.status!=="done"),s=n.filter(N=>N.due&&new Date(N.due)<Yt()),o=h("messages.view",e)?_s(e):0,l=Ce(e),c=ye(e),d=ie(e),f=d.filter(N=>N.status==="active"),g=d.filter(N=>N.status==="pending"),S=Lr(e,bs(e).slice(0,4)),V=Wr(e),T=de(e).filter(N=>!N.is_system).length,ne=new Set(de(e).flatMap(N=>N.permissions||[])).size,Me=h("users.view",e)||h("settings.view",e);return`
    <section class="home-cockpit">
      <div class="home-hero">
        <div>
          <h1>Good ${r(Jr())}, <span>${r(Kr(b().profile.full_name)||"Quest Admin")}</span></h1>
        ...
        <div class="home-hero-actions">
          <label class="company-switch home-company-switch">
            ${z("q-company")}
            <select data-company-switch aria-label="Active company">
              ${En().map(N=>`<option value="${r(N.id)}" ${N.id===e?"selected":""}>${r(xt(N))}</option>`).join("")}
            </select>
          </label>
      ...
      <section class="home-metric-grid">
        ${ct("q-symbol-approvals","Company access",On(e),Ea(e)?"Approval required before full access.":"Workspace modules are available.",m("settings",{tab:"billing"},e),"View status",X(e)?"good":"warning")}
      ...
      <section class="home-dashboard-grid">
        ...
        <article class="panel home-message-panel">
          ...
          <div class="home-message-list">
            ${Vr(e).map(Yr).join("")||v("No unread messages.")}
          </div>
        </article>
        <article class="panel home-next-panel">
          ...
          <div class="home-next-list">
            ${Br(e).map(Hr).join("")||v("No open tasks.")}
          </div>
        </article>
        ...
        <article class="panel home-access-panel">
          ...
          <div class="home-access-grid">
            ...
            <div><i class="ti ti-clipboard-check"></i><strong>${r(Ds(e).length)}</strong><span>Audit events</span></div>
          </div>
        </article>
      </section>
      <section class="home-shortcuts panel">
        ${Fe("files","q-symbol-files","Files",l.length,e)}
        ${Fe("crm","q-symbol-crm","CRM",Tt(e).length,e)}
        ${Fe("finance","q-symbol-finance","Finance",_e(e).length,e)}
        ${Fe("calendar","q-symbol-calendar","Calendar",ys(e).length,e)}
  ...
  `}function Fe(e,t,a,n,s){const o=st.find(l=>l.id===e);return o&&!ts(o,s)?"":`
  ...
  `}function Vr(e){return h("messages.view",e)?xe(e).filter(t=>gt(t.id)>0).slice(0,4).map(t=>{const a=Oe(t.id).slice(-1)[0];return{id:t.id,title:a?.body||t.title,meta:`${t.title} - ${lt(a?.created_at||t.updated_at||t.created_at)}`,href:m("messages",{conversation:t.id},e),count:gt(t.id),avatar:{full_name:a?B(a.sender_profile_id):t.title}}}):[]}function Yr(e){return`
    <a class="home-message-row" href="${_(e.href)}" data-router>
      ${te(e.avatar||{},"avatar small")}
      <span><strong>${r(e.title)}</strong><small>${r(e.meta)}</small></span>
      <b>${r(e.count)}</b>
    </a>
  `}function Br(e){return ae(e).filter(t=>t.status!=="done").sort(Ja).slice(0,4)}function Hr(e){return`
  ...
  `}function Wr(e){return[{label:"Company created",icon:"ti-circle-check",state:"good"},{label:X(e)?"Access approved":"Pending approval",icon:X(e)?"ti-circle-check":"ti-clock",state:X(e)?"good":"warning"},{label:"Billing connected",icon:"ti-link",state:X(e)?"good":"muted"},{label:X(e)?"Payment active":"Payment not active",icon:"ti-credit-card",state:X(e)?"good":"muted"},{label:"Full access enabled",icon:"ti-shield-check",state:X(e)?"good":"muted"}]}function Jr(){const e=new Date().getHours();return e<12?"morning":e<18?"afternoon":"evening"}function Kr(e){return String(e||"").trim().split(/\s+/)[0]||""}function Gr(e,t){const a=e.jobId?P(e.jobId):null,n=a?[a]:Q(t),s=ae(t).filter(g=>!a||g.project_id===a.id),o=Ce(t).filter(g=>!a||g.job_id===a.id),l=ye(t).filter(g=>!a||g.linked_job_id===a.id),c=s.filter(g=>g.status!=="done"),d=s.filter(g=>g.status!=="done"&&g.due&&new Date(g.due)<Yt()),f=me(n,"estimate_total");return`
    <section class="analytics-workspace">
      ...
      <section class="analytics-grid">
        ...
        <article class="panel analytics-score">
          ...
          <strong>${r(Bu(s.filter(g=>g.status==="done").length,s.length))}</strong>
        ...
        <article class="panel analytics-side">
          ...
          <div class="stage-bars">
            ${Ct.map(g=>{const S=s.filter(V=>V.status===g).length;return`<div><span>${r(we(g))}</span><b><i style="width:${r(lr(S,s.length))}%"></i></b><strong>${r(S)}</strong></div>`}).join("")}
          </div>
        </article>
  ...
  `}function Zr(e,t){const a=Nc(e.params.get("tab")),n=Te();return`
    ...
    <nav class="tabbar" aria-label="Job sections">
      ${Ei.map(s=>`<a class="${s===a?"active":""}" href="${_(m("jobs",{tab:s,...n?{job_id:n.id}:{}},t))}" data-router>${r(Lc(s))}</a>`).join("")}
    </nav>
    ${Xr(a,t,n)}
  `}function Xr(e,t,a){return e==="pipeline"?oi(t):e==="list"?eo(t):e==="profile"?to(t,a):oi(t)}function oi(e){const t=Cs(e);return`
    <section class="job-board">
      ${Dt.map(a=>{const n=t.filter(s=>s.stage===a);return`
          <article class="job-lane">
            <h2><span>${r(a)}</span><b>${n.length}</b></h2>
            ${n.map(s=>Wd(s)).join("")||'<div class="lane-empty">No jobs</div>'}
          </article>
        `}).join("")}
    </section>
  `}function eo(e){const t=Cs(e);return`
    <section class="panel">
  ...
  `:v("Create a job to see the profile workspace.")}function ao(e,t){const a=t||Od(e);return`
    <form class="job-editor" data-job-form>
      ...
      ${U("Company","company_id",e,En().map(n=>[n.id,xt(n)]))}
  ...
  `}function no(e,t){const a=e.jobId?P(e.jobId):null,n=Sd(t,a?.id);return`
    ...
    <section class="task-layout task-layout-flat">
      <article class="panel task-main">
        ${i.taskView==="board"?ro(t,n):so(t,n)}
      </article>
    </section>
    ...
    <section class="workspace-toolbar">
      ...
      <label>
        ...
        <select data-task-priority-filter>
          ${["all"].concat(ea).map(n=>`<option value="${r(n)}" ${i.taskPriorityFilter===n?"selected":""}>${r(n==="all"?"All priorities":I(n))}</option>`).join("")}
        </select>
      </label>
  ...
  `}function oo(e,t){return t?`
    ...
    ${H([["Status",we(t.status)],["Priority",I(t.priority)],["Type",Le(t.type)],["Assignee",B(t.assignee_id)],["Due",O(t.due)],["Company ID",t.company_id],["Project ID",t.project_id||"Company-level task"]])}
  ...
  `:`
      ...
      ${v("No task selected.")}
    `}function li(e,t,a){const n=a||Rd(e,t?.id||"");return`
    <form class="task-form" data-task-form>
      ...
      ${U("Priority","priority",n.priority,ea.map(s=>[s,I(s)]))}
      ${U("Type","type",n.type,xi.map(s=>[s,Le(s)]))}
  ...
  `}function lo(e,t){const a=e.params.get("folder")||i.driveFolder||"home";i.driveFolder=a;const n=e.jobId?P(e.jobId):null,s=hu(t,a,n?.id||""),o=h("files.manage",t);return`
  ...
  `}function co(e,t,a,n){const s=_u(e,t,a),o=s.map(c=>({kind:"folder",...c})).concat(n.map(c=>({kind:"file",file:c}))),l=a?a.name:t==="home"?"This folder":fe(t);return`
    <section class="drive-section-title">
      <div><h3>${r(l)}</h3><span>${s.length} folder${s.length===1?"":"s"} / ${n.length} file${n.length===1?"":"s"}</span></div>
    </section>
    ${i.driveView==="list"?uo(o):mo(o)}
  `}function uo(e){return`
    <div class="explorer-table" role="table" aria-label="File explorer">
      ...
      ${e.map(t=>t.kind==="folder"?fo(t):go(t.file)).join("")||v("This folder is empty.")}
    </div>
  `}function mo(e){return`
    <section class="drive-folder-grid explorer-grid">
      ${e.map(t=>t.kind==="folder"?po(t):_o(t.file)).join("")||v("This folder is empty.")}
    </section>
  ...
  `}function go(e){return`
    <button type="button" class="explorer-row ${e.id===i.selectedFileId?"active":""}" data-action="select-file" data-file-id="${r(e.id)}" role="row">
      <span class="explorer-name">${bo(e)}<strong>${r(e.file_name)}</strong></span>
  ...
  `}function vo(e,t){const a=h("files.manage",t);return`
  ...
  `}function yo(e){const t=zn(e);return e.signed_url&&t==="image"?`<img class="file-preview-media" src="${r(e.signed_url)}" alt="" />`:e.signed_url&&t==="pdf"?`<iframe class="file-preview-frame" src="${r(e.signed_url)}" title="${r(e.file_name)}"></iframe>`:e.signed_url&&t==="text"?`<iframe class="file-preview-frame text" src="${r(e.signed_url)}" title="${r(e.file_name)}"></iframe>`:["doc","sheet"].includes(t)&&e.signed_url?`<iframe class="file-preview-frame" src="https://view.officeapps.live.com/op/embed.aspx?src=${encodeURIComponent(e.signed_url)}" title="${r(e.file_name)}"></iframe>`:`
  ...
  `}function ho(){const e=u(),t=i.route||Mt(),a=t.params.get("folder")||i.driveFolder||"home",n=t.jobId?P(t.jobId):null;return x("Drive","New folder",`
  ...
  `,"task-modal")}function wo(){const e=u(),t=i.route?.params?.get("folder")||(i.driveFolder==="home"?"shared":i.driveFolder),a=i.route?.jobId||"";return`
  ...
  `}function $o(e,t){const a=ie(t),n=["members","access"].includes(e.params.get("tab"))?e.params.get("tab"):"members",s=i.joinRequests.filter(d=>d.company_id===t&&d.status==="pending"),o=h("users.manage",t),l=a.filter(d=>d.status==="active"),c=a.filter(d=>d.status!=="active");return`
    ...
    <section class="dashboard-grid compact-settings-grid">
      <article class="panel span-2">
        ...
        <div class="access-user-list">
          ${a.map(d=>So(t,d,o)).join("")||v("No users assigned to this company yet.")}
        </div>
      </article>
      <article class="panel">
        <div class="section-head">
        ...
        <div class="access-invite-list">
          ${fd(t).map(d=>Do(d,o)).join("")||v("No pending invites.")}
        </div>
      </article>
      <article class="panel">
        ...
        <div class="access-request-list">
          ${s.map(d=>ko(d,o)).join("")||v("No pending join requests.")}
        </div>
      </article>
      <article class="panel span-3">
    ...
    `}
  `}function So(e,t,a){const n=de(e),s=t.role_id||_t(e,t.role)||n[0]?.id||"",o=t.profile_id&&xs(e,t.profile_id),l=a&&t.profile_id&&!o;return`
  ...
  `}function ko(e,t){const a=e.requested_email||Re(e.profile_id)?.email||e.profile_id||"Requester";return`
  ...
  `}function Do(e,t){const a=ot(e.company_id,e.role_id),n=e.expires_at&&Date.parse(e.expires_at)<Date.now();return`
  ...
  `}function ta(e){const t=String(e.name||"").trim(),a=String(e.email||"").trim();if(t&&!ma(t))return t;if(a&&!ma(a))return a.split("@")[0].replace(/[._-]+/g," ").replace(/\b\w/g,s=>s.toUpperCase());const n=String(e.role||"").toLowerCase();return n==="owner"?"Workspace owner":n==="admin"?"Workspace admin":n==="developer"?"Developer":`${e.role_label||"Workspace"} user`}function is(e){const t=String(e.email||"").trim();if(t&&!ma(t))return t;const a=String(e.profile_id||e.member_id||"").trim();return a?`ID ${cr(a)}`:"No email on profile"}function Co(e){const t=rt(e),a=t.filter(n=>!n.supervisor_id||!t.some(s=>s.id===n.supervisor_id));return`
    <section class="tool-page team-chart-page">
      ...
      <section class="panel">
        ...
        <div class="team-tree">
          ${a.map(n=>ss(e,n,t)).join("")||v("No workers assigned.")}
        </div>
      </section>
    </section>
  `}function ss(e,t,a,n=0){const s=a.filter(o=>o.supervisor_id===t.id);return`
    <article class="team-node" style="--depth:${n}">
      ...
      ${s.length?`<div class="team-node-children">${s.map(o=>ss(e,o,a,n+1)).join("")}</div>`:""}
    </article>
  `}function jo(e,t){const a=Ta(t),n=["company","billing","roles","access","team"].includes(e.params.get("tab"))?e.params.get("tab"):"company";return`
    ...
    <section class="dashboard-grid compact-settings-grid">
      ...
      <article class="panel">
        ...
        ${H([["Name",E(t)],["Company ID",t],["Color",a?.color||je(t)],["Visible jobs",Q(t).length]])}
      </article>
      `:""}
      ${n==="billing"?qo(t):""}
      ${n==="roles"?Fo(t):""}
      ...
      <article class="panel span-3">
        ...
        <div class="access-audit-list">
          ${Ds(t).slice(0,8).map(gd).join("")||v("No access audit events yet.")}
        </div>
      </article>
      `:""}
      ${n==="team"?`
  ...
  `}function qo(e){const t=Ot(e),a=Ea(e);return`
    <article class="panel">
      <div class="section-head">
    ...
    ${Rn()?Ao(e):""}
  `}function Ao(e){const t=Cd(),a=t.filter(n=>n.status==="pending_review").length;return`
    <article class="panel span-3">
      <div class="section-head">
  ...
  `}function Fo(e){const t=de(e),a=Ia(e);return`
    <article class="panel span-2">
      <div class="section-head">
  ...
  `}function Io(e,t){const a=st.filter(o=>o.status==="live"),n=a.filter(o=>Wa(t,o.permission||`${o.id}.view`)),s=a.filter(o=>!Wa(t,o.permission||`${o.id}.view`));return`
    <div class="section-head">
  ...
  `}function To(e){return x("Settings","New role",`
  ...
  `,"finance-modal")}function Eo(e){const t=de(e).filter(n=>n.name.toLowerCase()!=="owner"),a=[["","Member"]].concat(t.map(n=>[n.id,n.name]));return x("Users","Create invite code",`
    <form class="role-form" data-invite-form>
      <input type="hidden" name="company_id" value="${r(e)}" />
      ${F("Email","email","",!0,"email")}
      ${U("Role","role_id",bd(e),a)}
  ...
  `,"finance-modal")}function xo(e){const t=$u(e),a=wt(e),n=i.formsTab==="builder"&&a?"builder":i.formsTab==="responses"?"responses":"library";return`
  ...
  `}function Po(e,t){const a=Qa(e.id);return`
    ...
    <article class="question-workbench">
      <div class="question-canvas">
        <div class="gform-floating-toolbar" aria-label="Builder tools">
          ${qt.map(([t,a])=>`<button type="button" data-action="add-question" data-question-type="${r(t)}" title="${r(a)}" aria-label="Add ${r(a)} question"><i class="ti ${r(ku(t))}"></i></button>`).join("")}
        </div>
        <div class="question-list">
          ${e.questions.map((t,a)=>Vo(t,a)).join("")||v("Add the first question.")}
        </div>
      </div>
    </article>
  ...
  `}function Qo(e,t){const a=Qa(t.id),n=a[0]||null;return`
  ...
  `}function Vo(e,t){const a=qt.map(([n,s])=>`<option value="${r(n)}" ${e.type===n?"selected":""}>${r(s)}</option>`).join("");return`
  ...
  `}function zo(e,t){const a=yd(t),n=Tt(t),s=ae(t).filter(c=>c.status!=="done").length,o=me(Q(t),"estimate_total"),l=wd(t);return`
  ...
  `}function Wo(e,t){const a=hd(e,t);if(!a)return x("CRM","Customer account",v("This customer is not visible in the current company view."));const n=a.latestJob,s=a.tasks.filter(o=>o.status!=="done");return x("CRM",a.name,`
  ...
  `,"crm-modal")}function Jo(e,t){const a=xe(t),n=vs(t);n&&i.selectedConversationId!==n.id&&(i.selectedConversationId=n.id);const s=!!(n&&e.params.get("conversation"));return nu(t,n?.id||""),n&&Ua(n.id,!1),`
    <section class="tool-page messages-page ${s?"thread-open":""}">
      ...
      ${i.session?.auth==="local-basic"?al():""}
    </section>
  `}function Ko(e,t,a){const n=Oe(e.id).at(-1),s=gt(e.id);return`
    <a class="conversation-row ${a?"active":""}" href="${_(m("messages",{conversation:e.id},t))}" data-router>
      <span class="conversation-mark">${z(Ys(e.type))}</span>
      <span>
        <strong>${r(e.title)}</strong>
  ...
  `}function Go(e,t){const a=Oe(t.id),n=h("messages.send",e);return`
    ...
    ${n?el(t):v("Your role can view this chat but cannot send messages.")}
  `}function Zo(e){const t=e.sender_profile_id===b().profile.id,a=Zd(e.sender_profile_id),n=Wc(e.id);return`
    <article class="message-bubble ${t?"own":""}">
      ...
      <div class="message-card">
        ...
        ${e.body?`<p>${tu(e.body)}</p>`:""}
        ${n.length?`<div class="message-attachments">${n.map(Xo).join("")}</div>`:""}
      </div>
    </article>
  `}function Xo(e){const t=e.mime_type.startsWith("image/");return`
    <button class="message-attachment" type="button" data-action="open-message-attachment" data-attachment-id="${r(e.id)}">
      ...
      <span><strong>${r(e.file_name)}</strong><small>${r(au(e.size_bytes))}</small></span>
    </button>
  ...
  `}function nl(e){const t=ie(e);return x("Messages","New group chat",`
  ...
  `,"message-modal")}function il(e){const t=ie(e).filter(a=>(a.profile_id||a.member_id)!==b().profile.id);return x("Messages","New direct message",`
  ...
  `,"message-modal")}function sl(e,t){const a=i.messageConversations.find(l=>l.id===t);if(!a)return x("Messages","Chat access",v("Conversation not found."));const n=Aa(a.id),s=n.filter(l=>l.target_type==="role").map(l=>l.target_id),o=n.filter(l=>l.target_type==="profile").map(l=>l.target_id);return x("Messages","Chat access",`
  ...
  `,"message-modal")}function rs(e,t=[]){const a=new Set(t);return`
  ...
  `}function os(e,t=[]){const a=new Set(t),n=e.slice().sort((s,o)=>Ve(s).localeCompare(Ve(o)));return`
    <section class="message-access-section">
      <div class="message-picker-head">
  ...
  `}function rl(e,t){const a=i.messageConversations.find(n=>n.id===t);return a?x("Messages",a.title,`
    ${H([["Type",I(a.type)],["Access",Hn(a)],["Messages",String(Oe(a.id).length)],["Attachments",String(zc(a.id).length)],["Last message",O(a.last_message_at)]])}
  `,"message-modal"):x("Messages","Chat details",v("Conversation not found."))}function ol(e){const t=i.messageQuery.trim().toLowerCase(),a=xe(e).flatMap(n=>Oe(n.id).filter(s=>!t||s.body.toLowerCase().includes(t)).map(s=>({conversation:n,message:s})));return x("Messages","Search results",`
    <div class="queue-list">
  ...
  `,"message-modal")}function ll(e,t){const a=Es(t),n=_e(t),s=Ms(t).slice().sort(St("received_at")).slice(0,5),o=Mn(t).slice().sort(St("spent_at")).slice(0,5),l=Fn(t).slice().sort((d,f)=>d.name.localeCompare(f.name)).slice(0,5),c=h("finance.manage",t);return`
  ...
  `}function cl(e,t){return e.params.get("invoice")?dl(t,e.params.get("invoice")):e.params.get("expense")?ul(t,e.params.get("expense")):e.params.get("vendor")?ml(t,e.params.get("vendor")):e.params.get("report")==="summary"?pl(t):""}function dl(e,t){const a=Pe(t);if(!a||a.company_id!==e)return x("Finance","Invoice",v("Invoice not found."));const n=Is(a.id),s=P(a.job_id);return x("Finance",a.invoice_number,`
    <div class="finance-detail-modal">
      ${H([["Client",a.client_name||s?.client_name||"No client"],["Status",Ts(a)],["Job",s?.name||"Company level"],["Issued",O(a.issue_date)],["Due",O(a.due_date)],["Total",C(a.total)],["Collected",C(Tn(a.id))],["Balance",C(pe(a.id))]])}
  ...
  `,"finance-modal")}function ul(e,t){const a=Fs(t);if(!a||a.company_id!==e)return x("Finance","Expense",v("Expense not found."));const n=P(a.job_id);return x("Finance",`${Ka(a.vendor_id)} expense`,`
    <div class="finance-detail-modal">
  ...
  `,"finance-modal")}function ml(e,t){const a=In(t);if(!a||a.company_id!==e)return x("Finance","Vendor",v("Vendor not found."));const n=Mn(e).filter(s=>s.vendor_id===a.id);return x("Finance",a.name,`
    <div class="finance-detail-modal">
  ...
  `,"finance-modal")}function pl(e){const t=Es(e);return x("Finance","Summary report",`
    <div class="finance-report-modal">
      ${H([["Company",E(e)],["Estimated pipeline",C(t.pipeline)],["Invoiced",C(t.invoiced)],["Collected",C(t.collected)],["Outstanding",C(t.outstanding)],["Expenses",C(t.expenses)],["Net position",C(t.net)]])}
      <div class="finance-aging-grid">
  ...
  `,"finance-modal")}function ci(e,t=null){const a=t||Pd(e);return x("Finance",t?"Edit invoice":"New invoice",`
  ...
  `,"finance-form-modal")}function fl(e,t=""){const a=Ud(e,t),n=_e(e).map(s=>[s.id,`${s.invoice_number} - ${s.client_name||P(s.job_id)?.client_name||"No client"}`]);return x("Finance","Record payment",`
    <form class="finance-form" data-finance-payment-form>
      ...
      ${U("Method","method",a.method,Ui.map(s=>[s,s]))}
  ...
  `,"finance-form-modal")}function di(e,t=null,a=""){const n=t||Nd(e,a),s=Fn(e).map(o=>[o.id,o.name]);return x("Finance",t?"Edit expense":"Add expense",`
    <form class="finance-form" data-finance-expense-form>
      ...
      ${U("Status","status",n.status,Ri.map(o=>[o,o]))}
  ...
  `,"finance-form-modal")}function ui(e,t=null){const a=t||Ld(e);return x("Finance",t?"Edit vendor":"Add vendor",`
    <form class="finance-form" data-finance-vendor-form>
      ...
      ${U("Status","status",a.status,Pi.map(n=>[n,n]))}
      ${ke("Notes","notes",a.notes,"span-2")}
      <div class="form-actions span-2">
  ...
  `,"finance-form-modal")}function gl(e,t){return e.section==="clock"?wl(t):e.section==="calendar"?bl(e,t):e.section==="approvals"?$l(t):hl(t)}function Ca(e,t){return`
  ...
  `}function bl(e,t){const a=Gc(t),n=Ma(t),s=a.filter(d=>d.dateKey===k(0)),o=n.filter(d=>d.mine),l=n.filter(d=>d.source!=="manual").length,c=h("calendar.manage",t);return`
    <section class="tool-page operations-page calendar-page">
      ...
      <section class="calendar-shell">
        <article class="panel calendar-main">
          ${i.calendarView==="month"?_l(t,a):""}
          ${i.calendarView==="week"?vl(t,a):""}
          ${i.calendarView==="list"?yl(t,a):""}
        </article>
  ...
  `}function vl(e,t){return`
    <div class="calendar-grid calendar-week-grid">
      ${Ss(i.calendarCursorDate).map(n=>{const s=$s(t,n.key);return`
          <div class="calendar-day ${n.key===k(0)?"today":""}">
            <div class="calendar-day-head"><b>${r(n.name)}</b><span>${r(n.shortDate)}</span></div>
            ${s.map(ls).join("")||'<small class="calendar-empty-day">Open</small>'}
          </div>
        `}).join("")}
    </div>
  `}function yl(e,t){const a=ud(t);return`
  ...
  `}function ls(e){return`
    <button class="calendar-pill ${r(md(e.type))}" type="button" data-action="open-calendar-event" data-event-id="${r(e.id)}">
      <span>${r(ks(e))}</span>
      <strong>${r(e.title)}</strong>
    </button>
  `}function cs(e){return`
    <button class="calendar-agenda-item" type="button" data-action="open-calendar-event" data-event-id="${r(e.id)}">
      <i class="ti ${r(pd(e.type))}"></i>
      <span><strong>${r(e.title)}</strong><small>${r(`${O(e.dateKey)} · ${ks(e)} · ${e.type}`)}</small></span>
    </button>
  `}function hl(e){const t=js(e),a=Et(e);return`
    <section class="tool-page operations-page">
      ...
      <section class="dashboard-grid operations-grid">
        ...
        <article class="panel">
          ...
          ${H([["Company",E(e)],["Assigned to you",String(t.assignedToMe.length)],["Due this week",String(t.thisWeek.length)],["Completed",String(t.done.length)]])}
        </article>
      <article class="panel span-2">
  ...
  `}function wl(e){const t=qs(e),a=Et(e),n=Yt().getTime(),s=n-6*864e5,o=hi(e,n)+(a?Date.now()-Date.parse(a.started_at):0),l=hi(e,s)+(a?Date.now()-Date.parse(a.started_at):0);return`
  ...
  `}function $l(e){const t=qn(e),a=t.filter(o=>o.type==="Form approval"),n=t.filter(o=>o.type==="Task review"),s=t.filter(o=>o.type==="Access request");return`
    <section class="tool-page operations-page">
  ...
  `}function mi(e){return`
    ${G(I(e||"workspace"),"This module will use the same company workspace shell when wired.","")}
    <section class="panel">
      ${v("Module data model pending.")}
    </section>
  `}function pi(e=!1){document.title="Quest HQ | Company operations workspace";const t=i.route||Mt(),a=ja(t.params.get("return_url")||_(m("jobs",{},L()))),n=String(t.params.get("invite")||"").trim(),s=String(t.params.get("auth")||"").trim(),o=ds(t.params.get("mode")||s,n);o&&i.authMode!==o&&(i.authMode=o),n&&!["signin","register"].includes(i.authMode)&&(i.authMode="register");const l=e||!!(n||s),c=i.session;Da.innerHTML=`
  ...
  `}function Sl(e,t,a){const n=qd(t);return`
    <div class="modal-overlay">
  ...
  `}function ds(e,t=""){const a=String(e||"").toLowerCase().trim();return t&&!a?"register":["signin","register","invite","request"].includes(a)?a:a==="business"?"register":a==="worker"?t?"register":"invite":""}function kl(e=""){const t=i.authMode;return`
  ...
  `}function Cl(e){const t=String(i.route?.params?.get("invite")||"").trim();return i.authMode==="register"?`
  ...
  `}function zt(e){return i.loginError?`<div class="form-message error">${r(i.loginError)}</div>`:`<div class="form-message">${r(i.authMessage||e)}</div>`}function jl(e){return`
    <div class="modal-overlay">
  ...
  `}function ql(e,t){if(i.modal==="profile")return jl(t.profile);if(i.modal==="file-upload")return wo();if(i.modal==="folder-new")return ho();if(i.modal==="file-detail")return Il(u());if(i.modal==="forms-tools")return Tl(u());if(i.modal==="form-actions")return Rl(u(),wt(u()));if(i.modal==="form-new")return El(u());if(i.modal==="form-preview")return Ol(u(),wt(u()));if(i.modal==="job-new")return Ba(u(),null);if(i.modal==="job-edit")return Ba(u(),Te());if(i.modal==="finance-invoice-new")return ci(u(),null);if(i.modal==="finance-invoice-edit")return ci(u(),Pe(i.selectedFinanceInvoiceId));if(i.modal==="finance-payment-new")return fl(u(),i.selectedFinanceInvoiceId);if(i.modal==="finance-expense-new")return di(u(),null,i.selectedFinanceVendorId);if(i.modal==="finance-expense-edit")return di(u(),Fs(i.selectedFinanceExpenseId));if(i.modal==="finance-vendor-new")return ui(u(),null);if(i.modal==="finance-vendor-edit")return ui(u(),In(i.selectedFinanceVendorId));if(i.modal==="role-new")return To(u());if(i.modal==="invite-new")return Eo(u());if(i.modal==="message-group-new")return nl(u());if(i.modal==="message-direct-new")return il(u());if(i.modal==="message-access")return sl(u(),i.selectedConversationId);if(i.modal==="message-details")return rl(u(),i.selectedConversationId);if(i.modal==="message-search")return ol(u());if(i.modal==="calendar-event-detail")return Fl(u());if(i.modal==="calendar-event-new")return fi(u(),null);if(i.modal==="calendar-event-edit")return fi(u(),It(i.selectedCalendarEventId));if(e.name==="company"&&e.section==="crm"&&e.params.get("account"))return Wo(e.companyId,e.params.get("account"));if(e.name==="company"&&e.section==="finance"){const a=cl(e,e.companyId);if(a)return a}return e.name==="company"&&e.section==="jobs"&&e.params.get("tab")==="editor"?Ba(e.companyId,e.jobId?P(e.jobId):Te()):e.name==="company"&&e.section==="tasks"?Ml(e,e.companyId):""}function us(){return i.toast?`
  ...
  `}function Ba(e,t){return x("Jobs",t?"Edit job":"Create job",ao(e,t),"wide-modal")}function Ml(e,t){const a=e.jobId?P(e.jobId):null,n=e.params.get("task_id")||"",s=n?qa(n):null;return e.params.get("new")==="1"?x("Tasks","New task",li(t,a,null),"task-modal"):e.params.get("edit")==="1"&&s?x("Tasks","Edit task",li(t,a,s),"task-modal"):s?Al("Task detail",s.title,oo(t,s)):""}function Fl(e){const t=sd(i.selectedCalendarEventId,e);if(!t)return"";const a=t.source==="manual"?It(t.sourceId):null,n=[t.href?`<a class="btn btn-primary" href="${_(t.href)}" data-router><i class="ti ti-arrow-right"></i>Open source</a>`:"",a&&t.editable?`<button class="btn" type="button" data-action="edit-calendar-event" data-event-id="${r(a.id)}"><i class="ti ti-pencil"></i>Edit</button>`:"",a&&t.editable?`<button class="btn danger" type="button" data-action="delete-calendar-event" data-event-id="${r(a.id)}"><i class="ti ti-trash"></i>Delete</button>`:""].filter(Boolean).join("");return x("Calendar",t.title,`
    <div class="calendar-detail">
      ${H([["Type",t.type],["When",t.allDay?O(t.dateKey):`${ua(t.startsAt)}${t.endsAt&&t.endsAt!==t.startsAt?` - ${ua(t.endsAt)}`:""}`],["Assigned",t.owner||"Unassigned"],["Source",t.source==="manual"?"Manual event":I(t.source)],["Linked",t.linkLabel||"None"]])}
  ...
  `,"calendar-modal")}function fi(e,t){const a=t||Qd(e),n=a.linked_type==="job"?a.linked_id:"";return x("Calendar",t?"Edit event":"New event",`
    <form class="calendar-form" data-calendar-event-form>
      ...
      ${F("Starts","starts_at",$i(a.starts_at),!0,"datetime-local")}
      ${F("Ends","ends_at",$i(a.ends_at||a.starts_at),!0,"datetime-local")}
      ...
      ${U("Assigned to","assigned_profile_id",a.assigned_profile_id,Kd(e))}
  ...
  `,"calendar-form-modal")}function Il(e){const t=i.selectedFileId?i.files.find(a=>a.id===i.selectedFileId):null;return t?x("Open file",t.file_name,vo(t,e),"file-viewer-modal"):""}function Tl(e){return x("Forms","Tools",`
  ...
  `)}function El(e){const t=i.formStartTab==="templates"?"templates":"blank",a=mt(),n=t==="templates"&&(a.find(d=>d.id===i.formStartTemplateId)||a[0])||null,s=n?.title||"",o=n?.description||"",l=n?.type||"Internal",c=n?.questions||[{type:"short",label:"First question",required:!1,options:[]}];return x("Forms","New form builder",`
  ...
  `,"form-create-modal builder-modal")}function xl(e,t){const a=$t(e)?`
  ...
  `}function Ol(e,t){return t?x("Forms","Preview form",`
    <div class="form-preview-modal-body">
      ${Yo(e,t)}
    </div>
  `,"form-preview-modal"):x("Forms","Preview form",v("Choose a form first."))}function Rl(e,t){return t?x("Forms","Manage form",`
  ...
  `):x("Forms","Manage form",v("Choose a form first."))}function Pl(e){const t=i.accountMenuOpen&&!e.target.closest(".account-menu"),a=i.notificationMenuOpen&&!e.target.closest(".notification-center");t&&(i.accountMenuOpen=!1),a&&(i.notificationMenuOpen=!1);const n=e.target.closest("[data-action]");if(n){Ul(e,n);return}const s=e.target.closest("[data-select-job]");if(s){e.preventDefault(),Bc(s.dataset.selectJob);return}const o=e.target.closest("[data-select-task]");if(o){e.preventDefault(),Hc(o.dataset.selectTask);return}const l=e.target.closest("a[href][data-router]");if(!l){(t||a)&&p();return}l.target||l.hasAttribute("download")||(e.preventDefault(),j(l.getAttribute("href")))}function Ul(e,t){const a=t.dataset.action;if(a==="refresh-data"){e.preventDefault(),i.dataLoaded=!1,i.sync={label:"Refreshing...",mode:"loading"},p();return}if(a==="sign-out"){e.preventDefault(),i.accountMenuOpen=!1,Ql();return}if(a==="toggle-account-menu"){e.preventDefault(),i.accountMenuOpen=!i.accountMenuOpen,i.notificationMenuOpen=!1,p();return}if(a==="toggle-notifications"){e.preventDefault(),i.notificationMenuOpen=!i.notificationMenuOpen,i.accountMenuOpen=!1,p();return}if(a==="mark-all-notifications-read"){e.preventDefault(),fu(u()).catch(n=>console.warn("Notification read sync failed",n));return}if(a==="open-notification"){e.preventDefault(),gu(t.dataset.notificationId).catch(n=>console.warn("Notification open sync failed",n));return}if(a==="verify-email"){e.preventDefault(),i.accountMenuOpen=!1,$("Email verification is not implemented yet. Account access is not blocked right now.","local");return}if(a==="start-demo-mode"){e.preventDefault(),ms(t.dataset.returnUrl||"");return}if(a==="open-auth-modal"){e.preventDefault();const n=ds(t.dataset.authMode||"signin")||"signin";i.authMode=n,i.loginError="",i.authMessage="",j(`/?auth=${encodeURIComponent(n)}`);return}if(a==="close-auth-modal"){e.preventDefault(),i.loginError="",i.authMessage="",j("/");return}if(a==="set-auth-mode"){e.preventDefault();const n=["signin","register","invite","request"].includes(t.dataset.authMode)?t.dataset.authMode:"signin";if(i.authMode=n,i.loginError="",i.authMessage="",i.route?.name==="home"||i.route?.name==="login"){const s=new URLSearchParams(i.route.params);i.route.name==="home"?(s.set("auth",n),s.delete("mode")):(s.set("mode",n),s.delete("auth"));const o=s.toString();j(`${i.route.path}${o?`?${o}`:""}`,{replace:!0});return}p();return}if(a==="open-profile"){e.preventDefault(),i.accountMenuOpen=!1,i.modal="profile",p();return}if(a==="open-role-form"){if(e.preventDefault(),!y("roles.manage",u(),"Your role cannot manage roles.","Roles"))return;i.modal="role-new",p();return}if(a==="view-as-role"){e.preventDefault();const n=u(),s=ot(n,t.dataset.roleId);if(!s){$("That role is no longer available.","local","Role preview");return}i.rolePreview={company_id:n,role_id:s.id},$(`Viewing the workspace as ${s.name}.`,"local","Role preview");return}if(a==="exit-role-preview"){e.preventDefault(),i.rolePreview=null,$("Role preview ended.","live","Role preview");return}if(a==="open-invite-form"){if(e.preventDefault(),!y("users.manage",u(),"Your role cannot invite or manage users.","Users"))return;i.modal="invite-new",p();return}if(a==="new-message-group"){if(e.preventDefault(),!y("messages.create_group",u(),"Your role cannot create group chats.","Messages"))return;i.modal="message-group-new",p();return}if(a==="new-direct-message"){if(e.preventDefault(),!y("messages.send",u(),"Your role cannot start direct messages.","Messages"))return;i.modal="message-direct-new",p();return}if(a==="manage-message-chat"){if(e.preventDefault(),!y("messages.manage_groups",u(),"Your role cannot manage chat access.","Messages"))return;i.selectedConversationId=t.dataset.conversationId||i.selectedConversationId,i.modal="message-access",p();return}if(a==="message-details"){e.preventDefault(),i.selectedConversationId=t.dataset.conversationId||i.selectedConversationId,i.modal="message-details",p();return}if(a==="message-search-results"){e.preventDefault(),i.modal="message-search",p();return}if(a==="set-message-filter"){e.preventDefault(),i.messageFilter=["all","unread",...fn].includes(t.dataset.filter)?t.dataset.filter:"all",p();return}if(a==="delete-message"){e.preventDefault(),pc(t.dataset.messageId);return}if(a==="open-message-attachment"){e.preventDefault(),fc(t.dataset.attachmentId);return}if(a==="run-message-scenario"){e.preventDefault(),iu(u());return}if(a==="reset-message-demo"){e.preventDefault(),ru();return}if(a==="set-calendar-scope"){e.preventDefault(),i.calendarScope=t.dataset.scope==="me"?"me":"company",p();return}if(a==="set-calendar-view"){e.preventDefault(),i.calendarView=["month","week","list"].includes(t.dataset.view)?t.dataset.view:"week",p();return}if(a==="calendar-prev"){e.preventDefault(),yi(-1),p();return}if(a==="calendar-next"){e.preventDefault(),yi(1),p();return}if(a==="calendar-today"){e.preventDefault(),i.calendarCursorDate=k(0),p();return}if(a==="open-calendar-event"){e.preventDefault(),i.selectedCalendarEventId=t.dataset.eventId||"",i.modal="calendar-event-detail",p();return}if(a==="open-calendar-event-form"){if(e.preventDefault(),!h("calendar.manage",u())){$("Your role can view the calendar but cannot create company events.","local","Calendar");return}i.selectedCalendarEventId="",i.modal="calendar-event-new",p();return}if(a==="edit-calendar-event"){e.preventDefault();const n=It(t.dataset.eventId);if(!n||!Ft(n)){$("This event cannot be edited from Calendar.","local","Calendar");return}i.selectedCalendarEventId=n.id,i.modal="calendar-event-edit",p();return}if(a==="delete-calendar-event"){e.preventDefault(),uc(t.dataset.eventId);return}if(a==="copy-invite-link"){if(e.preventDefault(),!y("users.manage",u(),"Your role cannot view invite links.","Users"))return;ac(t.dataset.inviteId);return}if(a==="copy-invite-code"){if(e.preventDefault(),!y("users.manage",u(),"Your role cannot view invite codes.","Users"))return;nc(t.dataset.inviteId);return}if(a==="revoke-invite"){if(e.preventDefault(),!y("users.manage",u(),"Your role cannot revoke invites.","Users"))return;ic(t.dataset.inviteId);return}if(a==="approve-join-request"){if(e.preventDefault(),!y("users.manage",u(),"Your role cannot approve access requests.","Users"))return;gi(t.dataset.requestId,"approved");return}if(a==="reject-join-request"){if(e.preventDefault(),!y("users.manage",u(),"Your role cannot reject access requests.","Users"))return;gi(t.dataset.requestId,"rejected");return}if(a==="start-checkout"){e.preventDefault(),Gl();return}if(a==="review-workspace"){e.preventDefault(),Zl(t.dataset.companyId,t.dataset.status);return}if(a==="open-file-upload"){if(e.preventDefault(),!y("files.manage",u(),"Your role can view files but cannot upload.","Files"))return;i.modal="file-upload",p();return}if(a==="open-folder-form"){if(e.preventDefault(),!y("files.manage",u(),"Your role can view files but cannot create folders.","Files"))return;i.modal="folder-new",p();return}if(a==="open-job-form"){if(e.preventDefault(),!y("jobs.manage",u(),"Your role can view jobs but cannot create or edit them.","Jobs"))return;const n=t.dataset.jobId||"";n&&(i.selectedJobId=n),i.modal=t.dataset.mode==="edit"?"job-edit":"job-new",p();return}if(a==="open-forms-tools"){if(e.preventDefault(),!y("forms.manage",u(),"Your role can view forms but cannot create or edit them.","Forms"))return;i.modal="forms-tools",p();return}if(a==="open-form-actions"){e.preventDefault(),Kt(t.dataset.formId,!1),i.modal="form-actions",p();return}if(a==="open-form-preview"){e.preventDefault(),Kt(t.dataset.formId,!1),i.modal="form-preview",p();return}if(a==="set-form-start-tab"){e.preventDefault(),i.formStartTab=t.dataset.tab==="templates"?"templates":"blank",i.formStartTab==="blank"&&(i.formStartTemplateId=""),i.formStartTab==="templates"&&!i.formStartTemplateId&&(i.formStartTemplateId=mt()[0]?.id||""),p();return}if(a==="select-form-start-template"){e.preventDefault(),i.formStartTab="templates",i.formStartTemplateId=t.dataset.templateId||mt()[0]?.id||"",p();return}if(a==="close-modal"){e.preventDefault(),Nl();return}if(a==="set-task-view"){e.preventDefault(),i.taskView=t.dataset.view==="board"?"board":"table",localStorage.setItem(Fi,i.taskView),p();return}if(a==="set-drive-view"){e.preventDefault(),i.driveView=t.dataset.view==="list"?"list":"grid",localStorage.setItem(Ii,i.driveView),p();return}if(a==="clock-in"){e.preventDefault(),$d(u(),t.dataset.taskId||i.route?.params?.get("task_id")||"");return}if(a==="clock-out"){e.preventDefault(),As();return}if(a==="select-file"){e.preventDefault(),i.selectedFileId=t.dataset.fileId||"",i.modal="file-detail",p();return}if(a==="download-file"){e.preventDefault(),Mc(t.dataset.fileId);return}if(a==="delete-file"){if(e.preventDefault(),!y("files.manage",u(),"Your role cannot delete files.","Files"))return;Fc(t.dataset.fileId);return}if(a==="set-forms-tab"){e.preventDefault(),i.formsTab=t.dataset.tab==="responses"?"responses":"library",p();return}if(a==="set-form-editor-tab"){e.preventDefault(),i.formEditorTab=t.dataset.tab||"questions",p();return}if(a==="new-form"){if(e.preventDefault(),!y("forms.manage",u(),"Your role can view forms but cannot create them.","Forms"))return;i.formStartTemplateId=t.dataset.templateId||"",i.formStartTab=t.dataset.startTab==="templates"||i.formStartTemplateId?"templates":"blank",i.formStartTab==="templates"&&!i.formStartTemplateId&&(i.formStartTemplateId=mt()[0]?.id||""),i.modal="form-new",p();return}if(a==="select-form"){e.preventDefault(),Kt(t.dataset.formId);return}if(a==="toggle-form-card"){e.preventDefault();const n=t.dataset.formId||"";i.expandedFormIds.has(n)?i.expandedFormIds.delete(n):i.expandedFormIds.add(n),p();return}if(a==="edit-form"){if(e.preventDefault(),!y("forms.manage",u(),"Your role cannot edit forms.","Forms"))return;Kt(t.dataset.formId,!1),i.formsTab="builder",i.formEditorTab="questions",i.modal="",p();return}if(a==="save-form"){if(e.preventDefault(),!y("forms.manage",u(),"Your role cannot edit forms.","Forms"))return;se("Form saved locally"),p();return}if(a==="publish-form"){if(e.preventDefault(),!y("forms.manage",u(),"Your role cannot publish forms.","Forms"))return;qi(t.dataset.formId,"Published");return}if(a==="archive-form"){if(e.preventDefault(),!y("forms.manage",u(),"Your role cannot archive forms.","Forms"))return;qi(t.dataset.formId,"Archived");return}if(a==="duplicate-form"){if(e.preventDefault(),!y("forms.manage",u(),"Your role cannot duplicate forms.","Forms"))return;Au(t.dataset.formId);return}if(a==="delete-form"){if(e.preventDefault(),!y("forms.manage",u(),"Your role cannot delete forms.","Forms"))return;Mu(t.dataset.formId);return}if(a==="copy-form-link"){e.preventDefault(),Fu(t.dataset.formId);return}if(a==="export-forms"){e.preventDefault(),Iu(u());return}if(a==="new-finance-invoice"){if(e.preventDefault(),!h("finance.manage",u()))return $("Your role cannot manage finance records.","local","Finance");i.selectedFinanceInvoiceId="",i.modal="finance-invoice-new",p();return}if(a==="edit-finance-invoice"){if(e.preventDefault(),!h("finance.manage",u()))return $("Your role cannot manage finance records.","local","Finance");i.selectedFinanceInvoiceId=t.dataset.invoiceId||"",i.modal="finance-invoice-edit",p();return}if(a==="new-finance-payment"){if(e.preventDefault(),!h("finance.manage",u()))return $("Your role cannot manage finance records.","local","Finance");i.selectedFinanceInvoiceId=t.dataset.invoiceId||i.route?.params?.get("invoice")||"",i.modal="finance-payment-new",p();return}if(a==="new-finance-expense"){if(e.preventDefault(),!h("finance.manage",u()))return $("Your role cannot manage finance records.","local","Finance");i.selectedFinanceExpenseId="",i.selectedFinanceVendorId=t.dataset.vendorId||"",i.modal="finance-expense-new",p();return}if(a==="edit-finance-expense"){if(e.preventDefault(),!h("finance.manage",u()))return $("Your role cannot manage finance records.","local","Finance");i.selectedFinanceExpenseId=t.dataset.expenseId||"",i.modal="finance-expense-edit",p();return}if(a==="new-finance-vendor"){if(e.preventDefault(),!h("finance.manage",u()))return $("Your role cannot manage finance records.","local","Finance");i.selectedFinanceVendorId="",i.modal="finance-vendor-new",p();return}if(a==="edit-finance-vendor"){if(e.preventDefault(),!h("finance.manage",u()))return $("Your role cannot manage finance records.","local","Finance");i.selectedFinanceVendorId=t.dataset.vendorId||"",i.modal="finance-vendor-edit",p();return}if(a==="add-question"){if(e.preventDefault(),!y("forms.manage",u(),"Your role cannot edit forms.","Forms"))return;Tu(t.dataset.questionType||"multiple");return}if(a==="duplicate-question"){if(e.preventDefault(),!y("forms.manage",u(),"Your role cannot edit forms.","Forms"))return;Eu(t.dataset.questionId);return}if(a==="delete-question"){if(e.preventDefault(),!y("forms.manage",u(),"Your role cannot edit forms.","Forms"))return;xu(t.dataset.questionId);return}if(a==="move-question"){if(e.preventDefault(),!y("forms.manage",u(),"Your role cannot edit forms.","Forms"))return;Ou(t.dataset.questionId,Number(t.dataset.direction||0));return}if(a==="add-question-option"){if(e.preventDefault(),!y("forms.manage",u(),"Your role cannot edit forms.","Forms"))return;Ru(t.dataset.questionId);return}if(a==="remove-question-option"){if(e.preventDefault(),!y("forms.manage",u(),"Your role cannot edit forms.","Forms"))return;Pu(t.dataset.questionId,Number(t.dataset.optionIndex||-1));return}if(a==="delete-job"){if(e.preventDefault(),!y("jobs.manage",u(),"Your role cannot delete jobs.","Jobs"))return;vc(t.dataset.jobId);return}if(a==="delete-task"){if(e.preventDefault(),!y("tasks.manage",u(),"Your role cannot delete tasks.","Tasks"))return;hc(t.dataset.taskId)}}function Nl(){const e=i.route||Mt();if(i.modal="",i.formStartTemplateId="",i.formStartTab="blank",i.selectedFinanceInvoiceId="",i.selectedFinanceExpenseId="",i.selectedFinanceVendorId="",e.name==="company"&&e.section==="tasks"&&(e.params.get("new")||e.params.get("edit")||e.params.get("task_id"))){j(m("tasks",e.jobId?{job_id:e.jobId}:{},e.companyId),{replace:!0});return}if(e.name==="company"&&e.section==="jobs"&&e.params.get("tab")==="editor"){const t=e.jobId?P(e.jobId):Te();j(m("jobs",{tab:t?"profile":"pipeline",...t?{job_id:t.id}:{}},e.companyId),{replace:!0});return}if(e.name==="company"&&e.section==="crm"&&e.params.get("account")){j(m("crm",{},e.companyId),{replace:!0});return}if(e.name==="company"&&e.section==="finance"&&(e.params.get("invoice")||e.params.get("expense")||e.params.get("vendor")||e.params.get("report"))){j(m("finance",{},e.companyId),{replace:!0});return}p()}function Ll(e){if(e.target.matches("[data-login-form]")){e.preventDefault();const t=Object.fromEntries(new FormData(e.target).entries());if(!(String(t.username||"").trim()===We.localUsername&&String(t.password||"")===We.localPassword)){i.loginError="Invalid temporary credentials.",p();return}i.loginError="",ms(t.return_url||_(m("jobs",{},L())));return}if(e.target.matches("[data-auth-sign-in-form]")){e.preventDefault(),Bl(e.target);return}if(e.target.matches("[data-auth-register-form]")){e.preventDefault(),Wl(e.target);return}if(e.target.matches("[data-auth-invite-code-form]")){e.preventDefault(),Hl(e.target);return}if(e.target.matches("[data-existing-invite-code-form]")){e.preventDefault();const t=Object.fromEntries(new FormData(e.target).entries()),a=String(t.invite_code||"").trim();if(!a){i.loginError="Invite code is required.",p();return}wn(a);return}if(e.target.matches("[data-auth-request-form]")){e.preventDefault(),Kl(e.target);return}if(e.target.matches("[data-company-create-form]")){e.preventDefault(),Jl(e.target);return}if(e.target.matches("[data-profile-form]")){e.preventDefault(),Vl(e.target).catch(t=>{$(t.message||"Profile save failed.","local","Profile")});return}if(e.target.matches("[data-job-form]")){e.preventDefault(),_c(e.target);return}if(e.target.matches("[data-task-form]")){e.preventDefault(),yc(e.target);return}if(e.target.matches("[data-new-form-form]")){e.preventDefault(),qu(e.target);return}if(e.target.matches("[data-file-form]")){e.preventDefault(),wc(e.target);return}if(e.target.matches("[data-folder-form]")){e.preventDefault(),$c(e.target);return}if(e.target.matches("[data-finance-invoice-form]")){e.preventDefault(),Sc(e.target);return}if(e.target.matches("[data-finance-payment-form]")){e.preventDefault(),kc(e.target);return}if(e.target.matches("[data-finance-expense-form]")){e.preventDefault(),Dc(e.target);return}if(e.target.matches("[data-finance-vendor-form]")){e.preventDefault(),Cc(e.target);return}if(e.target.matches("[data-role-form]")){e.preventDefault(),ec(e.target);return}if(e.target.matches("[data-invite-form]")){e.preventDefault(),tc(e.target);return}if(e.target.matches("[data-message-group-form]")){e.preventDefault(),rc(e.target);return}if(e.target.matches("[data-direct-message-form]")){e.preventDefault(),oc(e.target);return}if(e.target.matches("[data-message-access-form]")){e.preventDefault(),lc(e.target);return}if(e.target.matches("[data-message-form]")){e.preventDefault(),cc(e.target);return}if(e.target.matches("[data-calendar-event-form]")){e.preventDefault(),dc(e.target);return}if(e.target.matches("[data-user-role-form]")){e.preventDefault(),sc(e.target);return}e.target.matches("[data-form-preview-response]")&&(e.preventDefault(),Uu(e.target))}async function Ql(){if(i.session?.auth==="supabase"){const e=q();e?.auth&&await e.auth.signOut()}localStorage.removeItem(Je),i.session=null,i.dataLoaded=!1,j("/login",{replace:!0})}function ms(e=""){i.loginError="",i.authMessage="",i.session=Za(),Xi(),i.activeCompanyId=u(),localStorage.setItem(De,i.activeCompanyId),D(Je,i.session),i.dataLoaded=!1,i.dataLoading=!1,j(ja(e||_(m("jobs",{},u()))),{replace:!0})}async function Vl(e){const t=new FormData(e),a=b().profile,n=e.elements.avatar_file?.files?.[0]||null;let s=String(t.get("avatar_url")||a.avatar_url||"").trim();if(n&&n.size){const l=await Yl(n);if(!l.ok)return;s=l.url}let o=yt({...a,full_name:String(t.get("full_name")||"").trim()||a.full_name||"Quest user",avatar_url:s},a);if(i.session?.auth==="supabase"){const l=q();if(!l){$("Profile upload needs Supabase to be available.","local","Profile");return}const c=await l.from("profiles").update({full_name:o.full_name,avatar_url:o.avatar_url}).eq("id",a.id).select().single();if(c.error){$(c.error.message||"Profile save failed.","local","Profile");return}o=yt(c.data,o),l.auth?.updateUser&&await l.auth.updateUser({data:{full_name:o.full_name,avatar_url:o.avatar_url}}),i.profiles=[o].concat(i.profiles.filter(d=>d.id!==o.id)),o.member_id&&(i.teamMembers=i.teamMembers.map(d=>d.id===o.member_id?{...d,full_name:o.full_name,name:o.full_name,avatar_url:o.avatar_url}:d))}else D(Mi,o),i.profileDraft=o;i.session={...b(),profile:o},D(Je,i.session),i.modal="",$("Profile saved.",i.session?.auth==="supabase"?"live":"local","Profile")}async function Yl(e){if(!["image/jpeg","image/png","image/webp"].includes(e.type))return $("Use a PNG, JPG, or WebP image for your profile picture.","local","Profile"),{ok:!1,url:""};if(e.size>2*1024*1024)return $("Profile pictures must be 2 MB or smaller.","local","Profile"),{ok:!1,url:""};if(i.session?.auth!=="supabase"){const f=await Bs(e);return f?{ok:!0,url:f}:($("Could not read that image file.","local","Profile"),{ok:!1,url:""})}const a=q(),n=b().profile.id,s=wu(e),o=`${n}/avatar-${Date.now()}.${s}`,l=await a.storage.from("avatars").upload(o,e,{cacheControl:"3600",upsert:!0,contentType:e.type});if(l.error)return $(l.error.message||"Profile picture upload failed.","local","Profile"),{ok:!1,url:""};const c=a.storage.from("avatars").getPublicUrl(o),d=c.data?.publicUrl?`${c.data.publicUrl}?v=${Date.now()}`:"";return d?{ok:!0,url:d}:($("Profile picture uploaded, but no public URL was returned.","local","Profile"),{ok:!1,url:""})}async function Bl(e){const t=Object.fromEntries(new FormData(e).entries()),a=q();if(!a?.auth){i.loginError="Supabase auth is unavailable.",p();return}i.loginError="",i.authMessage="Signing in...",p();const n=await a.auth.signInWithPassword({email:String(t.email||"").trim(),password:String(t.password||"")});if(n.error){i.loginError=n.error.message||"Unable to sign in.",i.authMessage="",p();return}if(await pt(n.data.session),t.invite_token){await wn(t.invite_token,t.return_url);return}i.authMessage="",i.dataLoaded=!1,j(ja(t.return_url||_(m("jobs",{},L()))),{replace:!0})}async function Hl(e){const t=Object.fromEntries(new FormData(e).entries()),a=String(t.invite_code||"").trim();if(!a){i.loginError="Invite code is required.",p();return}i.loginError="",i.authMessage="Checking invite code...",i.authMode="register",p();const n=await zl(a);if(n?.missing){i.loginError="Invite code was not found or is no longer pending.",i.authMessage="",i.authMode="invite",p();return}if(n?.status&&n.status!=="pending"){i.loginError=`This invite is ${n.status}. Ask your company admin for a new code.`,i.authMessage="",i.authMode="invite",p();return}if(n?.expires_at&&Date.parse(n.expires_at)<=Date.now()){i.loginError="This invite code expired. Ask your company admin for a new code.",i.authMessage="",i.authMode="invite",p();return}n?(i.inviteLookup=n,i.authMessage=`Invite found for ${n.email}.`):i.authMessage="";const s=new URLSearchParams({invite:a}),o=ja(t.return_url||"");o&&s.set("return_url",o),s.set("mode","register"),j(`/login?${s.toString()}`,{replace:!0})}async function zl(e){const t=String(e||"").trim(),a=q();if(!t||!a)return null;const n=await a.rpc("lookup_company_invite",{invite_token:t}).catch(o=>({error:o}));if(n.error)return null;const s=Array.isArray(n.data)?n.data[0]:n.data;return s?{token:t,company_id:w(s.company_id||""),company_name:String(s.company_name||s.company_id||"").trim(),email:String(s.email||"").trim(),status:String(s.status||"").trim(),expires_at:s.expires_at||""}:{missing:!0}}async function Wl(e){const t=Object.fromEntries(new FormData(e).entries()),a=q();if(!a?.auth){i.loginError="Supabase auth is unavailable.",p();return}const n=String(t.email||"").trim(),s=String(t.password||""),o=String(t.full_name||"").trim(),l=String(t.invite_token||"").trim(),c=String(t.company_name||"").trim();if(!n||!s||!o||!l&&!c){i.loginError=l?"Name, email, and password are required.":"Name, email, password, and company workspace are required.",p();return}i.loginError="",i.authMessage=l?"Creating account and accepting invite...":"Creating secure workspace...",p();const d=await a.auth.signUp({email:n,password:s,options:{data:{full_name:o}}});if(d.error){const S=/already|registered|exists/i.test(d.error.message||"");i.loginError=S&&l?"That email already has a Quest HQ account. Sign in with the invited email to accept this invite.":d.error.message||"Unable to create account.",S&&l&&(i.authMode="signin"),i.authMessage="",p();return}let f=d.data.session;if(!f){const S=await a.auth.signInWithPassword({email:n,password:s});if(S.error){i.loginError="Account created. Please sign in to finish workspace setup.",i.authMode="signin",i.authMessage="",p();return}f=S.data.session}if(await pt(f),l){await wn(l,t.return_url);return}const g=await a.rpc("create_company_workspace",{company_name:c});if(g.error){i.loginError=g.error.message||"Account created, but workspace setup failed.",i.authMessage="",p();return}i.activeCompanyId=w(g.data||L()),xn(i.activeCompanyId),localStorage.setItem(De,i.activeCompanyId),i.dataLoaded=!1,i.authMessage="",j(m("settings",{tab:"billing"},i.activeCompanyId),{replace:!0})}async function Jl(e){const t=Object.fromEntries(new FormData(e).entries()),a=q(),n=String(t.company_name||"").trim();if(!a||!n){i.loginError="Company workspace name is required.",p();return}const s=await a.rpc("create_company_workspace",{company_name:n});if(s.error){i.loginError=s.error.message||"Workspace setup failed.",p();return}i.activeCompanyId=w(s.data||L()),xn(i.activeCompanyId),localStorage.setItem(De,i.activeCompanyId),i.dataLoaded=!1,j(m("settings",{tab:"billing"},i.activeCompanyId),{replace:!0})}async function Kl(e){const t=Object.fromEntries(new FormData(e).entries()),a=q();if(!a?.auth){i.loginError="Supabase auth is unavailable.",p();return}const n=String(t.email||"").trim(),s=String(t.password||""),o=w(t.company_id||"");i.loginError="",i.authMessage="Submitting access request...",p();const l=await a.auth.signInWithPassword({email:n,password:s});if(l.error){i.loginError=l.error.message||"Sign in first to request access.",i.authMessage="",p();return}await pt(l.data.session);const c=await a.rpc("request_company_access",{target_company_id:o,request_message:String(t.message||"").trim()||null});if(c.error){i.loginError=c.error.message||"Unable to request access.",i.authMessage="",p();return}i.authMessage="Access request sent. An Owner/Admin must approve it.",i.loginError="",i.authMode="signin",p()}async function Gl(){const e=u();i.sync={label:"Opening billing...",mode:"loading"},p();try{const t=await fetch("/api/create-checkout-session",{method:"POST",headers:{"Content-Type":"application/json",...b().access_token?{Authorization:`Bearer ${b().access_token}`}:{}},body:JSON.stringify({company_id:e,return_url:`${window.location.origin}${_(m("settings",{tab:"billing"},e))}`})}),a=await t.json().catch(()=>({}));if(!t.ok||!a.url)throw new Error(a.error||"Billing is not configured yet.");window.location.href=a.url}catch(t){i.sync={label:t.message||"Billing unavailable",mode:"local"},p()}}async function Zl(e,t){const a=w(e),n=Oa(t);if(!a||!n||!Rn()){$("Quest developer access is required to review workspaces.","local","Workspace review");return}const s=q();if(i.sync={label:"Updating workspace review...",mode:"loading"},p(),i.session?.auth==="supabase"&&s){const o=await s.rpc("review_company_workspace",{target_company_id:a,next_status:n,review_note:`Marked ${n} from Quest HQ approval console`});if(o.error){i.sync={label:o.error.message||"Workspace review failed",mode:"local"},$(o.error.message||"Workspace review failed.","local","Workspace review"),p();return}}Xl(a,n),await at(a,"workspace.reviewed","company_subscription",a,{status:n},i.session?.auth==="supabase"),i.sync={label:`Workspace marked ${ia(n).toLowerCase()}`,mode:i.session?.auth==="supabase"?"live":"local"},$(`Workspace marked ${ia(n).toLowerCase()}.`,i.session?.auth==="supabase"?"live":"local","Workspace review"),p()}function Xl(e,t){const a=oa({...Ot(e)||{},company_id:e,status:t});i.subscriptions=Os(i.subscriptions.filter(s=>s.company_id!==e).concat(a));const n=ut({...i.workspaceReviews.find(s=>s.company_id===e)||{},company_id:e,company_name:E(e),status:t,plan_code:a.plan_code,amount_cents:a.amount_cents,currency:a.currency,created_at:new Date().toISOString()});i.workspaceReviews=i.workspaceReviews.filter(s=>s.company_id!==e).concat(n),t==="pending_review"?xn(e):jd(e)}async function ec(e){const t=u();if(!y("roles.manage",t,"Your role cannot manage roles.","Roles"))return;const a=new FormData(e),n=He({id:crypto.randomUUID(),company_id:t,name:a.get("name"),color:a.get("color")||"#f0b23b",priority:a.get("priority")||100,is_system:!1,created_by:b().profile.id}),s=a.getAll("permissions").map(l=>String(l||"")).filter(Boolean),o=q();if(i.session?.auth==="supabase"&&o){const l=await o.from("roles").insert(n).select().single();if(l.error){i.sync={label:l.error.message||"Role save failed",mode:"local"},p();return}const c=He(l.data),d=s.map(f=>({role_id:c.id,permission_key:f,effect:"allow"}));d.length&&await o.from("role_permissions").insert(d),i.roles.unshift(c),i.rolePermissions=d.concat(i.rolePermissions).map(Ga),i.sync={label:"Role saved",mode:"live"}}else i.roles.unshift(n),i.rolePermissions=s.map(l=>Ga({role_id:n.id,permission_key:l,effect:"allow"})).concat(i.rolePermissions),i.sync={label:"Role saved locally",mode:"local"};i.modal="",p()}async function tc(e){const t=new FormData(e),a=w(t.get("company_id")||u());if(!y("users.manage",a,"Your role cannot invite users.","Users"))return;const n=String(t.get("email")||"").trim().toLowerCase(),s=String(t.get("role_id")||"").trim();if(!n){i.sync={label:"Invite email is required",mode:"local"},p();return}const o=la({id:crypto.randomUUID(),company_id:a,email:n,role_id:kt(s)?s:"",token:_d(),status:"pending",invited_by:b().profile.id,expires_at:new Date(Date.now()+336*60*60*1e3).toISOString(),created_at:new Date().toISOString()}),l=q();if(i.session?.auth==="supabase"&&l){const c={company_id:o.company_id,email:o.email,role_id:o.role_id||null,token:o.token,status:"pending",invited_by:b().profile.id},d=await l.from("company_invites").insert(c).select().single();if(d.error){i.sync={label:d.error.message||"Invite save failed",mode:"local"},p();return}i.companyInvites.unshift(la(d.data)),await at(o.company_id,"invite.created","company_invite",d.data.id,{email:o.email},!0),i.sync={label:"Invite code created. Copy it for the new user.",mode:"live"}}else i.companyInvites.unshift(o),at(o.company_id,"invite.created","company_invite",o.id,{email:o.email}),i.sync={label:"Invite code created locally",mode:"local"};J("access.invite","Invite code created",`${Y()} created an invite code for ${o.email}.`,m("settings",{tab:"access"},o.company_id),"invite",o.id,o.company_id),i.modal="",p()}async function wn(e,t=""){const a=q();if(!a){i.loginError="Supabase auth is unavailable.",i.authMessage="",p();return}i.authMessage="Accepting workspace invite...",p();const n=await a.rpc("accept_company_invite",{invite_token:String(e||"").trim()});if(n.error){i.loginError=n.error.message||"Unable to accept invite.",i.authMessage="",p();return}const s=w(n.data||L());i.activeCompanyId=s,localStorage.setItem(De,s),i.inviteLookup=null,i.authMessage="",i.loginError="",i.dataLoaded=!1,j(m("jobs",{},s),{replace:!0})}async function ac(e){const t=i.companyInvites.find(a=>a.id===e);if(!(t&&!y("users.manage",t.company_id,"Your role cannot view invite links.","Users"))){if(!t?.token){i.sync={label:"Invite link is unavailable",mode:"local"},p();return}try{await navigator.clipboard.writeText(vd(t)),i.sync={label:"Invite link copied",mode:"live"}}catch{i.sync={label:"Copy failed",mode:"local"}}p()}}async function nc(e){const t=i.companyInvites.find(a=>a.id===e);if(!(t&&!y("users.manage",t.company_id,"Your role cannot view invite codes.","Users"))){if(!t?.token){i.sync={label:"Invite code is unavailable",mode:"local"},p();return}try{await navigator.clipboard.writeText(t.token),i.sync={label:"Invite code copied",mode:"live"}}catch{i.sync={label:"Copy failed",mode:"local"}}p()}}async function ic(e){const t=i.companyInvites.find(n=>n.id===e);if(!t||!y("users.manage",t.company_id,"Your role cannot revoke invites.","Users"))return;const a=q();if(i.session?.auth==="supabase"&&a){const n=await a.rpc("revoke_company_invite",{target_invite_id:t.id});if(n.error){i.sync={label:n.error.message||"Invite revoke failed",mode:"local"},p();return}i.sync={label:"Invite revoked",mode:"live"}}else i.sync={label:"Invite revoked locally",mode:"local"};i.companyInvites=i.companyInvites.map(n=>n.id===t.id?la({...n,status:"revoked"}):n),at(t.company_id,"invite.revoked","company_invite",t.id,{email:t.email}),J("access.invite","Invite revoked",`${Y()} revoked the invite for ${t.email}.`,m("settings",{tab:"access"},t.company_id),"invite",t.id,t.company_id),Z(),p()}async function sc(e){const t=new FormData(e),a=w(t.get("company_id")||u());if(!y("users.manage",a,"Your role cannot manage user access.","Users"))return;const n=String(t.get("profile_id")||"").trim(),s=String(t.get("role_id")||"").trim(),o=["active","pending","disabled","left"].includes(String(t.get("membership_status")))?String(t.get("membership_status")):"active",l=ot(a,s);if(!n||!l){i.sync={label:"Select a user and role",mode:"local"},p();return}const c=Dd(a,n,l,o);if(c){i.sync={label:c,mode:"local"},p();return}const d=ra({company_id:a,profile_id:n,role:jn(l),status:o}),f=oe(a,n),g=Rs({company_id:a,profile_id:n,role_id:l.id,assigned_by:b().profile.id}),S=q();if(i.session?.auth==="supabase"&&S){const V=kt(l.id),T=await S.rpc("update_company_member_access",{target_company_id:a,target_profile_id:n,target_role:d.role,target_role_id:V?l.id:null,target_status:o});if(T.error){i.sync={label:T.error.message||"Access update failed",mode:"local"},p();return}aa(ra(T.data||d)),V&&vi(g),i.sync={label:V?"User access saved":"Membership saved; create a role to assign permissions",mode:"live"}}else aa(d),vi(g),i.sync={label:"User access saved locally",mode:"local"};J("access.role","User access updated",`${Y()} set ${Rt(n)} to ${l.name} / ${I(o)}.`,m("settings",{tab:"access"},a),"membership",n,a,[n].concat(ue(a,["users.manage","settings.manage"]))),at(a,bu(f,d),"membership",n,{role:l.name,status:o}),p()}async function gi(e,t){const a=i.joinRequests.find(l=>l.id===e);if(!a||!["approved","rejected"].includes(t)||!y("users.manage",a.company_id,"Your role cannot manage access requests.","Users"))return;const n=q(),s=Ps({...a,status:t}),o=ra({company_id:a.company_id,profile_id:a.profile_id,role:"member",status:t==="approved"?"active":"disabled"});if(i.session?.auth==="supabase"&&n){const l=await n.rpc("review_company_join_request",{target_request_id:a.id,decision:t,target_role_id:null});if(l.error){i.sync={label:l.error.message||"Request update failed",mode:"local"},p();return}t==="approved"&&aa(o),i.sync={label:t==="approved"?"Access approved":"Request rejected",mode:"live"}}else t==="approved"&&aa(o),i.sync={label:t==="approved"?"Access approved locally":"Request rejected locally",mode:"local"};i.joinRequests=i.joinRequests.map(l=>l.id===a.id?s:l),at(a.company_id,t==="approved"?"join.approved":"join.rejected","join_request",a.id,{email:a.requested_email}),J("access.request",t==="approved"?"Access approved":"Access rejected",`${Y()} ${t==="approved"?"approved":"rejected"} ${a.requested_email||"a join request"}.`,m("settings",{tab:"access"},a.company_id),"join_request",a.id,a.company_id,[a.profile_id].concat(ue(a.company_id,["users.manage","settings.manage"]))),Z(),p()}async function rc(e){const t=u();if(!h("messages.create_group",t)){$("Your role cannot create group chats.","local","Messages");return}const a=new FormData(e),n=["company","role","custom"].includes(a.get("type"))?String(a.get("type")):"custom",s=ve({id:crypto.randomUUID(),company_id:t,title:String(a.get("title")||"").trim()||"New group chat",type:n,created_by:b().profile.id,last_message_at:new Date().toISOString(),created_at:new Date().toISOString(),updated_at:new Date().toISOString()}),o=Bn(a,s,n);!o.some(c=>c.target_type==="profile"&&c.target_id===b().profile.id)&&n!=="company"&&o.push(ee({id:`msg-access-${crypto.randomUUID()}`,company_id:t,conversation_id:s.id,target_type:"profile",target_id:b().profile.id})),await $n(s,o)&&(i.selectedConversationId=s.id,i.modal="",J("message.group","Group chat created",`${Y()} created ${s.title}.`,m("messages",{conversation:s.id},t),"message_conversation",s.id,t,ca(s)),j(m("messages",{conversation:s.id},t),{replace:!0}))}async function oc(e){const t=u();if(!y("messages.send",t,"Your role cannot start direct messages.","Messages"))return;const a=new FormData(e),n=String(a.get("profile_id")||"").trim();if(!n){$("Choose a person first.","local","Messages");return}const s=ve({id:crypto.randomUUID(),company_id:t,title:Rt(n),type:"direct",created_by:b().profile.id,last_message_at:new Date().toISOString(),created_at:new Date().toISOString(),updated_at:new Date().toISOString()}),o=[ee({id:`msg-access-${crypto.randomUUID()}`,company_id:t,conversation_id:s.id,target_type:"profile",target_id:b().profile.id}),ee({id:`msg-access-${crypto.randomUUID()}`,company_id:t,conversation_id:s.id,target_type:"profile",target_id:n})];if(!await $n(s,o))return;i.selectedConversationId=s.id,i.modal="";const c=String(a.get("body")||"").trim();c&&await ps(s,c,[]),J("message.direct","Direct message started",`${Y()} started a direct message with ${s.title}.`,m("messages",{conversation:s.id},t),"message_conversation",s.id,t,[n]),j(m("messages",{conversation:s.id},t),{replace:!0})}async function lc(e){const t=u();if(!h("messages.manage_groups",t)&&!h("messages.manage",t)){$("Your role cannot manage chat access.","local","Messages");return}const a=i.messageConversations.find(f=>f.id===e.dataset.conversationId);if(!a)return;const n=new FormData(e),s=ve({...a,title:String(n.get("title")||"").trim()||a.title,type:fn.includes(n.get("type"))?String(n.get("type")):a.type,updated_at:new Date().toISOString()}),o=Bn(n,s,s.type);s.type!=="company"&&!o.some(f=>f.target_type==="profile"&&f.target_id===b().profile.id)&&o.push(ee({id:`msg-access-${crypto.randomUUID()}`,company_id:t,conversation_id:s.id,target_type:"profile",target_id:b().profile.id}));const l=ca(a);if(!await $n(s,o,!0))return;const d=ca(s).filter(f=>!l.includes(f));d.length&&J("message.group","Added to chat",`${Y()} added you to ${s.title}.`,m("messages",{conversation:s.id},t),"message_conversation",s.id,t,d),i.modal="",$("Chat access saved.",i.session?.auth==="supabase"?"live":"local","Messages"),p()}async function cc(e){const t=i.messageConversations.find(o=>o.id===e.dataset.conversationId);if(!t)return;if(!h("messages.send",t.company_id)){$("Your role cannot send messages.","local","Messages");return}const a=new FormData(e),n=String(a.get("body")||"").trim(),s=Array.from(e.elements.attachments?.files||[]);if(!n&&!s.length){$("Type a message or attach a file.","local","Messages");return}if(s.length&&!h("messages.attach_files",t.company_id)){$("Your role cannot attach files.","local","Messages");return}await ps(t,n,s),e.reset(),p()}async function dc(e){const t=u(),a=Object.fromEntries(new FormData(e).entries()),n=a.id?It(String(a.id)):null;if(!n&&!h("calendar.manage",t)){$("Your role cannot create or edit calendar events.","local","Calendar");return}if(n&&!Ft(n)){$("This event cannot be edited from Calendar.","local","Calendar");return}const s=String(a.linked_job_id||"").trim(),o=new Date().toISOString();let l=tt({...n||{},id:n?.id||crypto.randomUUID(),company_id:t,title:String(a.title||"").trim()||"Calendar event",description:String(a.description||"").trim(),event_type:Sa.includes(a.event_type)?String(a.event_type):"Company event",starts_at:Si(a.starts_at),ends_at:Si(a.ends_at||a.starts_at),all_day:a.all_day==="on",visibility:a.visibility==="private"?"private":"company",linked_type:s?"job":"",linked_id:s,assigned_profile_id:String(a.assigned_profile_id||""),created_by:n?.created_by||b().profile.id,created_at:n?.created_at||o,updated_at:o});const c=q();if(i.session?.auth==="supabase"&&c){const d=Ed(l);n&&delete d.id;const f=n?await c.from("calendar_events").update({...d,updated_at:o}).eq("id",n.id).select().single():await c.from("calendar_events").insert(d).select().single();if(f.error){$(f.error.message||"Calendar event save failed.","local","Calendar");return}l=tt(f.data)}i.calendarEvents=[l].concat(i.calendarEvents.filter(d=>d.id!==l.id)),Qs(),J("calendar.event",n?"Calendar event updated":"Calendar event created",`${Y()} ${n?"updated":"created"} ${l.title}.`,m("calendar",{},t),"calendar_event",l.id,t),i.selectedCalendarEventId=`manual:${l.id}`,i.modal="calendar-event-detail",p()}async function uc(e){const t=It(e);if(!t||!Ft(t)){$("This event cannot be deleted from Calendar.","local","Calendar");return}const a=q();if(i.session?.auth==="supabase"&&a){const n=await a.from("calendar_events").delete().eq("id",t.id);if(n.error){$(n.error.message||"Calendar event delete failed.","local","Calendar");return}}i.calendarEvents=i.calendarEvents.filter(n=>n.id!==t.id),Qs(),J("calendar.event","Calendar event deleted",`${Y()} deleted ${t.title}.`,m("calendar",{},t.company_id),"calendar_event",t.id,t.company_id),i.selectedCalendarEventId="",i.modal="",p()}async function ps(e,t,a){const n=new Date().toISOString(),s=Se({id:crypto.randomUUID(),conversation_id:e.id,company_id:e.company_id,sender_profile_id:b().profile.id,body:t,message_type:a.length?"attachment":"text",created_at:n,updated_at:n}),o=q();let l=s;if(i.session?.auth==="supabase"&&o){const f=await o.from("messages").insert(Id(s)).select().single();if(f.error)return $(f.error.message||"Message send failed.","local","Messages"),null;l=Se(f.data)}i.messages=i.messages.concat(l);const c=await mc(l,a),d={...e,last_message_at:l.created_at,updated_at:l.created_at};return i.messageConversations=i.messageConversations.map(f=>f.id===e.id?d:f),i.session?.auth==="supabase"&&o&&await o.from("message_conversations").update({last_message_at:l.created_at,updated_at:l.created_at}).eq("id",e.id),Ua(e.id,!1),Vs(d,l,c),Ne(),l}async function mc(e,t){const a=q(),n=[];for(const s of t){const o=crypto.randomUUID(),l=`${e.company_id}/${e.conversation_id}/${o}-${Bt(s.name||"attachment")}`;let c="",d="";if(i.session?.auth==="supabase"&&a){const g=await a.storage.from("quest-message-attachments").upload(l,s,{cacheControl:"3600",upsert:!1,contentType:s.type||"application/octet-stream"});if(g.error){$(g.error.message||"Attachment upload failed.","local","Messages");continue}d=l}else s.type?.startsWith("image/")&&s.size<=22e4&&(c=await Bs(s));const f=Ee({id:o,conversation_id:e.conversation_id,message_id:e.id,company_id:e.company_id,bucket_id:"quest-message-attachments",object_path:d,file_name:s.name||"attachment",mime_type:s.type||"application/octet-stream",size_bytes:s.size||0,preview_url:c,created_at:new Date().toISOString()});if(i.session?.auth==="supabase"&&a){const g=await a.from("message_attachments").insert(Td(f)).select().single();if(g.error){$(g.error.message||"Attachment record failed.","local","Messages"),d&&await a.storage.from("quest-message-attachments").remove([d]);continue}n.push(Ee(g.data))}else n.push(f)}return i.messageAttachments=i.messageAttachments.concat(n),n}async function $n(e,t,a=!1){const n=q();if(i.session?.auth==="supabase"&&n){const s=a?await n.from("message_conversations").update(wi(e)).eq("id",e.id).select().single():await n.from("message_conversations").insert(wi(e)).select().single();if(s.error)return $(s.error.message||"Conversation save failed.","local","Messages"),!1;if(await n.from("message_conversation_access").delete().eq("conversation_id",e.id),t.length){const o=await n.from("message_conversation_access").insert(t.map(Fd));if(o.error)return $(o.error.message||"Conversation access save failed.","local","Messages"),!1}e=ve(s.data),i.sync={label:"Quest Supabase live",mode:"live"}}return i.messageConversations=[e].concat(i.messageConversations.filter(s=>s.id!==e.id)),i.messageAccess=t.concat(i.messageAccess.filter(s=>s.conversation_id!==e.id)),Ua(e.id,!1),Ne(),!0}async function pc(e){const t=i.messages.find(o=>o.id===e);if(!t)return;if(!(t.sender_profile_id===b().profile.id&&h("messages.delete_own",t.company_id)||h("messages.delete_any",t.company_id))){$("Your role cannot delete this message.","local","Messages");return}const n=new Date().toISOString(),s=q();if(i.session?.auth==="supabase"&&s){const o=await s.from("messages").update({deleted_at:n,updated_at:n}).eq("id",t.id);if(o.error){$(o.error.message||"Message delete failed.","local","Messages");return}}i.messages=i.messages.map(o=>o.id===t.id?{...o,deleted_at:n,updated_at:n}:o),Ne(),p()}async function fc(e){const t=i.messageAttachments.find(n=>n.id===e);if(!t)return;if(t.preview_url){window.open(t.preview_url,"_blank","noopener,noreferrer");return}const a=q();if(i.session?.auth==="supabase"&&a&&t.object_path){const n=await a.storage.from(t.bucket_id||"quest-message-attachments").createSignedUrl(t.object_path,900,{download:t.file_name});if(!n.error&&n.data?.signedUrl){window.open(n.data.signedUrl,"_blank","noopener,noreferrer");return}}$("This demo attachment is metadata-only.","local","Messages")}function gc(e){if(e.target.matches("[data-global-search]")){i.query=e.target.value,Qe();return}if(e.target.matches("[data-file-search]")){i.fileQuery=e.target.value,Qe();return}if(e.target.matches("[data-form-search]")){i.formQuery=e.target.value,Qe();return}if(e.target.matches("[data-crm-search]")){i.crmQuery=e.target.value,Qe();return}if(e.target.matches("[data-message-search]")){i.messageQuery=e.target.value,Qe();return}if(e.target.matches("[data-calendar-search]")){i.calendarQuery=e.target.value,Qe();return}if(e.target.matches("[data-message-access-filter]")){eu(e.target);return}if(e.target.matches("[data-form-field]")){ar(e.target);return}(e.target.matches("[data-question-field]")||e.target.matches("[data-question-option]"))&&nr(e.target)}function bc(e){if(e.target.matches("[data-company-switch]")){const t=e.target.value||L();Vc(t);return}if(e.target.matches("[data-stage-filter]")){i.stageFilter=e.target.value||"all",p();return}if(e.target.matches("[data-crm-stage-filter]")){i.crmStageFilter=e.target.value||"all",p();return}if(e.target.matches("[data-crm-owner-filter]")){i.crmOwnerFilter=e.target.value||"all",p();return}if(e.target.matches("[data-task-status-filter]")){i.taskStatusFilter=e.target.value||"all",p();return}if(e.target.matches("[data-task-priority-filter]")){i.taskPriorityFilter=e.target.value||"all",p();return}if(e.target.matches("[data-calendar-type-filter]")){i.calendarTypeFilter=e.target.value||"all",p();return}if(e.target.matches("[data-task-job-filter]")){const t=e.target.value;j(m("tasks",t?{job_id:t}:{},u()));return}if(e.target.matches("[data-analytics-job-filter]")){const t=e.target.value;j(m("analytics",t?{job_id:t}:{},u()));return}if(e.target.matches("[data-file-category-filter]")){i.fileCategoryFilter=e.target.value||"All categories",p();return}if(e.target.matches("[data-file-folder-filter]")){const t=e.target.value==="home"?"":e.target.value,a=i.route?.jobId||"";j(m("files",{...t?{folder:t}:{},...a?{job_id:a}:{}},u()));return}if(e.target.matches("[data-file-job-filter]")){const t=e.target.value;j(m("files",{...t?{folder:"jobs",job_id:t}:{}},u()));return}if(e.target.matches("[data-form-type-filter]")){i.formTypeFilter=e.target.value||"all",p();return}if(e.target.matches("[data-form-field]")){ar(e.target);return}(e.target.matches("[data-question-field]")||e.target.matches("[data-question-option]"))&&nr(e.target)}async function _c(e){const t=Xe(Object.fromEntries(new FormData(e).entries()));if(t.id=t.id||crypto.randomUUID(),t.company_id=t.company_id||u(),!y("jobs.manage",t.company_id,"Your role can view jobs but cannot create or edit them.","Jobs"))return;t.estimate_total=Number(t.estimate_total||0),t.invoice_total=Number(t.invoice_total||0),t.updated_at=new Date().toISOString();const a=i.jobs.some(s=>s.id===t.id),n=q();if(n){const s=a?await n.from("jobs").update(t).eq("id",t.id).select().single():await n.from("jobs").insert(t).select().single();if(!s.error&&s.data){Ha(Xe(s.data)),i.sync={label:"Quest Supabase live",mode:"live"},i.modal="",j(m("jobs",{tab:"profile",job_id:s.data.id},t.company_id),{replace:!0});return}i.sync={label:"Saved locally",mode:"local"}}Ha(t),i.modal="",j(m("jobs",{tab:"profile",job_id:t.id},t.company_id),{replace:!0})}async function vc(e){if(!e)return;const t=u();if(!y("jobs.manage",t,"Your role cannot delete jobs.","Jobs"))return;const a=q();a&&await a.from("jobs").delete().eq("id",e),i.jobs=i.jobs.filter(n=>n.id!==e),i.selectedJobId=Q(t)[0]?.id||"",i.modal="",Z(),j(m("jobs",{tab:"list"},t),{replace:!0})}async function yc(e){const t=u();if(!y("tasks.manage",t,"Your role can view tasks but cannot create or edit them.","Tasks"))return;const a=Object.fromEntries(new FormData(e).entries()),n=et({...a,id:String(a.id||"").trim()||`task-${crypto.randomUUID()}`,company_id:t,creator_id:b().profile.member_id||rt(t)[0]?.id||"abraham",urgency:a.priority||"medium",watchers:[],subtasks:[],activity:[],updated_at:new Date().toISOString()}),s=qa(n.id),o=!!s,l=q();if(l){const c=Vd(n),d=o?await l.from("tasks").update(c).eq("id",n.id).select().single():await l.from("tasks").insert(c).select().single();if(!d.error&&d.data){const f=et(d.data);bi(f),Ci(f,s),i.sync={label:"Quest Supabase live",mode:"live"},i.modal="",j(m("tasks",{...n.project_id?{job_id:n.project_id}:{},task_id:n.id},t),{replace:!0});return}i.sync={label:"Task saved locally",mode:"local"}}bi(n),Ci(n,s),i.modal="",j(m("tasks",{...n.project_id?{job_id:n.project_id}:{},task_id:n.id},t),{replace:!0})}async function hc(e){if(!e)return;const t=u();if(!y("tasks.manage",t,"Your role cannot delete tasks.","Tasks"))return;const a=q();a&&await a.from("tasks").delete().eq("id",e),i.tasks=i.tasks.filter(n=>n.id!==e),i.selectedTaskId="",i.modal="",Z(),j(m("tasks",{},t),{replace:!0})}async function wc(e){const t=u();if(!y("files.manage",t,"Your role can view files but cannot upload.","Files"))return;const a=new FormData(e),n=Object.fromEntries(a.entries()),s=Array.from(e.elements.files?.files||[]),o=String(n.file_name||"").trim(),l=s.length?s:o?[null]:[];if(!l.length){i.sync={label:"Choose a file or enter a file name",mode:"local"},p();return}const c=q();let d=0;for(const f of l){const g=crypto.randomUUID(),S=f?.name||o,V=String(n.folder||"shared"),T=`${t}/${n.job_id?`jobs/${n.job_id}`:V}/${g}-${Bt(S)}`;let ne=!1;c&&f&&(ne=!(await c.storage.from("quest-job-files").upload(T,f,{cacheControl:"3600",upsert:!1,contentType:f.type||"application/octet-stream"})).error);const Me=vt({id:g,company_id:t,job_id:n.job_id||"",folder:V,file_name:S,mime_type:f?.type||"application/octet-stream",size_bytes:f?.size||Number(n.size_bytes||0),category:n.category||fe(V),notes:n.notes||"",uploaded_by_label:n.uploaded_by_label||b().profile.full_name,bucket_id:"quest-job-files",object_path:ne||!f?T:"",created_at:new Date().toISOString(),updated_at:new Date().toISOString()});if(c){const N=await c.from("job_files").insert(Yd(Me)).select().single();if(!N.error&&N.data){_i(vt(N.data)),d+=1;continue}ne&&await c.storage.from("quest-job-files").remove([T])}_i(Me)}i.sync=d===l.length?{label:"Quest Supabase live",mode:"live"}:{label:d?"Some files saved locally":"File record saved locally",mode:d?"loading":"local"},J("file.added",l.length>1?"Files added":"File added",`${Y()} added ${l.length} file${l.length===1?"":"s"} to ${fe(n.folder||"shared")}.`,m("files",{folder:n.folder||"shared",...n.job_id?{job_id:n.job_id}:{}},t),"file",n.job_id||"",t),i.modal="",j(m("files",{folder:n.folder||"shared",...n.job_id?{job_id:n.job_id}:{}},t),{replace:!0})}function $c(e){const t=Object.fromEntries(new FormData(e).entries()),a=w(t.company_id||u());if(!y("files.manage",a,"Your role can view files but cannot create folders.","Files"))return;const n=String(t.name||"").trim();if(!n){i.sync={label:"Folder name is required",mode:"local"},p();return}const s=Un({id:`folder-${crypto.randomUUID()}`,company_id:a,name:n,parent_key:t.parent_key||"home",created_by_label:b().profile.full_name||"Quest HQ",created_at:new Date().toISOString(),updated_at:new Date().toISOString()});i.driveFolders.unshift(s),i.modal="",i.sync={label:"Folder created locally",mode:"local"},J("file.folder","Folder created",`${Y()} created ${s.name}.`,m("files",{folder:s.id},s.company_id),"folder",s.id,s.company_id),Z(),p()}async function Sc(e){const t=Object.fromEntries(new FormData(e).entries()),a=u(),n=P(t.job_id),s=String(t.id||"").trim()?Pe(String(t.id).trim()):null,o=Ut({...t,id:String(t.id||"").trim()||`invoice-${crypto.randomUUID()}`,company_id:a,client_name:String(t.client_name||n?.client_name||"").trim(),total:R(t.subtotal)+R(t.tax),updated_at:new Date().toISOString()});await ft("finance_invoices",fs(o),"Invoice save failed")&&(Ic(o),s?.job_id&&s.job_id!==o.job_id&&za(s.job_id),za(o.job_id),i.modal="",i.sync={label:i.session?.auth==="supabase"?"Invoice saved securely":"Finance saved locally",mode:i.session?.auth==="supabase"?"live":"local"},J("finance.invoice",s?"Invoice updated":"Invoice created",`${Y()} ${s?"updated":"created"} ${o.invoice_number}.`,m("finance",{invoice:o.id},a),"invoice",o.id,a),j(m("finance",{invoice:o.id},a),{replace:!0}))}async function kc(e){const t=Object.fromEntries(new FormData(e).entries()),a=u(),n=Pe(t.invoice_id);if(!n||n.company_id!==a){i.sync={label:"Create an invoice before recording a payment",mode:"local"},p();return}const s=Nt({...t,id:`payment-${crypto.randomUUID()}`,company_id:a,created_at:new Date().toISOString()});!await ft("finance_payments",jc(s),"Payment save failed")||(n.status=pe(n.id)-s.amount<=0?"Paid":"Partially paid",n.updated_at=new Date().toISOString(),!await ft("finance_invoices",fs(n),"Invoice status update failed"))||(i.financePayments.unshift(s),za(n.job_id),Z(),i.modal="",i.sync={label:i.session?.auth==="supabase"?"Payment recorded securely":"Payment recorded locally",mode:i.session?.auth==="supabase"?"live":"local"},J("finance.payment","Payment recorded",`${Y()} recorded ${C(s.amount)} for ${n.invoice_number}.`,m("finance",{invoice:s.invoice_id},a),"payment",s.id,a),j(m("finance",s.invoice_id?{invoice:s.invoice_id}:{},a),{replace:!0}))}async function Dc(e){const t=Object.fromEntries(new FormData(e).entries()),a=u(),n=Lt({...t,id:String(t.id||"").trim()||`expense-${crypto.randomUUID()}`,company_id:a,updated_at:new Date().toISOString()});await ft("finance_expenses",qc(n),"Expense save failed")&&(Tc(n),i.modal="",i.sync={label:i.session?.auth==="supabase"?"Expense saved securely":"Expense saved locally",mode:i.session?.auth==="supabase"?"live":"local"},J("finance.expense","Expense saved",`${Y()} saved a ${C(n.amount)} ${n.category} expense.`,m("finance",{expense:n.id},a),"expense",n.id,a),j(m("finance",{expense:n.id},a),{replace:!0}))}async function Cc(e){const t=Object.fromEntries(new FormData(e).entries()),a=u(),n=Qt({...t,id:String(t.id||"").trim()||`vendor-${crypto.randomUUID()}`,company_id:a,updated_at:new Date().toISOString()});await ft("finance_vendors",Ac(n),"Vendor save failed")&&(Ec(n),i.modal="",i.sync={label:i.session?.auth==="supabase"?"Vendor saved securely":"Vendor saved locally",mode:i.session?.auth==="supabase"?"live":"local"},J("finance.vendor","Vendor saved",`${Y()} saved vendor ${n.name}.`,m("finance",{vendor:n.id},a),"vendor",n.id,a),j(m("finance",{vendor:n.id},a),{replace:!0}))}async function ft(e,t,a){if(i.session?.auth!=="supabase")return!0;const n=q();if(!n)return i.sync={label:"Supabase is unavailable",mode:"local"},p(),!1;if(!h("finance.manage",t.company_id))return i.sync={label:"Your role cannot manage finance records",mode:"local"},p(),!1;const s=await n.from(e).upsert(t,{onConflict:"id"}).select().single();return s.error?(i.sync={label:s.error.message||a,mode:"local"},$(s.error.message||a,"local","Finance"),p(),!1):!0}function fs(e){return{id:e.id,company_id:e.company_id,job_id:e.job_id||null,client_name:e.client_name,invoice_number:e.invoice_number,status:e.status,issue_date:e.issue_date||null,due_date:e.due_date||null,subtotal:R(e.subtotal),tax:R(e.tax),total:R(e.total),notes:e.notes||"",created_by:b().profile.id||null,updated_at:new Date().toISOString()}}function jc(e){return{id:e.id,company_id:e.company_id,invoice_id:e.invoice_id,amount:R(e.amount),method:e.method,received_at:e.received_at||null,reference:e.reference||"",notes:e.notes||"",created_by:b().profile.id||null,updated_at:new Date().toISOString()}}function qc(e){return{id:e.id,company_id:e.company_id,job_id:e.job_id||null,vendor_id:e.vendor_id||null,category:e.category,amount:R(e.amount),status:e.status,spent_at:e.spent_at||null,notes:e.notes||"",created_by:b().profile.id||null,updated_at:new Date().toISOString()}}function Ac(e){return{id:e.id,company_id:e.company_id,name:e.name,contact_name:e.contact_name||"",email:e.email||"",phone:e.phone||"",category:e.category,status:e.status,notes:e.notes||"",created_by:b().profile.id||null,updated_at:new Date().toISOString()}}async function Mc(e){const t=i.files.find(s=>s.id===e);if(t&&!y("files.view",t.company_id,"Your role cannot view this file.","Files"))return;if(!t?.object_path){i.sync={label:"No stored object for this file",mode:"local"},p();return}const a=q();if(!a)return;const n=await a.storage.from(t.bucket_id||"quest-job-files").createSignedUrl(t.object_path,3600,{download:t.file_name});if(n.error||!n.data?.signedUrl){i.sync={label:"Download failed",mode:"local"},p();return}window.open(n.data.signedUrl,"_blank","noopener,noreferrer")}async function Fc(e){const t=i.files.find(n=>n.id===e);if(!t||!y("files.manage",t.company_id,"Your role cannot delete files.","Files"))return;const a=q();a&&(t.object_path&&await a.storage.from(t.bucket_id||"quest-job-files").remove([t.object_path]),await a.from("job_files").update({deleted_at:new Date().toISOString()}).eq("id",e)),i.files=i.files.filter(n=>n.id!==e),i.selectedFileId="",i.modal="",Z(),p()}function Ha(e){const t=i.jobs.findIndex(a=>a.id===e.id);t>=0?i.jobs[t]=e:i.jobs.unshift(e),i.selectedJobId=e.id,Z()}function bi(e){const t=i.tasks.findIndex(a=>a.id===e.id);t>=0?i.tasks[t]=e:i.tasks.unshift(e),i.selectedTaskId=e.id,Z()}function _i(e){const t=i.files.findIndex(a=>a.id===e.id);t>=0?i.files[t]=e:i.files.unshift(e),Z()}function Ic(e){const t=i.financeInvoices.findIndex(a=>a.id===e.id);t>=0?i.financeInvoices[t]=e:i.financeInvoices.unshift(e),Z()}function Tc(e){const t=i.financeExpenses.findIndex(a=>a.id===e.id);t>=0?i.financeExpenses[t]=e:i.financeExpenses.unshift(e),Z()}function Ec(e){const t=i.financeVendors.findIndex(a=>a.id===e.id);t>=0?i.financeVendors[t]=e:i.financeVendors.unshift(e),Z()}function aa(e){const t=i.memberships.findIndex(a=>a.company_id===e.company_id&&a.profile_id===e.profile_id);t>=0?i.memberships[t]=e:i.memberships.unshift(e),Z()}function vi(e){i.roleAssignments=i.roleAssignments.filter(t=>t.company_id!==e.company_id||t.profile_id!==e.profile_id),e.role_id&&i.roleAssignments.unshift(e)}function za(e){if(!e)return;const t=P(e);t&&(t.invoice_total=me(_e(t.company_id).filter(a=>a.job_id===e),"total"),t.updated_at=new Date().toISOString(),Ha(t))}function Qe(){const e=document.getElementById("workspace");e&&(gs(i.route),e.innerHTML=as(i.route))}function Mt(){const e=Sn(),t=new URLSearchParams(window.location.search);if(e==="/login")return{name:"login",path:e,params:t,section:"",companyId:"",jobId:""};if(e==="/")return{name:"home",path:e,params:t,section:"",companyId:"",jobId:""};if(e==="/command")return{name:"command",path:e,params:t,section:"dashboard",companyId:u(),jobId:t.get("job_id")||""};const a=e.match(/^\/company\/([^/]+)(?:\/([^/]+))?\/?$/);if(a){const n=a[2]||"home";return{name:"company",path:e,params:t,companyId:decodeURIComponent(a[1]),section:n,jobId:t.get("job_id")||""}}return{name:e.replace(/^\//,"")||"command",path:e,params:t,section:"",companyId:u(),jobId:t.get("job_id")||""}}function xc(){const e=Sn(),t=new URLSearchParams(window.location.search),a=t.get("company_id")||t.get("company")||Zt(t.get("job_id")||t.get("project_id"))||localStorage.getItem(De)||L(),n=Object.fromEntries(Object.entries(pr).map(([l,c])=>[l,m(c,{},a)]));Object.assign(n,{"/index.html":"/","/command.html":m("home",{},a),"/login.html":"/login"});let s=n[e];if(e==="/jobs"){const l=t.get("tab");l==="tasks"?s=m("tasks",ce(t,["job_id","task_id","new","edit"]),a):l==="files"?s=m("files",ce(t,["job_id","folder"]),a):l==="forms"?s=m("forms",ce(t,["job_id"]),a):l==="analytics"?s=m("analytics",ce(t,["job_id"]),a):s=m("jobs",ce(t,["job_id","tab"]),a)}if(e==="/files"&&(s=m("files",ce(t,["job_id","folder"]),a)),e==="/forms"&&(s=m("forms",ce(t,["job_id"]),a)),e==="/analytics"&&(s=m("analytics",ce(t,["job_id"]),a)),e==="/crm"&&(s=m("crm",ce(t,["account"]),a)),e==="/finance"&&(s=m("finance",ce(t,["invoice","expense","vendor","report"]),a)),e==="/messages"&&(s=m("messages",ce(t,["conversation"]),a)),e==="/calendar"&&(s=m("calendar",{},a)),e==="/admin"&&(s=m("settings",{},a)),e==="/time"&&(s=m("time",{},a)),e==="/team"&&(s=m("team-chart",{},a)),e==="/team-chart"&&(s=m("team-chart",{},a)),e==="/approvals"&&(s=m("approvals",{},a)),e==="/clock"&&(s=m("clock",{},a)),e==="/task-management.html"){const l=t.get("project_id")||t.get("job_id")||"";s=m("tasks",l?{job_id:l}:{},Zt(l)||a)}const o=e.match(/^\/jobs\/([^/]+)\/tasks\/?$/);if(o){const l=decodeURIComponent(o[1]);s=m("tasks",{job_id:l},Zt(l)||a)}s&&window.history.replaceState({},"",_(s))}function Oc(e){if(e.name!=="company")return"";if(e.section==="home"&&/^\/company\/[^/]+\/?$/.test(e.path))return m("home",{},e.companyId);const t=Ue();if(i.session?.auth==="supabase"&&!t.length)return null;if(!t.includes(e.companyId))return i.session?.auth==="supabase"?"":m(e.section||"jobs",Object.fromEntries(e.params.entries()),t[0]||L());if(!st.map(s=>s.id).includes(e.section))return m("home",{},e.companyId);const n=e.jobId?Zt(e.jobId):"";return n&&n!==e.companyId&&t.includes(n)?m(e.section,Object.fromEntries(e.params.entries()),n):""}function Sn(){let e=window.location.pathname||"/";return Be&&e.startsWith(Be)&&(e=e.slice(Be.length)||"/"),e.startsWith("/")||(e="/"+e),e.replace(/\/+$/,"")||"/"}function _(e){if(/^https?:\/\//i.test(e))return e;const[t,a=""]=String(e||"/").split("?"),n=t.startsWith("/")?t:"/"+t;return`${Be}${n}${a?`?${a}`:""}`||"/"}function j(e,t={}){const a=/^https?:\/\//i.test(e)||e.startsWith(Be+"/")||Be===""&&e.startsWith("/")?e:_(e);t.replace?window.history.replaceState({},"",a):window.history.pushState({},"",a),p()}function Rc(){return`${Sn()}${window.location.search}`}function ja(e){try{const t=new URL(e,window.location.origin);return t.origin!==window.location.origin?_(m("jobs",{},L())):`${t.pathname}${t.search}`}catch{return _(m("jobs",{},L()))}}function m(e="jobs",t={},a=u()){const n=new URLSearchParams(t);for(const[s,o]of[...n.entries()])(o==null||o==="")&&n.delete(s);return`/company/${encodeURIComponent(w(a||L()))}/${e}${n.toString()?`?${n.toString()}`:""}`}function Pc(e){return e.name==="home"?"Quest HQ":e.name==="company"?I(e.section):e.name==="command"?"Company Dashboard":e.name==="login"?"Sign in":I(e.name||"Workspace")}function Uc(e,t){const[a]=t.split("?"),n=a.match(/^\/company\/([^/]+)\/([^/]+)/);return!n||e.name!=="company"?!1:e.companyId===decodeURIComponent(n[1])&&e.section===n[2]}function Nc(e){return Ei.includes(e)?e:"pipeline"}function Lc(e){return{pipeline:"Pipeline",list:"List",profile:"Profile"}[e]||e}function Qc(e){const t=e.companyId||i.activeCompanyId||L(),a=Ue();i.activeCompanyId=a.includes(t)?t:a[0]||L(),localStorage.setItem(De,i.activeCompanyId)}function gs(e){const t=u();e.jobId&&Q(t).some(n=>n.id===e.jobId)&&(i.selectedJobId=e.jobId),(!i.selectedJobId||!Q(t).some(n=>n.id===i.selectedJobId))&&(i.selectedJobId=Q(t)[0]?.id||"");const a=e.params.get("task_id");a&&ae(t).some(n=>n.id===a)&&(i.selectedTaskId=a),e.section!=="tasks"&&(i.selectedTaskId=""),i.driveFolder=e.params.get("folder")||"home"}function Vc(e){const t=Ue(),a=w(e),n=t.includes(a)?a:t[0]||L();i.activeCompanyId=n,localStorage.setItem(De,n),Yc();const s=i.route||Mt(),o=s.name==="company"?s.section:"jobs";j(m(o,{},n))}function Yc(){i.modal="",i.selectedJobId="",i.selectedTaskId="",i.selectedFileId="",i.selectedFormId="",i.selectedQuestionId="",i.selectedFinanceInvoiceId="",i.selectedFinanceExpenseId="",i.selectedFinanceVendorId="",i.selectedCalendarEventId="",i.query="",i.fileQuery="",i.formQuery="",i.crmQuery="",i.stageFilter="all",i.crmStageFilter="all",i.crmOwnerFilter="all",i.taskStatusFilter="all",i.taskPriorityFilter="all",i.calendarQuery="",i.calendarTypeFilter="all",i.calendarScope="company",i.fileCategoryFilter="All categories",i.formTypeFilter="all",i.formsTab="library",i.driveFolder="home"}function Bc(e){const t=P(e);t&&(i.selectedJobId=e,j(m("jobs",{tab:"profile",job_id:e},t.company_id)))}function Hc(e){const t=qa(e);t&&(i.selectedTaskId=e,j(m("tasks",{...t.project_id?{job_id:t.project_id}:{},task_id:e},t.company_id)))}function Te(){return P(i.selectedJobId)||Q(u())[0]||null}function P(e){return i.jobs.find(t=>t.id===e)||null}function qa(e){return i.tasks.find(t=>t.id===e)||null}function Q(e=u()){return i.jobs.filter(t=>t.company_id===e)}function ae(e=u()){return i.tasks.filter(t=>t.company_id===e)}function bs(e=u()){const t=b().profile.id;return i.notifications.filter(a=>a.company_id===e&&a.recipient_profile_id===t).sort((a,n)=>Date.parse(n.created_at||0)-Date.parse(a.created_at||0))}function xe(e=u()){const t=i.messageQuery.trim().toLowerCase(),a=i.messageFilter||"all";return i.messageConversations.filter(n=>n.company_id===e&&Kc(n)).filter(n=>a==="all"||n.type===a||a==="unread"&&gt(n.id)>0).filter(n=>{if(!t)return!0;const s=Oe(n.id).some(o=>o.body.toLowerCase().includes(t));return n.title.toLowerCase().includes(t)||s}).sort((n,s)=>Date.parse(s.last_message_at||s.updated_at||s.created_at||0)-Date.parse(n.last_message_at||n.updated_at||n.created_at||0))}function _s(e=u()){return xe(e).reduce((t,a)=>t+gt(a.id),0)}function vs(e=u()){const t=xe(e),n=i.route?.params?.get("conversation")||""||i.selectedConversationId;return t.find(s=>s.id===n)||t[0]||null}function Oe(e){return i.messages.filter(t=>t.conversation_id===e&&!t.deleted_at).sort((t,a)=>Date.parse(t.created_at||0)-Date.parse(a.created_at||0))}function zc(e){return i.messageAttachments.filter(t=>t.conversation_id===e)}function Wc(e){return i.messageAttachments.filter(t=>t.message_id===e)}function Aa(e){return i.messageAccess.filter(t=>t.conversation_id===e)}function Jc(e,t=b().profile.id){return i.messageReads.find(a=>a.conversation_id===e&&a.profile_id===t)||null}function gt(e,t=b().profile.id){const a=Date.parse(Jc(e,t)?.last_read_at||0);return Oe(e).filter(n=>n.sender_profile_id!==t&&Date.parse(n.created_at||0)>a).length}function Kc(e){if(!e||!h("messages.view",e.company_id))return!1;const t=b().profile,a=Aa(e.id);if(e.type==="company"||a.some(o=>o.target_type==="all_company"))return!0;const n=new Set([t.id,t.member_id,t.email].filter(Boolean).map(String));if(a.some(o=>o.target_type==="profile"&&n.has(o.target_id)))return!0;const s=[_t(e.company_id,Ge(e.company_id)),...i.roleAssignments.filter(o=>o.company_id===e.company_id&&o.profile_id===t.id).map(o=>o.role_id)];return a.some(o=>o.target_type==="role"&&s.includes(o.target_id))}function Ma(e=u()){const t=i.calendarEvents.filter(c=>c.company_id===e&&nd(c)).map(Zc),a=ae(e).filter(c=>c.due&&c.status!=="done").filter(c=>h("calendar.view_team",e)||hs(c.assignee_id)||c.creator_id===b().profile.member_id).map(Xc),n=h("finance.view",e)?_e(e).filter(c=>c.due_date&&pe(c.id)>0).map(ed):[],s=qn(e).filter(c=>c.type!=="Access request"||h("users.manage",e)).map(c=>td(c,e)),o=Et(e),l=o&&(h("calendar.view_team",e)||Fa(o.user_id))?[ad(o)]:[];return t.concat(a,n,s,l).sort((c,d)=>Date.parse(c.startsAt||0)-Date.parse(d.startsAt||0))}function Gc(e=u()){const t=i.calendarQuery.trim().toLowerCase();return Ma(e).filter(a=>i.calendarScope==="company"||a.mine).filter(a=>i.calendarTypeFilter==="all"||a.type===i.calendarTypeFilter).filter(a=>t?[a.title,a.description,a.type,a.owner,a.linkLabel].some(n=>String(n||"").toLowerCase().includes(t)):!0).filter(a=>i.calendarView==="list"||ld(a))}function ys(e=u()){const t=Date.now();return Ma(e).filter(a=>Date.parse(a.endsAt||a.startsAt||0)>=t).slice(0,9)}function Zc(e){const t=e.linked_type==="job"?P(e.linked_id):null;return{id:`manual:${e.id}`,source:"manual",sourceId:e.id,companyId:e.company_id,title:e.title,description:e.description,type:e.event_type,startsAt:e.starts_at,endsAt:e.ends_at||e.starts_at,allDay:e.all_day,dateKey:ws(e.starts_at),owner:rd(e.assigned_profile_id||e.created_by),mine:Fa(e.assigned_profile_id)||e.created_by===b().profile.id,href:id(e),linkLabel:t?.name||"",editable:Ft(e)}}function Xc(e){const t=e.due_time?`${e.due}T${e.due_time}:00`:`${e.due}T12:00:00`;return{id:`task:${e.id}`,source:"task",sourceId:e.id,companyId:e.company_id,title:e.title,description:e.description||Le(e.type),type:"Task due",startsAt:t,endsAt:t,allDay:!e.due_time,dateKey:e.due,owner:B(e.assignee_id),mine:hs(e.assignee_id),href:m("tasks",{...e.project_id?{job_id:e.project_id}:{},task_id:e.id},e.company_id),linkLabel:P(e.project_id)?.name||"Company task",editable:!1}}function ed(e){return{id:`invoice:${e.id}`,source:"invoice",sourceId:e.id,companyId:e.company_id,title:`${e.invoice_number} due`,description:`${C(pe(e.id))} outstanding for ${e.client_name||"client"}.`,type:"Invoice due",startsAt:`${e.due_date}T12:00:00`,endsAt:`${e.due_date}T12:00:00`,allDay:!0,dateKey:e.due_date,owner:e.client_name||"Finance",mine:h("finance.view",e.company_id),href:m("finance",{invoice:e.id},e.company_id),linkLabel:e.client_name||"Finance",editable:!1}}function td(e,t=u()){const a=String(e.updatedAt||k(0)).slice(0,10);return{id:`approval:${e.id}`,source:"approval",sourceId:e.id,companyId:t,title:e.title,description:e.meta,type:"Approval",startsAt:`${a}T12:00:00`,endsAt:`${a}T12:00:00`,allDay:!0,dateKey:a,owner:e.owner,mine:!0,href:e.href,linkLabel:e.status,editable:!1}}function ad(e){const t=ws(e.started_at);return{id:`timer:${e.id}`,source:"timer",sourceId:e.id,companyId:e.company_id,title:e.task_title||"Active timer",description:"Current clock session.",type:"Time",startsAt:e.started_at,endsAt:new Date().toISOString(),allDay:!1,dateKey:t,owner:B(e.user_id),mine:Fa(e.user_id),href:m("time",{},e.company_id),linkLabel:"My time",editable:!1}}function nd(e){return!e||!h("calendar.view",e.company_id)?!1:e.visibility!=="private"?!0:h("calendar.view_team",e.company_id)||Ft(e)||Fa(e.assigned_profile_id)}function Ft(e){return e?h("calendar.manage",e.company_id)||e.created_by===b().profile.id:!1}function id(e){return e.linked_type==="job"&&e.linked_id&&h("jobs.view",e.company_id)?m("jobs",{tab:"profile",job_id:e.linked_id},e.company_id):e.linked_type==="task"&&e.linked_id&&h("tasks.view",e.company_id)?m("tasks",{task_id:e.linked_id},e.company_id):e.linked_type==="form"&&e.linked_id&&h("forms.view",e.company_id)?m("forms",{form_id:e.linked_id},e.company_id):e.linked_type==="invoice"&&e.linked_id&&h("finance.view",e.company_id)?m("finance",{invoice:e.linked_id},e.company_id):""}function sd(e,t=u()){return Ma(t).find(a=>a.id===e)||null}function It(e){return i.calendarEvents.find(t=>t.id===e)||null}function hs(e){return String(e||"")===String(b().profile.member_id||b().profile.id||"")}function Fa(e){const t=b().profile;return[t.id,t.member_id,t.email].filter(Boolean).map(String).includes(String(e||""))}function rd(e){return e?Re(e)?.full_name||B(e)||String(e):"Unassigned"}function ws(e){if(!e)return k(0);const t=new Date(e);return Number.isNaN(t.getTime())?String(e).slice(0,10):t.toISOString().slice(0,10)}function $s(e,t){return e.filter(a=>a.dateKey===t).sort((a,n)=>Date.parse(a.startsAt||0)-Date.parse(n.startsAt||0))}function od(e){const t=kn(new Date),a=new Date(t);return a.setDate(t.getDate()+7),e.filter(n=>{const s=Date.parse(n.startsAt||n.dateKey||0);return s>=t.getTime()&&s<a.getTime()})}function ld(e){const t=new Date(`${e.dateKey}T00:00:00`);if(i.calendarView==="month"){const s=new Date(`${i.calendarCursorDate}T00:00:00`);return t.getFullYear()===s.getFullYear()&&t.getMonth()===s.getMonth()}const a=kn(new Date(`${i.calendarCursorDate}T00:00:00`)),n=new Date(a);return n.setDate(a.getDate()+7),t>=a&&t<n}function cd(e){const t=new Date(`${e}T00:00:00`),a=new Date(t.getFullYear(),t.getMonth(),1),n=new Date(a);return n.setDate(a.getDate()-a.getDay()),Array.from({length:42},(s,o)=>{const l=new Date(n);return l.setDate(n.getDate()+o),{key:Dn(l),label:String(l.getDate()),month:l.getMonth()}})}function Ss(e){const t=kn(new Date(`${e}T00:00:00`));return Array.from({length:7},(a,n)=>{const s=new Date(t);return s.setDate(t.getDate()+n),{key:Dn(s),name:new Intl.DateTimeFormat("en-US",{weekday:"short"}).format(s),shortDate:new Intl.DateTimeFormat("en-US",{month:"short",day:"numeric"}).format(s)}})}function dd(){const e=new Date(`${i.calendarCursorDate}T00:00:00`);if(i.calendarView==="month")return new Intl.DateTimeFormat("en-US",{month:"long",year:"numeric"}).format(e);if(i.calendarView==="week"){const t=Ss(i.calendarCursorDate);return`${O(t[0].key)} - ${O(t[6].key)}`}return"Upcoming"}function kn(e){const t=new Date(e);return t.setHours(0,0,0,0),t.setDate(t.getDate()-t.getDay()),t}function Dn(e){const t=e.getFullYear(),a=String(e.getMonth()+1).padStart(2,"0"),n=String(e.getDate()).padStart(2,"0");return`${t}-${a}-${n}`}function yi(e){const t=new Date(`${i.calendarCursorDate}T00:00:00`);i.calendarView==="month"?t.setMonth(t.getMonth()+e):t.setDate(t.getDate()+e*7),i.calendarCursorDate=Dn(t)}function ud(e){return e.reduce((t,a)=>(t[a.dateKey]=t[a.dateKey]||[],t[a.dateKey].push(a),t),{})}function ks(e){if(e.allDay)return"All day";const t=new Date(e.startsAt);return Number.isNaN(t.getTime())?"Timed":new Intl.DateTimeFormat("en-US",{hour:"numeric",minute:"2-digit"}).format(t)}function md(e){return`calendar-type-${Bt(e||"event")}`}function pd(e){return e==="Task due"?"ti-list-check":e==="Invoice due"?"ti-file-dollar":e==="Approval"?"ti-user-check":e==="Time"?"ti-clock":e.includes("Install")?"ti-hammer":e.includes("Estimate")?"ti-calendar-dollar":e.includes("Personal")?"ti-user":"ti-calendar-event"}function Ce(e=u()){return i.files.filter(t=>t.company_id===e)}function bt(e=u()){return i.driveFolders.filter(t=>t.company_id===e)}function rt(e=u()){return i.teamMembers.filter(t=>Array.isArray(t.company_ids)&&t.company_ids.includes(e))}function ie(e=u()){const t=new Map;rt(e).forEach(n=>{t.set(n.id,{profile_id:"",member_id:n.id,name:n.full_name||n.name,email:n.email,avatar_url:n.avatar_url,role:na(e,n.id).toLowerCase(),role_label:na(e,n.id),role_id:"",status:n.active?"active":"disabled"})}),i.memberships.filter(n=>n.company_id===e).forEach(n=>{const s=Re(n.profile_id),o=n.member_id?i.teamMembers.find(f=>f.id===n.member_id):null,l=i.roleAssignments.find(f=>f.company_id===e&&f.profile_id===n.profile_id),c=l?ot(e,l.role_id):null,d=n.profile_id||n.member_id;t.set(d,{profile_id:n.profile_id,member_id:n.member_id,name:s?.full_name||o?.full_name||s?.email||o?.name||d||"User",email:s?.email||o?.email||"",avatar_url:s?.avatar_url||o?.avatar_url||"",role:n.role,role_label:c?.name||I(n.role),role_id:l?.role_id||_t(e,n.role),status:n.status||"active"})});const a=b().profile;if(i.session?.auth==="supabase"&&a?.id&&!t.has(a.id)){const n=oe(e,a.id);n&&t.set(a.id,{profile_id:a.id,member_id:a.member_id||"",name:a.full_name||a.email,email:a.email,avatar_url:a.avatar_url,role:n.role,role_label:I(n.role),role_id:_t(e,n.role),status:n.status||"active"})}return[...t.values()].sort((n,s)=>(n.status==="active"?0:1)-(s.status==="active"?0:1)||n.name.localeCompare(s.name))}function fd(e=u()){return i.companyInvites.filter(t=>t.company_id===e&&t.status==="pending").sort((t,a)=>Date.parse(a.created_at||0)-Date.parse(t.created_at||0))}function Ds(e=u()){return i.auditEvents.filter(t=>t.company_id===e).sort((t,a)=>Date.parse(a.created_at||0)-Date.parse(t.created_at||0))}function gd(e){const t=Re(e.actor_profile_id),a=t?.full_name||t?.email||cr(e.actor_profile_id||"system");return`
  ...
  `}function H(e){return`<div class="contract-rows">${e.map(([t,a])=>`<div><span>${r(t)}</span><strong>${r(a)}</strong></div>`).join("")}</div>`}function F(e,t,a="",n=!1,s="text",o=""){return`<label class="${r(o)}"><span>${r(e)}</span><input name="${r(t)}" type="${r(s)}" value="${r(a)}" ${n?"required":""} /></label>`}function ke(e,t,a="",n=""){return`<label class="${r(n)}"><span>${r(e)}</span><textarea name="${r(t)}" rows="4">${r(a)}</textarea></label>`}function U(e,t,a,n){return`
    <label><span>${r(e)}</span><select name="${r(t)}">
      ${n.map(([s,o])=>`<option value="${r(s)}" ${String(s)===String(a)?"selected":""}>${r(o)}</option>`).join("")}
    </select></label>
  `}function Us(e){return`<span class="priority ${r(String(e).toLowerCase())}">${r(e)}</span>`}function Vn(e){return`<span class="priority ${r(e)}">${r(I(e))}</span>`}function Ns(e){return`<span class="status-pill ${r(e)}">${r(we(e))}</span>`}function Jd(e){return`<span class="finance-status ${r(Bt(e))}">${r(e)}</span>`}function te(e,t){if(e.avatar_url)return`<span class="${r(t)}"><img src="${r(e.avatar_url)}" alt="" /></span>`;const a=String(e.full_name||e.email||"QB").trim().split(/\s+/).map(n=>n[0]).join("").slice(0,2).toUpperCase()||"QB";return`<span class="${r(t)}">${r(a)}</span>`}function Kd(e=u()){const t=ie(e).filter(a=>a.status==="active").map(a=>[a.profile_id||a.member_id,a.name||a.email||a.member_id]);return[["","Unassigned"]].concat(t)}function $i(e){const t=new Date(e||Date.now());if(Number.isNaN(t.getTime()))return"";const a=t.getFullYear(),n=String(t.getMonth()+1).padStart(2,"0"),s=String(t.getDate()).padStart(2,"0"),o=String(t.getHours()).padStart(2,"0"),l=String(t.getMinutes()).padStart(2,"0");return`${a}-${n}-${s}T${o}:${l}`}function Si(e){const t=new Date(e||Date.now());return Number.isNaN(t.getTime())?new Date().toISOString():t.toISOString()}function v(e){return`<div class="empty-state">${z("q-empty","empty-symbol")}<span>${r(e)}</span></div>`}function ce(e,t){const a={};return t.forEach(n=>{const s=e.get(n);s&&(a[n]=s)}),a}function Z(){i.session?.auth!=="supabase"&&(D(en,i.jobs),D(tn,i.tasks),D(an,i.files),D(nn,i.driveFolders),D(it,i.forms),D(pa,i.formResponses),D(on,i.financeInvoices),D(ln,i.financePayments),D(cn,i.financeExpenses),D(dn,i.financeVendors),D(fa,i.timeEntries),D(ga,i.activeTimer),D(sn,i.teamMembers),D(rn,i.memberships),D(ba,i.notifications),D(_a,i.messageConversations),D(va,i.messageAccess),D(ya,i.messages),D(ha,i.messageReads),D(wa,i.messageAttachments),D($a,i.calendarEvents))}function Ls(){i.session?.auth!=="supabase"&&(D(fa,i.timeEntries),D(ga,i.activeTimer))}function Yn(){i.session?.auth!=="supabase"&&D(ba,i.notifications)}function Qs(){i.session?.auth!=="supabase"&&D($a,i.calendarEvents)}function Ne(){i.session?.auth!=="supabase"&&(D(_a,i.messageConversations),D(va,i.messageAccess),D(ya,i.messages),D(ha,i.messageReads),D(wa,i.messageAttachments))}function Bn(e,t,a){if(a==="company")return[ee({id:`msg-access-${crypto.randomUUID()}`,company_id:t.company_id,conversation_id:t.id,target_type:"all_company",target_id:"all"})];const n=[];return e.getAll("role_ids").forEach(s=>{s&&n.push(ee({id:`msg-access-${crypto.randomUUID()}`,company_id:t.company_id,conversation_id:t.id,target_type:"role",target_id:s}))}),e.getAll("profile_ids").forEach(s=>{s&&n.push(ee({id:`msg-access-${crypto.randomUUID()}`,company_id:t.company_id,conversation_id:t.id,target_type:"profile",target_id:s}))}),n.length?n:[ee({id:`msg-access-${crypto.randomUUID()}`,company_id:t.company_id,conversation_id:t.id,target_type:"profile",target_id:b().profile.id})]}function Ua(e,t=!0){if(!e)return;const a=i.messageConversations.find(l=>l.id===e);if(!a)return;const n=new Date().toISOString(),s=b().profile.id,o=Vt({conversation_id:e,company_id:a.company_id,profile_id:s,last_read_at:n});if(i.messageReads=[o].concat(i.messageReads.filter(l=>l.conversation_id!==e||l.profile_id!==s)),Ne(),t&&i.session?.auth==="supabase"){const l=q();l&&l.from("message_reads").upsert(xd(o),{onConflict:"conversation_id,profile_id"})}}function Vs(e,t,a=[]){const n=m("messages",{conversation:e.id},e.company_id),s=Rt(t.sender_profile_id),o=ca(e).filter(c=>c!==be(e.company_id,t.sender_profile_id)),l=Gd(t.body,e.company_id).filter(c=>c!==be(e.company_id,t.sender_profile_id));e.type==="direct"&&J("message.direct","New direct message",`${s} sent a direct message in ${e.title}.`,n,"message",t.id,e.company_id,o),l.forEach(c=>{Ye({company_id:e.company_id,recipients:[c],type:"message.mention",title:"Mentioned in chat",body:`${s} mentioned you in ${e.title}.`,href:n,sourceType:"message",sourceId:t.id}).catch(d=>console.warn("Message mention notification failed",d))}),a.length&&J("message.attachment","Attachment shared",`${s} shared ${a.length} attachment${a.length===1?"":"s"} in ${e.title}.`,n,"message",t.id,e.company_id,o)}function Gd(e="",t=u()){const a=String(e||"").toLowerCase();return a.includes("@")?ie(t).filter(n=>a.includes(`@${String(n.name||"").split(/\s+/)[0].toLowerCase()}`)||a.includes(`@${String(n.name||"").toLowerCase()}`)).map(n=>be(t,n.profile_id||n.member_id)).filter(Boolean):[]}function Zd(e){const t=Re(e);if(t)return t;const a=i.teamMembers.find(n=>n.id===e);return{id:e,full_name:a?.full_name||a?.name||e||"Quest user",email:a?.email||"",avatar_url:a?.avatar_url||""}}function Ve(e){const t=String(e?.name||"").trim();if(t&&!ma(t))return t;const a=String(e?.email||"").trim();return a?a.split("@")[0]||a:"Workspace user"}function Xd(e){return W([e?.email,e?.role_label||I(e?.role||""),I(e?.status||"")]).join(" / ")||"Company member"}function ki(e){return{id:e?.profile_id||e?.member_id||"",full_name:Ve(e),email:e?.email||"",avatar_url:e?.avatar_url||""}}function eu(e){const t=String(e.value||"").trim().toLowerCase(),a=e.closest(".message-modal-form"),n=Array.from(a?.querySelectorAll("[data-message-person-row]")||[]);let s=0;n.forEach(l=>{const c=l.querySelector('input[type="checkbox"]')?.checked,d=!t||String(l.dataset.filterText||"").includes(t),f=c||d;l.hidden=!f,f&&(s+=1)});const o=a?.querySelector("[data-message-filter-count]");o&&(o.textContent=t?`${s} match${s===1?"":"es"}`:`${n.length} member${n.length===1?"":"s"}`)}function Ys(e){return{company:"q-symbol-company-chat",role:"q-symbol-role-chat",custom:"q-symbol-messages",direct:"q-symbol-direct-chat"}[e]||"q-symbol-messages"}function Hn(e){const t=Aa(e.id);if(e.type==="company"||t.some(s=>s.target_type==="all_company"))return"Everyone in this company";const a=t.filter(s=>s.target_type==="role").map(s=>ot(e.company_id,s.target_id)?.name||"Role"),n=t.filter(s=>s.target_type==="profile").map(s=>Rt(s.target_id));return a.concat(n).slice(0,5).join(", ")||"Private chat"}function tu(e){return r(e).replace(/(^|\s)@([\w.-]+)/g,"$1<strong>@$2</strong>")}function au(e){const t=Number(e||0);return t>=1024*1024?`${(t/1024/1024).toFixed(1)} MB`:t>=1024?`${Math.round(t/1024)} KB`:`${t} B`}function Bs(e){return new Promise(t=>{const a=new FileReader;a.onload=()=>t(String(a.result||"")),a.onerror=()=>t(""),a.readAsDataURL(e)})}function nu(e,t){const a=q();if(i.session?.auth!=="supabase"||!a?.channel||!t)return;const n=`${e}:${t}`;i.messageRealtimeKey!==n&&(i.messageRealtimeChannel&&a.removeChannel(i.messageRealtimeChannel),i.messageRealtimeKey=n,i.messageRealtimeChannel=a.channel(`quest-messages-${t}`).on("postgres_changes",{event:"*",schema:"public",table:"messages",filter:`conversation_id=eq.${t}`},()=>{i.dataLoaded=!1,p()}).on("postgres_changes",{event:"*",schema:"public",table:"message_attachments",filter:`conversation_id=eq.${t}`},()=>{i.dataLoaded=!1,p()}).subscribe())}function iu(e){const t=[()=>Xt(e,"Crew weather delay","role","Manager posted a weather delay update.",!0),()=>Xt(e,"Permit questions","custom","A permit packet PDF was shared.",!1,!0),()=>Xt(e,"Shan Kumar","direct","Can you jump on this when you are back?",!0),()=>su(e,"@Joshua you were mentioned in the launch room.")],a=Math.floor(Math.random()*t.length);t[a]()}function Xt(e,t,a,n,s=!1,o=!1){const l=new Date().toISOString(),c=ve({id:`msg-conv-${crypto.randomUUID()}`,company_id:e,title:t,type:a,created_by:"basic-quest-user",last_message_at:l,created_at:l,updated_at:l}),d=a==="direct"?[ee({id:`msg-access-${crypto.randomUUID()}`,company_id:e,conversation_id:c.id,target_type:"profile",target_id:"basic-quest-user"}),ee({id:`msg-access-${crypto.randomUUID()}`,company_id:e,conversation_id:c.id,target_type:"profile",target_id:"shan"})]:Bn(new FormData,c,a==="role"?"role":"company");i.messageConversations.unshift(c),i.messageAccess=d.concat(i.messageAccess);const f=Se({id:`msg-${crypto.randomUUID()}`,conversation_id:c.id,company_id:e,sender_profile_id:s?"shan":"basic-quest-user",body:n,created_at:l,updated_at:l,message_type:o?"attachment":"text"});i.messages.push(f),o&&i.messageAttachments.push(Ee({id:`msg-attachment-${crypto.randomUUID()}`,conversation_id:c.id,message_id:f.id,company_id:e,file_name:"permit-packet.pdf",mime_type:"application/pdf",size_bytes:42e4,created_at:l})),s||Ua(c.id,!1),i.selectedConversationId=c.id,Ne(),$("Demo message scenario added.","local","Messages"),j(m("messages",{conversation:c.id},e),{replace:!0})}function su(e,t){const a=vs(e)||xe(e)[0];if(!a)return Xt(e,"Demo chat","company",t,!0);const n=new Date().toISOString(),s=Se({id:`msg-${crypto.randomUUID()}`,conversation_id:a.id,company_id:e,sender_profile_id:"shan",body:t,created_at:n,updated_at:n});i.messages.push(s),i.messageConversations=i.messageConversations.map(o=>o.id===a.id?{...o,last_message_at:n,updated_at:n}:o),Vs(a,s,[]),Ne(),$("Demo mention added.","local","Messages"),p()}function ru(){i.messageConversations=gn.map(ve),i.messageAccess=bn.map(ee),i.messages=_n.map(Se),i.messageReads=yn.map(Vt),i.messageAttachments=vn.map(Ee),i.selectedConversationId="",Ne(),$("Demo messages reset.","local","Messages"),p()}function ou(e){return{id:e.id,company_id:e.company_id,recipient_profile_id:e.recipient_profile_id,type:e.type,title:e.title,body:e.body,href:e.href,source_type:e.source_type,source_id:e.source_id,read_at:e.read_at||null,created_at:e.created_at}}function Hs(e=""){const t=String(e||"").split(".")[0];return{access:"Access",approval:"Approval",calendar:"Calendar",file:"Files",finance:"Finance",form:"Forms",message:"Messages",task:"Tasks"}[t]||"Inbox"}async function Ye(e){const t=w(e.companyId||e.company_id||u()),a=lu(t,e.recipients,{excludeActor:e.excludeActor===!0,type:e.type,href:e.href});if(!a.length)return[];const n=new Date().toISOString(),s=a.map(o=>ht({id:`notification-${crypto.randomUUID()}`,company_id:t,recipient_profile_id:o,type:e.type||"general",title:e.title||"Notification",body:e.body||"",href:e.href||"",source_type:e.sourceType||e.source_type||"",source_id:e.sourceId||e.source_id||"",created_at:n}));if(i.session?.auth==="supabase"){const o=q();if(!o)return[];const l=await o.from("notifications").insert(s.map(ou)).select();if(l.error)return console.warn("Notification insert failed",l.error),[];const c=(l.data||[]).map(ht);return Di(c),p(),c}return Di(s),Yn(),p(),s}function Di(e){if(!e.length)return;const t=new Map;e.concat(i.notifications).forEach(a=>t.set(a.id,a)),i.notifications=[...t.values()].sort((a,n)=>Date.parse(n.created_at||0)-Date.parse(a.created_at||0)).slice(0,200)}function lu(e,t=[],a={}){let s=(Array.isArray(t)?t:[t]).map(o=>be(e,o)).filter(Boolean);return s.length||(s=Js(e,a.type||"","","")),s=W(s),i.session?.auth!=="supabase"&&!s.includes(b().profile.id)&&s.push(b().profile.id),a.excludeActor&&(s=s.filter(o=>o!==zs())),s.filter(o=>cu(e,o)&&du(e,o,a.type,a.href))}function be(e,t){if(!t)return"";const a=typeof t=="object"?String(t.profile_id||t.id||t.member_id||t.target_id||"").trim():String(t).trim();if(!a)return"";if(Re(a)||oe(e,a))return a;const n=b().profile;if(a===n.id||a===n.member_id||a===n.email)return n.id;const s=ie(e).find(l=>[l.profile_id,l.member_id,l.email,l.name].filter(Boolean).includes(a));if(s?.profile_id)return s.profile_id;const o=i.profiles.find(l=>l.member_id===a||l.email===a||l.full_name===a);return o?.id?o.id:i.session?.auth==="supabase"?"":a}function cu(e,t){if(!t)return!1;if(t===b().profile.id&&i.session?.auth!=="supabase")return!0;const a=oe(e,t);if(a)return a.status==="active";const n=ie(e).find(s=>s.profile_id===t||s.member_id===t);return i.session?.auth!=="supabase"?!0:n?.status==="active"}function zs(){return b().profile.id||b().profile.member_id||""}function du(e,t,a="",n=""){const s=uu(a,n);return s?Ws(e,t,s):!0}function uu(e="",t=""){const a=`${e} ${t}`;return a.includes("finance")?"finance.view":a.includes("message")?"messages.view":a.includes("calendar")?"calendar.view":a.includes("file")?"files.view":a.includes("approval")?"approvals.view":a.includes("form")?"forms.view":a.includes("task")?"tasks.view":""}function Ws(e,t,a){if(!a)return!0;if(t===b().profile.id)return h(a,e);const n=oe(e,t);if(i.session?.auth==="supabase"&&(!n||n.status!=="active"))return!1;const s=String(n?.role||ie(e).find(f=>f.profile_id===t)?.role||"member").toLowerCase();if(["owner","admin","developer"].includes(s))return!0;const o=Cn(a),l=i.roleAssignments.filter(f=>f.company_id===e&&f.profile_id===t).map(f=>f.role_id),c=i.rolePermissions.filter(f=>l.includes(f.role_id));if(c.some(f=>(o.includes(f.permission_key)||f.permission_key==="*")&&f.effect==="deny"))return!1;if(c.some(f=>(o.includes(f.permission_key)||f.permission_key==="*")&&f.effect==="allow"))return!0;const d=Ke[s]||Ke.member;return d.includes("*")||o.some(f=>d.includes(f))}function Js(e,t="",a="",n=""){const s=String(t||"").split(".")[0];return s==="finance"?ue(e,["finance.view"]):s==="message"?ue(e,["messages.view"]):s==="calendar"?pu(n).concat(ue(e,["calendar.manage"])):s==="file"?ue(e,["files.view"]).concat(mu(e,n)):s==="form"?ue(e,["forms.view","forms.manage"]):s==="approval"?ue(e,["approvals.view","approvals.manage"]):s==="access"?ue(e,["users.manage","settings.manage"]):[zs()]}function ue(e,t){return W(ie(e).filter(a=>a.status==="active").map(a=>be(e,a.profile_id||a.member_id)).filter(a=>t.some(n=>Ws(e,a,n))))}function Xa(e,t=!0){return e?W([e.assignee_id,t?e.creator_id:"",...Array.isArray(e.watchers)?e.watchers:[]].map(a=>be(e.company_id,a)).filter(Boolean)):[]}function mu(e,t){return t?W(i.tasks.filter(a=>a.company_id===e&&a.project_id===t).flatMap(a=>Xa(a))):[]}function pu(e){const t=i.calendarEvents.find(a=>a.id===e);return t?W([t.assigned_profile_id,t.created_by].map(a=>be(t.company_id,a)).filter(Boolean)):[]}function ca(e){if(!e)return[];const a=Aa(e.id).flatMap(n=>n.target_type==="all_company"?ue(e.company_id,["messages.view"]):n.target_type==="profile"?[be(e.company_id,n.target_id)]:n.target_type==="role"?ie(e.company_id).filter(s=>s.status==="active"&&(s.role_id===n.target_id||_t(e.company_id,s.role)===n.target_id)).map(s=>be(e.company_id,s.profile_id||s.member_id)):[]);return W(a.filter(Boolean))}async function fu(e=u()){const t=new Date().toISOString(),a=b().profile.id,n=i.notifications.filter(s=>s.company_id===e&&s.recipient_profile_id===a&&!s.read_at).map(s=>s.id);if(n.length&&(i.notifications=i.notifications.map(s=>s.company_id===e&&s.recipient_profile_id===a&&!s.read_at?{...s,read_at:t}:s),Yn(),p(),i.session?.auth==="supabase")){const s=q();s&&await s.from("notifications").update({read_at:t}).in("id",n).eq("recipient_profile_id",a)}}async function gu(e){const t=i.notifications.find(n=>n.id===e);if(!t)return;const a=new Date().toISOString();if(i.notifications=i.notifications.map(n=>n.id===t.id?{...n,read_at:n.read_at||a}:n),i.notificationMenuOpen=!1,Yn(),p(),i.session?.auth==="supabase"&&!t.read_at){const n=q();n&&await n.from("notifications").update({read_at:a}).eq("id",t.id).eq("recipient_profile_id",b().profile.id)}t.href&&j(t.href)}function Ci(e,t=null){const a=m("tasks",{...e.project_id?{job_id:e.project_id}:{},task_id:e.id},e.company_id),n=B(e.assignee_id);if(!t){Ye({companyId:e.company_id,recipients:[e.assignee_id],type:"task.assigned",title:"Task assigned",body:`${Y()} assigned ${e.title} to ${n}.`,href:a,sourceType:"task",sourceId:e.id}).catch(s=>console.warn("Task notification failed",s));return}t.assignee_id!==e.assignee_id&&Ye({companyId:e.company_id,recipients:[e.assignee_id],type:"task.assigned",title:"Task reassigned",body:`${Y()} reassigned ${e.title} to ${n}.`,href:a,sourceType:"task",sourceId:e.id}).catch(s=>console.warn("Task notification failed",s)),t.priority!==e.priority&&Ye({companyId:e.company_id,recipients:Xa(e),excludeActor:!0,type:"task.priority",title:"Task priority changed",body:`${Y()} set priority to ${I(e.priority)} on ${e.title}.`,href:a,sourceType:"task",sourceId:e.id}).catch(s=>console.warn("Task notification failed",s)),t.status!==e.status&&Ye({companyId:e.company_id,recipients:Xa(e),excludeActor:!0,type:"task.status",title:"Task status changed",body:`${Y()} moved ${e.title} to ${we(e.status)}.`,href:a,sourceType:"task",sourceId:e.id}).catch(s=>console.warn("Task notification failed",s))}function J(e,t,a,n,s="",o="",l=u(),c=null){Ye({companyId:l,recipients:c||Js(l,e,s,o),type:e,title:t,body:a,href:n,sourceType:s,sourceId:o}).catch(d=>console.warn("Notification event failed",d))}async function at(e,t,a,n,s={},o=!1){const l={id:`audit-${crypto.randomUUID()}`,company_id:e,actor_profile_id:b().profile.id,event_type:t,target_type:a,target_id:n,details:s,created_at:new Date().toISOString()};if(i.auditEvents.unshift(l),o&&i.session?.auth==="supabase"){const c=q();if(c)try{await c.from("audit_events").insert({company_id:e,actor_profile_id:b().profile.id,event_type:t,target_type:a,target_id:n,details:s})}catch{}}}function bu(e,t){return t.status==="disabled"?"membership.disabled":t.status==="left"?"membership.left":e&&["disabled","left","pending"].includes(e.status)&&t.status==="active"?"membership.reactivated":e&&e.role!==t.role?"role.changed":"membership.updated"}function Y(){return b().profile.full_name||b().profile.email||"Quest HQ"}function M(e,t,a=""){return`<article class="metric">${z(jr(e),"metric-symbol")}<span>${r(e)}</span><strong>${r(t)}</strong>${a?`<small>${r(a)}</small>`:""}</article>`}function Ie(e,t){return`<div><strong>${r(e)}</strong><span>${r(t)}</span></div>`}function ze(e,t,a,n,s=""){const o=`
    <span><strong>${r(e)}</strong><small>${r(t||"Finance record")}</small></span>
    <b>${r(a)}</b>
    <em>${O(n)}</em>
  `;return s?`<a class="finance-compact-row" href="${_(s)}" data-router>${o}</a>`:`<div class="finance-compact-row">${o}</div>`}function ji(e,t){const a=Ce(e);return t==="jobs"?a.filter(n=>n.job_id).length:a.filter(n=>n.folder===t).length}function Ks(e="home",t=null){return t?.id?`job:${t.id}`:e||"home"}function _u(e,t="home",a=null){const n=Ks(t,a),s=bt(e).filter(o=>o.parent_key===n).map(o=>vu(e,o));return a?s:t==="home"?mn.map(([l,c,d,f])=>({id:l,name:c,caption:d,icon:f,href:_(m("files",{folder:l},e)),countLabel:`${ji(e,l)} file${ji(e,l)===1?"":"s"}`,updatedLabel:""})).concat(s):t==="jobs"?Q(e).map(l=>({id:`job:${l.id}`,name:l.name,caption:l.client_name||E(e),icon:"ti-folder",href:_(m("files",{folder:"jobs",job_id:l.id},e)),countLabel:`${sa(l.id)} file${sa(l.id)===1?"":"s"}`,updatedLabel:O(l.updated_at)})).concat(s):s}function vu(e,t){const a=bt(e).filter(o=>o.parent_key===t.id).length,n=Ce(e).filter(o=>o.folder===t.id).length,s=a+n;return{id:t.id,name:t.name,caption:"Custom folder",icon:"ti-folder",href:_(m("files",{folder:t.id},e)),countLabel:`${s} item${s===1?"":"s"}`,updatedLabel:O(t.updated_at)}}function yu(e,t,a=null){if(a)return`<span>/</span><a href="${_(m("files",{folder:"jobs"},e))}" data-router>Jobs</a>`;const n=bt(e).find(d=>d.id===t);if(!n)return`<span>/</span><strong>${r(fe(t))}</strong>`;const s=[];let o=n;const l=new Set;for(;o&&!l.has(o.id);)l.add(o.id),s.unshift(o),o=bt(e).find(d=>d.id===o.parent_key);return`${n.parent_key&&!n.parent_key.startsWith("folder-")&&n.parent_key!=="home"?`<span>/</span><a href="${_(m("files",{folder:n.parent_key},e))}" data-router>${r(fe(n.parent_key))}</a>`:""}${s.map((d,f)=>`<span>/</span>${f===s.length-1?`<strong>${r(d.name)}</strong>`:`<a href="${_(m("files",{folder:d.id},e))}" data-router>${r(d.name)}</a>`}`).join("")}`}function hu(e=u(),t="home",a=""){const n=(i.fileQuery||i.query||"").trim().toLowerCase(),s=i.fileCategoryFilter;let o=Ce(e);return a?o=o.filter(l=>l.job_id===a):t&&t!=="home"&&(t==="jobs"?o=o.filter(l=>l.job_id):o=o.filter(l=>l.folder===t)),s&&s!=="All categories"&&(o=o.filter(l=>String(l.category||fe(l.folder)).toLowerCase()===s.toLowerCase())),n&&(o=o.filter(l=>[l.file_name,l.category,l.uploaded_by_label,l.notes,l.object_path,P(l.job_id)?.name].some(c=>String(c||"").toLowerCase().includes(n)))),o.sort((l,c)=>new Date(c.created_at||0)-new Date(l.created_at||0))}function qe(e){const t={pdf:"PDF",image:"Image",archive:"Archive",sheet:"Excel",doc:"Word",presentation:"PowerPoint",text:"Text",video:"Video",audio:"Audio",code:"Code",data:"Data",design:"Design",cad:"CAD",email:"Email"},a=Na(e);if(t[a])return t[a];const n=La(e);return n?n.toUpperCase():fe(e.folder)}function Na(e){const t=String(e.mime_type||"").toLowerCase(),a=La(e);return t.includes("pdf")||a==="pdf"?"pdf":t.includes("image")||["png","jpg","jpeg","gif","webp","svg","bmp","tif","tiff","heic","ico"].includes(a)?"image":t.includes("zip")||t.includes("compressed")||["zip","rar","7z","tar","gz","tgz","bz2"].includes(a)?"archive":t.includes("spreadsheet")||t.includes("excel")||["xls","xlsx","xlsm","ods","csv"].includes(a)?"sheet":t.includes("word")||["doc","docx","odt","rtf"].includes(a)?"doc":t.includes("presentation")||["ppt","pptx","pps","odp"].includes(a)?"presentation":t.includes("video")||["mp4","mov","avi","mkv","webm","wmv","m4v"].includes(a)?"video":t.includes("audio")||["mp3","wav","aac","flac","m4a","ogg"].includes(a)?"audio":["js","ts","jsx","tsx","html","css","scss","json","xml","yml","yaml","md","sql","py","rb","php","java","cs","cpp","c","go","rs","sh","ps1"].includes(a)?"code":["txt","log"].includes(a)||t.includes("text")?"text":["ai","psd","sketch","fig"].includes(a)?"design":["dwg","dxf","rvt","ifc","step","stp"].includes(a)?"cad":["eml","msg"].includes(a)?"email":["db","sqlite","bak"].includes(a)?"data":"file"}function zn(e){return Na(e)}function La(e){return String(e.file_name||"").split(".").pop()?.toLowerCase()||""}function wu(e){return e.type==="image/png"?"png":e.type==="image/webp"?"webp":"jpg"}function Wn(e,t=!1){return e.signed_url&&Na(e)==="image"?`<img src="${r(e.signed_url)}" alt="" />`:`<span class="file-doc-icon ${r(zn(e))} ${t?"large":""}">${sr(e,qe(e))}<small>${r(Gs(e))}</small></span>`}function Gs(e){const t=qe(e),a=La(e);return t==="Image"?a&&a.length<=4?a.toUpperCase():"IMG":t==="Archive"?a&&a.length<=3?a.toUpperCase():"ZIP":t==="Excel"?a==="csv"?"CSV":"XLS":t==="Word"?"DOC":t==="PowerPoint"?"PPT":t==="Video"?"VID":t==="Audio"?"AUD":t==="Code"?a&&a.length<=4?a.toUpperCase():"CODE":t==="Design"?a&&a.length<=4?a.toUpperCase():"DES":t==="CAD"?a&&a.length<=4?a.toUpperCase():"CAD":t==="Email"?a&&a.length<=4?a.toUpperCase():"MAIL":t==="Data"?a&&a.length<=4?a.toUpperCase():"DATA":t==="Text"?a&&a.length<=4?a.toUpperCase():"TXT":t.length<=4?t.toUpperCase():(a||"FILE").slice(0,4).toUpperCase()}function ye(e=u()){return i.forms.filter(t=>t.company_id===e)}function $u(e=u()){const t=i.formQuery.trim().toLowerCase(),a=i.route?.jobId||"";return ye(e).filter(n=>a&&n.linked_job_id!==a||i.formTypeFilter!=="all"&&n.type!==i.formTypeFilter?!1:t?[n.title,n.description,n.type,n.status,n.audience,P(n.linked_job_id)?.name].some(s=>String(s||"").toLowerCase().includes(t)):!0)}function wt(e=u()){const t=i.route?.jobId||"",a=ye(e).filter(o=>!t||o.linked_job_id===t),n=i.route?.params?.get("form_id")||"";if(n&&a.some(o=>o.id===n)&&(i.selectedFormId=n),!a.length)return i.selectedFormId="",i.selectedQuestionId="",null;let s=a.find(o=>o.id===i.selectedFormId)||a[0];return i.selectedFormId=s.id,(!i.selectedQuestionId||!s.questions.some(o=>o.id===i.selectedQuestionId))&&(i.selectedQuestionId=s.questions[0]?.id||""),s}function Ae(e){return i.forms.find(t=>t.id===e)||null}function he(){return Ae(i.selectedFormId)||wt(u())}function Zs(e=u()){return i.formResponses.filter(t=>t.company_id===e)}function Qa(e){return i.formResponses.filter(t=>t.form_id===e)}function Xs(e){return Array.isArray(e?.questions)?e.questions.length:0}function Su(e){const t=String(e?.creator_id||""),a=b().profile;return t?t&&(t===a.member_id||t===a.id)?a.full_name||"Quest Basic Mode":B(t)||e?.created_by_label||"Quest HQ":e?.created_by_label||a.full_name||"Quest HQ"}function dt(e,t,a="",n=!1,s="text"){return`<label><span>${r(e)}</span><input data-form-field="${r(t)}" type="${r(s)}" value="${r(a)}" ${n?"required":""} /></label>`}function er(e,t,a=""){return`<label><span>${r(e)}</span><textarea data-form-field="${r(t)}" rows="3">${r(a)}</textarea></label>`}function Jt(e,t,a,n){return`
    <label><span>${r(e)}</span><select data-form-field="${r(t)}">
      ${n.map(([s,o])=>`<option value="${r(s)}" ${String(s)===String(a)?"selected":""}>${r(o)}</option>`).join("")}
    </select></label>
  `}function $t(e){return["multiple","checkbox","dropdown"].includes(e.type)}function ku(e){return{short:"ti-letter-t",paragraph:"ti-align-left",multiple:"ti-circle-dot",checkbox:"ti-checkbox",dropdown:"ti-select",date:"ti-calendar",rating:"ti-star",yesno:"ti-circle-check",file:"ti-paperclip"}[e]||"ti-plus"}function Du(e){return qt.find(([t])=>t===e)?.[1]||I(e||"Question")}function ge(e,t){return`
  ...
  `}function tr(e){const t=Ae(e.form_id),a=Object.entries(e.answers||{}).map(([n,s])=>{const o=t?.questions.find(c=>c.id===n),l=Array.isArray(s)?s.join(", "):s;return Ie(o?.label||n,l||"No answer")}).join("");return`
